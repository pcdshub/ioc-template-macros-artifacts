#!$$IOCTOP/bin/$$IF(ARCH,$$ARCH,linux-x86_64)/TDS3000

<envPaths
epicsEnvSet("IOC_NAME", "$$IOCNAME" )
...
epicsEnvSet( "FAMILY1", "$$IF($$SCOPEFAMILY0,$$SCOPEFAMILY0,3000)")     # Scope family 3000 or 5000
epicsEnvSet( "ETHER1", "$$SCOPEIP0" )                           # Scope IP address
epicsEnvSet( "DEV1", "$$SCOPENAME0" )                             # Scope PV name
epicsEnvSet( "NAME1", "$$SCOPEIP0" )                            # Scope descriptive name
