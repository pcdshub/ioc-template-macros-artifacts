...
$PROCSERV --logfile $IOC_DATA/$IOC/iocInfo/ioc.log --savefile --name $IOC $$IF(PROCSERV_PORT,$$PROCSERV_PORT,30001) $$(IOCTOP)/bin/$EPICS_HOST_ARCH/$$IF(APP,$$APP,gige) st.cmd
