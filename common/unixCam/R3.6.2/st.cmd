...
$$LOOP(CAMERA)
$$IF(TRIG)
dbLoadRecords( "db/camdelay.db", "CAM=$$NAME,EVR=$$EVRNAME,TRIGGER=$$TRIG,BAUDRATE=$$IF(BAUDRATE)$$BAUDRATE$$ELSE(BAUDRATE)$(CAMERA_BAUD_$$TYPE)$$ENDIF(BAUDRATE),DELAYFUDGE=$(CAMERA_FUDGE_$$TYPE)")
