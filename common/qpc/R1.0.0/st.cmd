...
$$LOOP(QPC)
dbLoadRecords( "db/qpc_controller.db", "BASE=$$BASE, DEV=bus$$INDEX" )
$$LOOP(QPC_SLOT)
dbLoadRecords( "db/qpc_channel.db", "CH_BASE=$$CH_BASE,DEV=bus$$QPCINDEX,BASE=$$QPCBASE,CHANNEL=$$CHANNEL,TTLCHAN=$$CALC{4+$$CHANNEL}" )
$$ENDLOOP(QPC_SLOT)
# Asyn Debug
