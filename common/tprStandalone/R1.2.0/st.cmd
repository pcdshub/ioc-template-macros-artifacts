#!$$IOCTOP/bin/$$IF(ARCH,$$ARCH,rhel7-x86_64)/tpr
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=$$TPR_PV,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=$$TPR_PV:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=$$TPR_PV,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
# Setup debugging
$$IF(DEBUG)
tprTriggerAsynDriverDebug("trig0", 1)
$$ENDIF(DEBUG)
