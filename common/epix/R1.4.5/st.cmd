...
$$LOOP(EPIX)
$$IF(PGPBOX)
dbLoadRecords("db/epix$$IF(QUAD,Quad,)Mon.db", "IOC=$(IOC_PV),BASE=$$BASE:$$NAME,BOX=$$PGPBOX,MASK=$$CALC{PGPMASK},SRPV3=$$IF(QUAD)$$IF(SRPV3,$$SRPV3,1)$$ELSE(QUAD)$$IF(SRPV3,$$SRPV3,0)$$ENDIF(QUAD)$$IF(QUAD)$$ELSE(QUAD),FIRM=$$IF(NEWFIRM,1,0)$$ENDIF(QUAD)")
$$ENDIF(PGPBOX)
$$ENDLOOP(EPIX)

$$LOOP(EPIXHR)
$$IF(PGPBOX)
dbLoadRecords("db/epixHrMon.db", "IOC=$(IOC_PV),BASE=$$BASE:$$NAME,BOX=$$PGPBOX,MASK=$$CALC{PGPMASK},SRPV3=$$IF(SRPV3,$$SRPV3,1)")
$$ENDIF(PGPBOX)
$$ENDLOOP(EPIXHR)

$$LOOP(EPIX2M)
$$IF(Q0_PGP)
dbLoadRecords("db/epixQuadMon.db", "IOC=$(IOC_PV),BASE=$$BASE:$$NAME:Q0,BOX=$$NAME(Q0_PGP,BOX),MASK=$$NAME(Q0_PGP,$$CALC{MASK}),SRPV3=$$IF(SRPV3,$$SRPV3,1)")
$$ENDIF(Q0_PGP)
$$IF(Q1_PGP)
dbLoadRecords("db/epixQuadMon.db", "IOC=$(IOC_PV),BASE=$$BASE:$$NAME:Q1,BOX=$$NAME(Q1_PGP,BOX),MASK=$$NAME(Q1_PGP,$$CALC{MASK}),SRPV3=$$IF(SRPV3,$$SRPV3,1)")
$$ENDIF(Q1_PGP)
$$IF(Q2_PGP)
dbLoadRecords("db/epixQuadMon.db", "IOC=$(IOC_PV),BASE=$$BASE:$$NAME:Q2,BOX=$$NAME(Q2_PGP,BOX),MASK=$$NAME(Q2_PGP,$$CALC{MASK}),SRPV3=$$IF(SRPV3,$$SRPV3,1)")
$$ENDIF(Q2_PGP)
$$IF(Q3_PGP)
dbLoadRecords("db/epixQuadMon.db", "IOC=$(IOC_PV),BASE=$$BASE:$$NAME:Q3,BOX=$$NAME(Q3_PGP,BOX),MASK=$$NAME(Q3_PGP,$$CALC{MASK}),SRPV3=$$IF(SRPV3,$$SRPV3,1)")
$$ENDIF(Q3_PGP)
$$ENDLOOP(EPIX2M)
