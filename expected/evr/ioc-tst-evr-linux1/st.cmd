...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tst-evr-linux1" )
epicsEnvSet( "ENGINEER",     "Michael Browne (mcbrowne)" )
epicsEnvSet( "LOCATION",     "TST:IOC:EVR:LINUX1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TST:IOC:EVR:LINUX1" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "TST:IOC:EVR:LINUX1" )
