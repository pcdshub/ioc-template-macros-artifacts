...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-cxi-evr-01" )
epicsEnvSet( "ENGINEER",     "Christina Pino (cpino)" )
epicsEnvSet( "LOCATION",     "CXI ioc-las-cxi-srv05" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:CXI:EVR:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:LAS:CXI:01" )
