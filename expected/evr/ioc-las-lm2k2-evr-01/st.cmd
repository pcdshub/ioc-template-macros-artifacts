...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lm2k2-evr-01" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "CRIX MODS ctl-las-crix-srv01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LM2K2:EVR:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "LM2K2:EVR:01" )
