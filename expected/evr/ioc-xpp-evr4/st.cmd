#!/reg/g/pcds/epics/ioc/common/evr/R1.3.0/bin/rhel7-x86_64/evr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-evr4" )
epicsEnvSet( "ENGINEER",     "Michael Browne (mcbrowne)" )
epicsEnvSet( "LOCATION",     "XPP:R30:IOC:28" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "XPP:R30:IOC:28:EVR" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "XPP:R30:EVR:28" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD)")
