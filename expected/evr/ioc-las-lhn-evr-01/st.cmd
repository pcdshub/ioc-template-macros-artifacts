...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lhn-evr-01" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "Laser Hall ctl-las-lhn-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:EVR:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:LAS:LHN:01" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD),IP0E=Enabled,IP1E=Enabled,IP2E=Enabled,IP3E=Enabled,IP4E=Enabled,IP5E=Enabled,IP6E=Enabled,IP7E=Enabled,IPAE=Enabled,IPBE=Enabled")
