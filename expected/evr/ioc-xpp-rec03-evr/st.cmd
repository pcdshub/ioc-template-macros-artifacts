#!/reg/g/pcds/package/epics/3.14/ioc/common/evr/R1.2.2/bin/linux-x86_64/evr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-rec03-evr" )
epicsEnvSet( "ENGINEER",     "Silke Nelson (snelson)" )
epicsEnvSet( "LOCATION",     "B950 XPP R30 rec03" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "XPP:R30:IOC:26:EVR" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/package/epics/3.14/ioc/common/evr/R1.2.2" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/xpp/evr/R1.0.0/build" )
cd( "$(IOCTOP)" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "XPP:R30:EVR:26" )
