#!/reg/g/pcds/epics/ioc/common/evr/R1.2.4/bin/linux-x86_64/evr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-crix-evr-01" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "BUILDING 950-chemRIX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CRIX:CAM:EVR:00" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/evr/R1.2.4" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/rix/evr/R1.1.0/build" )
cd( "$(IOCTOP)" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "CRIX:CAM:EVR:00" )
