...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-xcs-evr-01" )
epicsEnvSet( "ENGINEER",     "Karl Gumerlock (klg)" )
epicsEnvSet( "LOCATION",     "XCS ctl-las-xcs-srv01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:XCS:EVR:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:LAS:XCS:01" )
