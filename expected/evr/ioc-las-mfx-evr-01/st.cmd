...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-mfx-evr-01" )
epicsEnvSet( "ENGINEER",     "Karl Gumerlock (klg)" )
epicsEnvSet( "LOCATION",     "MFX ioc-las-mfx-srv45" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:MFX:EVR:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:LAS:MFX:01" )
