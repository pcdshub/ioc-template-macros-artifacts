...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lm1k4-evr-01" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "IP1 MODS ctl-las-ip1-srv01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LM1K4:EVR:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "LM1K4:EVR:01" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD),IP0E=Enabled,IP1E=Enabled,IP2E=Enabled,IP3E=Enabled,IP8E=Enabled,IP9E=Enabled,IPAE=Enabled,IPBE=Enabled")
