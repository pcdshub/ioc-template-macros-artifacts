...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lln-evr-02" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "Laser Hall ctl-las-lln-02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LLN:EVR:02" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:LAS:LLN:02" )
