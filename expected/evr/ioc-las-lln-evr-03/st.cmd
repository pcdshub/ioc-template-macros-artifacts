...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lln-evr-03" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "Laser Hall ctl-las-lln-03" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LLN:EVR:03" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:LAS:LLN:03" )
