...
< envPaths
epicsEnvSet("IOCNAME", "ioc-det-prt2-ctr" )
epicsEnvSet("ENGINEER", "Daniel Damiani (ddamiani)" )
epicsEnvSet("LOCATION", "IOC:DET:MBL:02:CTR" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:DET:MBL:02:CTR")
...
## Asyn record support
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=DET:MBL:02:CTR,R=:asyn,PORT=bus0,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus0","digi-det-portable2:2105", 0, 0, 0)
...
dbLoadRecords("db/concentrator.db",       "NAME=DET:MBL:02:CTR,bus=bus0")
