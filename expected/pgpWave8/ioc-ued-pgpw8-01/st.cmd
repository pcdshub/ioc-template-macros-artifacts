...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-ued-pgpw8-01" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Bldg ???-R???, HUTCH UED" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:UED:USR:DIO" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "UED:USR:DIO" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "UED:USR:DIO" )
