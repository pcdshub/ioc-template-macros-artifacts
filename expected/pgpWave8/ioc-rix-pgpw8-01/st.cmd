...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "MR3K2:FIM:W8:01" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "MR3K2:FIM:W8:01" )
