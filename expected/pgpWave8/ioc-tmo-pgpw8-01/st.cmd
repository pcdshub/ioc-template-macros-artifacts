...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-pgpw8-01" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Bldg 940-100H1-R03-E12, HUTCH TMO" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MR2K4:FIM:W8:IOC:01" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "MR2K4:FIM:W8:01" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "MR2K4:FIM:W8:01" )
