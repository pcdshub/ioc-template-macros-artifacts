...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-crix-pgpw8-03" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "CRIX MODS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "LM2K2:W8:IOC:03" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "LM2K2:W8:03" )

epicsEnvSet( "PGP_NAME",       		"WAVE8" )
epicsEnvSet( "PGP_BOARD",     		"0" )
epicsEnvSet( "PGP_LANE",     		"6" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "LM2K2:W8:03" )
