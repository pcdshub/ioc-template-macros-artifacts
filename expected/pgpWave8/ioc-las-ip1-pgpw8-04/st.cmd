...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-ip1-pgpw8-04" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "IP1 MODS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "LM1K4:W8:IOC:04" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "LM1K4:W8:04" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "LM1K4:W8:04" )
