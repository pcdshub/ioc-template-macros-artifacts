...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-crix-pgpw8-02" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "CRIX MODS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "LM2K2:W8:IOC:02" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "LM2K2:W8:02" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "LM2K2:W8:02" )
