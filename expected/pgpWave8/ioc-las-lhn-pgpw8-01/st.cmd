...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lhn-pgpw8-01" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "Laser Hall" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:W8:IOC:01" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "IOC:LAS:LHN:W8:01" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "IOC:LAS:LHN:W8:01" )
