...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-ip1-pgpw8-02" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "IP1 MODS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "LM1K4:W8:IOC:02" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "LM1K4:W8:02" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "LM1K4:W8:02" )
