...
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/txi/pgpWave8/R2.3.0/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-txi-pgpw8-01" )
epicsEnvSet( "ENGINEER",     "Josue Zamudio    (jozamudi)" )
epicsEnvSet( "LOCATION",     "HUTCH TXI" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TXI:RP:W8:IOC:01" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "TXI:RP:W8:01" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "TXI:RP:W8:01" )
