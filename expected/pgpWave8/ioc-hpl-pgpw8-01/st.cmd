...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-hpl-pgpw8-01" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "ASC OPCPA Lab" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:HPL:W8:IOC:01" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "IOC:HPL:W8:01" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "IOC:HPL:W8:01" )
