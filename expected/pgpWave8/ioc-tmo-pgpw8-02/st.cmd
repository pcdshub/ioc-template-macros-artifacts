#!/reg/g/pcds/epics/ioc/common/pgpWave8/R2.3.0/bin/rhel7-x86_64/pgpWave8

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/tmo/pgpWave8/R2.3.0/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-pgpw8-02" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Bldg 940-100H1-R03-E14, HUTCH TMO" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MR3K4:FIM:W8:IOC:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/pgpWave8/R2.3.0" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "MR3K4:FIM:W8:01" )

epicsEnvSet( "PGP_NAME",       		"WAVE8" )
epicsEnvSet( "PGP_BOARD",     		"0" )
epicsEnvSet( "PGP_LANE",     		"1" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "MR3K4:FIM:W8:01" )
