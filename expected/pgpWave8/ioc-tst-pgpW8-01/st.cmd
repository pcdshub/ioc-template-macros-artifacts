...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tst-pgpW8-01" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Bldg 84, Lab2, HUTCH TST" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TST:IOC:W8:01" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "TST:W8:REG:01" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "TST:W8:REG:01" )
