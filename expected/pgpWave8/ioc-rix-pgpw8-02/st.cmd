...
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/rix/pgpWave8/R2.3.0/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-pgpw8-02" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Bldg 940-233H2.2, HUTCH RIX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MR4K2:FIM:W8:IOC:02" )
...
# Specify PGP_PV
epicsEnvSet( "PGP_PV",       "MR4K2:FIM:W8:02" )
...
pgpRogueDevConfig( $(PGP_BOARD), $(PGP_LANE), $(ADDR_MAP_PATH), "MR4K2:FIM:W8:02" )
