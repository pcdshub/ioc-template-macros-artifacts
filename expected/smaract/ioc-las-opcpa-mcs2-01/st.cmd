...
epicsEnvSet("IOCNAME",    "ioc-las-opcpa-mcs2-01" )
epicsEnvSet("ENGINEER",   "tjohnson")
epicsEnvSet("LOCATION",   "Laser Hall Rack 18")
epicsEnvSet("IOCSH_PS1",  "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",     "IOC:LAS:OPCPA:MCS2:01")
...
drvAsynIPPortConfigure("TCP0", "mcp-las-opcpa-01:55551 TCP", 0, 0, 0 )
...
dbLoadRecords("db/asynRecord.db", "P=LAS:OPCPA:MCS2:01,R=:ASYN,PORT=TCP0,ADDR=0,OMAX=0,IMAX=0")
dbLoadRecords("db/SmarAct_global.db", "BASE=LAS:OPCPA:MCS2:01,DEF_EC=0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:OPCPA:MCS2:01,N=1,CH=0,MOD=0,PORT=MCS0,TCP=TCP0,PSEN=0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:OPCPA:MCS2:01,N=2,CH=1,MOD=0,PORT=MCS0,TCP=TCP0,PSEN=0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:OPCPA:MCS2:01,N=3,CH=2,MOD=0,PORT=MCS0,TCP=TCP0,PSEN=0")
dbLoadRecords("db/SmarAct_module.db", "BASE=LAS:OPCPA:MCS2:01,CH1=0,CH2=1,CH3=2,MOD=0,PORT=MCS0,TCP=TCP0")
...
set_pass0_restoreFile("ioc-las-opcpa-mcs2-01.sav")
