...
epicsEnvSet("IOCNAME",    "ioc-rix-crix-mcs2-01" )
epicsEnvSet("ENGINEER",   "Tyler Johnson (tjohnson)")
epicsEnvSet("LOCATION",   "ChemRIXS Endstation")
epicsEnvSet("IOCSH_PS1",  "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",     "IOC:CRIX:MCS2:01")
...
drvAsynIPPortConfigure("TCP0", "mcp-rix-crix-01:55551 TCP", 0, 0, 0 )
...
smarActMCS2CreateController("MCS0", "TCP0", 3, 0.2, 1.0)
...
dbLoadRecords("db/asynRecord.db", "P=CRIX:MCS2:01,R=:ASYN,PORT=TCP0,ADDR=0,OMAX=0,IMAX=0")
dbLoadRecords("db/SmarAct_global.db", "BASE=CRIX:MCS2:01,DEF_EC=0")
dbLoadRecords("db/SmarAct.db", "BASE=CRIX:MCS2:01,N=1,CH=0,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=CRIX:MCS2:01,N=2,CH=1,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/alias.db", "RECORD=CRIX:MCS2:01:m1,ALIAS=CRIX:MCS2:01:QUESTAR_TIP")
dbLoadRecords("db/alias.db", "RECORD=CRIX:MCS2:01:m2,ALIAS=CRIX:MCS2:01:QUESTAR_TILT")
...
set_pass0_restoreFile("ioc-rix-crix-mcs2-01.sav")
...
create_monitor_set("ioc-rix-crix-mcs2-01.req", 5, "")
