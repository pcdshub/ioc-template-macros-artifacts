...
< envPaths
epicsEnvSet("TOP", "/reg/g/pcds/epics/ioc/cxi/smaract/R1.0.0/build")
cd("$(IOCTOP)")
...
drvAsynIPPortConfigure("TCP0", "mcp-cxi-ds1-01:55551 TCP", 0, 0, 0 )
...
dbLoadRecords("db/asynRecord.db", "P=CXI:MCS2:01,R=:ASYN,PORT=TCP0,ADDR=0,OMAX=0,IMAX=0")
dbLoadRecords("db/SmarAct_global.db", "BASE=CXI:MCS2:01,DEF_EC=0")
dbLoadRecords("db/SmarAct.db", "BASE=CXI:MCS2:01,N=1,CH=0,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=CXI:MCS2:01,N=2,CH=1,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=CXI:MCS2:01,N=3,CH=2,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/alias.db", "RECORD=CXI:MCS2:01:m1,ALIAS=CXI:DS1:MCS:01")
dbLoadRecords("db/alias.db", "RECORD=CXI:MCS2:01:m2,ALIAS=CXI:DS1:MCS:02")
dbLoadRecords("db/alias.db", "RECORD=CXI:MCS2:01:m2,ALIAS=CXI:DS1:MCS:02")
...
set_pass0_restoreFile("ioc-cxi-mcs2-01.sav")
...
create_monitor_set("ioc-cxi-mcs2-01.req", 5, "")
