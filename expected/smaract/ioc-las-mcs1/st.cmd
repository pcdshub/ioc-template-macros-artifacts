#!/reg/g/pcds/epics/ioc/xcs/smaract/R1.0.0/bin/rhel7-x86_64/smaract
...
epicsEnvSet("IOCTOP",     "/reg/g/pcds/epics/ioc/xcs/smaract/R1.0.0")
...
drvAsynIPPortConfigure("TCP0", "mcs-las-tst02:55551 TCP", 0, 0, 0 )
...
dbLoadRecords("db/asynRecord.db", "P=LAS:MCS2:01,R=:ASYN,PORT=TCP0,ADDR=0,OMAX=0,IMAX=0")
dbLoadRecords("db/SmarAct_global.db", "BASE=LAS:MCS2:01,DEF_EC=40")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=1,CH=0,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=2,CH=1,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=3,CH=2,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=4,CH=3,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=5,CH=4,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=6,CH=5,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=7,CH=6,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=8,CH=7,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=LAS:MCS2:01,N=9,CH=8,PORT=MCS0,TCP=TCP0")
