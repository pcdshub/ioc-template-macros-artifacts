...
drvAsynIPPortConfigure("TCP0", "mcp-rix-qrix-03:55551 TCP", 0, 0, 0 )
...
dbLoadRecords("db/asynRecord.db", "P=QRIX:MCS2:02,R=:ASYN,PORT=TCP0,ADDR=0,OMAX=0,IMAX=0")
dbLoadRecords("db/SmarAct_global.db", "BASE=QRIX:MCS2:02,DEF_EC=0")
dbLoadRecords("db/SmarAct.db", "BASE=QRIX:MCS2:02,N=1,CH=0,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/SmarAct.db", "BASE=QRIX:MCS2:02,N=2,CH=1,PORT=MCS0,TCP=TCP0")
dbLoadRecords("db/alias.db", "RECORD=QRIX:MCS2:02:m1,ALIAS=QRIX:MCS2:02:MID_IR_H")
dbLoadRecords("db/alias.db", "RECORD=QRIX:MCS2:02:m2,ALIAS=QRIX:MCS2:02:DIAG_H")
...
set_pass0_restoreFile("ioc-rix-qrix-mcs2-02.sav")
...
create_monitor_set("ioc-rix-qrix-mcs2-02.req", 5, "")
