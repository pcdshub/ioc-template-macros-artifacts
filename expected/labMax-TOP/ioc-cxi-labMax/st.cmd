...
epicsEnvSet("IOCNAME",    "ioc-cxi-labMax" )
epicsEnvSet("ENGINEER",   "snelson")
epicsEnvSet("LOCATION",   "CXI:EXP:IOC:LEM")
epicsEnvSet("IOCSH_PS1",  "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",     "CXI:EXP:IOC:LEM")
...
# Coherent LabMax-TOP:
drvAsynIPPortConfigure( "bus0","digi-cxi-22:2001", 0, 0, 0 )
...
dbLoadRecords( "db/labMax-Top.db",		"P=CXI:EXP:LEM:01,PORT=bus0" )
dbLoadRecords( "db/asynRecord.db",		"P=CXI:EXP:LEM:01,PORT=bus0,R=:asyn,ADDR=0,IMAX=0,OMAX=0" )
