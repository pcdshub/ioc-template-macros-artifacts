...
epicsEnvSet("IOCNAME",    "ioc-xpp-labMax-usr" )
epicsEnvSet("ENGINEER",   "Thu Lam (tlam)")
epicsEnvSet("LOCATION",   "XPP:R35:IOC:43:LPW:02")
epicsEnvSet("IOCSH_PS1",  "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",     "XPP:R35:IOC:43:LPW:02")
...
# Coherent LabMax-TOP:
drvAsynIPPortConfigure( "bus0","digi-xpp-13:2010", 0, 0, 0 )
...
dbLoadRecords( "db/labMax-Top.db",		"P=XPP:USR:LPW:01,PORT=bus0" )
dbLoadRecords( "db/asynRecord.db",		"P=XPP:USR:LPW:01,PORT=bus0,R=:asyn,ADDR=0,IMAX=0,OMAX=0" )
