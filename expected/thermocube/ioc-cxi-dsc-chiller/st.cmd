...
< envPaths
epicsEnvSet("IOCNAME", "ioc-cxi-dsc-chiller" )
epicsEnvSet("ENGINEER", "Christian Tsoi-A-Sue (ctsoi)" )
epicsEnvSet("LOCATION", "IOC:CXI:DSC:CHL" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:CXI:DSC:CHL")
...
## Asyn record support
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=CXI:DSC,R=:asyn,PORT=bus0,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus0","moxa-cxi-03:4015",0,0,0)
...
dbLoadRecords("db/chiller.db", "PRE=CXI:DSC,bus=0")
dbLoadRecords("$(FLOWDB_PROTEUS)", "PRE=CXI:DSC,AI=CXI:DS1:AIN:01:ai0:in9")
