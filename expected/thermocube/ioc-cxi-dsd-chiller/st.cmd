...
< envPaths
epicsEnvSet("IOCNAME", "ioc-cxi-dsd-chiller" )
epicsEnvSet("ENGINEER", "Christian Tsoi-A-Sue (ctsoi)" )
epicsEnvSet("LOCATION", "IOC:CXI:DSD:CHL" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:CXI:DSD:CHL")
...
## Asyn record support
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=CXI:DSD,R=:asyn,PORT=bus0,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus0","moxa-cxi-03:4014",0,0,0)
...
dbLoadRecords("db/chiller.db", "PRE=CXI:DSD,bus=0")
dbLoadRecords("$(FLOWDB_PROTEUS)", "PRE=CXI:DSD,AI=CXI:DS1:AIN:01:ai0:in2")
