...
< envPaths
epicsEnvSet("IOCNAME", "ioc-cxi-dg2-chiller" )
epicsEnvSet("ENGINEER", "Christian Tsoi-A-Sue (ctsoi)" )
epicsEnvSet("LOCATION", "IOC:CXI:DG2:CHL" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:CXI:DG2:CHL")
...
dbLoadRecords("$(FLOWDB_PROTEUS)", "PRE=CXI:DG2:CHL:01,AI=CXI:DS1:AIN:01:ai0:in3")
