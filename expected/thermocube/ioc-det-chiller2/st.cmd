...
< envPaths
epicsEnvSet("IOCNAME", "ioc-det-chiller2" )
epicsEnvSet("ENGINEER", "Daniel Damiani (ddamiani)" )
epicsEnvSet("LOCATION", "IOC:DET:CHL:2" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:DET:CHL:2")
...
## Asyn record support
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=DET:CHL:02,R=:asyn,PORT=bus0,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus0","digi-det-portable2:2001",0,0,0)
...
dbLoadRecords("db/chiller.db", "PRE=DET:CHL:02,bus=0")
