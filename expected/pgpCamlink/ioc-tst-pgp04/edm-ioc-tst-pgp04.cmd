...
export CAM=TST:PGP:CAM4
export IOC_PV=TST:IOC:CAM4
...
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/ioc-tst-pgp04/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/ioc-tst-pgp04/iocSpecificRelease/`
	fi
fi
