...
export CAM=TST:PGP:CAM2
export IOC_PV=TST:IOC:CAM2
...
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/ioc-tst-pgp02/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/ioc-tst-pgp02/iocSpecificRelease/`
	fi
fi
