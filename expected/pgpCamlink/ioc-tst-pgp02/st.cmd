#!/reg/g/pcds/epics/ioc/common/pgpCamlink/R1.7.1/bin/rhel7-x86_64/pgpCl
...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tst-pgp02" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Bldg 84, Lab 2, HUTCH TST" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TST:IOC:CAM2" )
...
epicsEnvSet( "SER_TRACE_IO_MASK",	"4" )
