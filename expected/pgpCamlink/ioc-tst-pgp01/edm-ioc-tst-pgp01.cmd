...
export CAM=TST:PGP:CAM1
export IOC_PV=TST:IOC:CAM1
...
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/ioc-tst-pgp01/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/ioc-tst-pgp01/iocSpecificRelease/`
	fi
fi
