...
export PGP_IOC=PgpIocUnk
export CAM_NAME="Unnamed"
export TRIG_CH=0
export HUTCH=kfe
export TOP=/reg/g/pcds/epics/ioc/common/pgpCamlink/R1.7.1
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/ioc-kfe-rogue1/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/ioc-kfe-rogue1/iocSpecificRelease/`
	fi
fi
