...
export CAM=CAMR:B84:LAB2:BASLER2040
export IOC_PV=IOC:B84:LAB2:BASLER2040
export PGP_PV=CAMR:B84:LAB2:PGP:01
export PGP_IOC=IOC:B84:LAB2:PGP:01
export CAM_NAME="Unnamed"
export TRIG_CH=1
export HUTCH=dev
export TOP=/reg/g/pcds/epics/ioc/common/pgpCamlink/R1.7.1
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/vioc-b084-pgp02/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/vioc-b084-pgp02/iocSpecificRelease/`
	fi
fi
