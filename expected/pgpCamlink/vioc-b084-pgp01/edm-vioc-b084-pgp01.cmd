...
export CAM=CAMR:B84:LAB2:O1000
export IOC_PV=IOC:B84:LAB2:O1000
...
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/vioc-b084-pgp01/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/vioc-b084-pgp01/iocSpecificRelease/`
	fi
fi
