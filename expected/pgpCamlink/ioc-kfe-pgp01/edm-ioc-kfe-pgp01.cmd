...
export CAM=IM1K0:XTES:CAM
export IOC_PV=IM1K0:XTES:CAM:IOC
export PGP_PV=IM0K0:PGP:ROGUE1
export PGP_IOC=IM0K0:IOC:ROGUE1
export CAM_NAME="IM1K0"
export TRIG_CH=0
export HUTCH=kfe
export TOP=/reg/g/pcds/epics/ioc/common/pgpCamlink/R1.7.1
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/ioc-kfe-pgp01/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/ioc-kfe-pgp01/iocSpecificRelease/`
	fi
fi
