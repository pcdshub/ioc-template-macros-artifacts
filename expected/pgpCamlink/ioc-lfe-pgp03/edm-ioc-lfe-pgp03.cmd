...
export CAM=IM4L0:XTES:CAM
export IOC_PV=IM4L0:XTES:CAM:IOC
export PGP_PV=IM0L0:PGP:ROGUE1
export PGP_IOC=IM0L0:IOC:ROGUE1
export CAM_NAME="IM4L0"
export TRIG_CH=2
export HUTCH=kfe
export TOP=/reg/g/pcds/epics/ioc/common/pgpCamlink/R1.7.1
if [ ! -d $TOP ]; then
	if [ -d $EPICS_IOCS/ioc-lfe-pgp03/iocSpecificRelease/iocBoot ]; then
		export TOP=`readlink -f $EPICS_IOCS/ioc-lfe-pgp03/iocSpecificRelease/`
	fi
fi
