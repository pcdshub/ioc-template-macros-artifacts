...
epicsEnvSet("IOCNAME",    "ioc-xcs-labMax" )
epicsEnvSet("ENGINEER",   "Carolyn Gee (cagee)")
epicsEnvSet("LOCATION",   "XCS:G40:LPW:01")
epicsEnvSet("IOCSH_PS1",  "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",     "XCS:LPW:01")
...
< envPaths
epicsEnvSet("TOP", "/reg/g/pcds/epics/ioc/xcs/labmax/R1.0.0/build")
cd("$(IOCTOP)")
...
# Coherent LabMax-TOP:
drvAsynIPPortConfigure( "bus0","moxa-xcs-10:4001", 0, 0, 0 )
...
dbLoadRecords( "db/labMax-Top.db",		"P=XCS:LPW:01,PORT=bus0" )
dbLoadRecords( "db/asynRecord.db",		"P=XCS:LPW:01,PORT=bus0,R=:asyn,ADDR=0,IMAX=0,OMAX=0" )
