...
< envPaths
epicsEnvSet("IOCNAME", "ioc-tmo-ip2-temp" )
epicsEnvSet("ENGINEER", "Janez Govednik (janezg)" )
epicsEnvSet("LOCATION", "TMO:IP2:TCT:01" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:TMO:IP2:TCT:01")
...
drvAsynSerialPortConfigure("ls335-LSA26P7","/dev/ls335-LSA26P7",0,0,0)
asynSetOption("ls335-LSA26P7",0,"baud","57600")
asynSetOption("ls335-LSA26P7",0,"bits","7")
asynSetOption("ls335-LSA26P7",0,"parity","odd")


# Load record instances
dbLoadRecords( "db/iocSoft.db",             "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db",  "IOC=$(IOC_PV)" )
dbLoadRecords("db/lakeshore335.db","TCT=TMO:IP2:TCT:01,PORT=ls335-LSA26P7,DSCAN=1,CSCAN=5")
