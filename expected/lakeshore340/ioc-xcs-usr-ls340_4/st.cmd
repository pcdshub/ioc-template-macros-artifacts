...
< envPaths
epicsEnvSet("IOCNAME", "ioc-xcs-usr-ls340_4" )
...
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=XCS:USR:TCT:04,R=:asyn,PORT=bus3,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus3","digi-xcs-19:2009",0,0,0)
...
asynSetTraceMask("bus3", 0, 0x1) # logging for normal operation
...
dbLoadRecords( "db/lakeshore340.db",        "NAME=XCS:USR:TCT:04, bus=3, TEMPSCAN=10" )
dbLoadRecords( "db/LakeshoreKtoC.db",       "NAME=XCS:USR:TCT:04" )
