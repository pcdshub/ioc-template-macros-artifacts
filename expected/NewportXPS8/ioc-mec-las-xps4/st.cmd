...
epicsEnvSet( "EPICS_NAME", "IOC:MEC:LAS:XPS4" )
epicsEnvSet( "LOCATION",   "MEC:XXX"  )
epicsEnvSet( "IOCSH_PS1",  "ioc-mec-las-xps4> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-mec-las-xps4/autosave" )

set_pass0_restoreFile( "ioc-mec-las-xps4.sav"                  )
...
create_monitor_set( "ioc-mec-las-xps4.req", 30, "" );
