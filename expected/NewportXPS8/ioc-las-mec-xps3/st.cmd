...
epicsEnvSet( "EPICS_NAME", "IOC:LAS:MEC:XPS3" )
epicsEnvSet( "LOCATION",   "MEC:XXX"  )
epicsEnvSet( "IOCSH_PS1",  "ioc-las-mec-xps3> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-las-mec-xps3/autosave" )

set_pass0_restoreFile( "ioc-las-mec-xps3.sav"                  )
...
create_monitor_set( "ioc-las-mec-xps3.req", 30, "" );
