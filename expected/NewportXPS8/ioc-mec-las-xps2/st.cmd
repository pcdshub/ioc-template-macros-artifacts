...
epicsEnvSet( "EPICS_NAME", "IOC:MEC:LAS:XPS2" )
epicsEnvSet( "LOCATION",   "MEC:XXX"  )
epicsEnvSet( "IOCSH_PS1",  "ioc-mec-las-xps2> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-mec-las-xps2/autosave" )

set_pass0_restoreFile( "ioc-mec-las-xps2.sav"                  )
...
create_monitor_set( "ioc-mec-las-xps2.req", 30, "" );
