...
epicsEnvSet( "EPICS_NAME", "IOC:LAS:MEC:XPS1" )
epicsEnvSet( "LOCATION",   "MEC:XXX"  )
epicsEnvSet( "IOCSH_PS1",  "ioc-las-mec-xps1> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-las-mec-xps1/autosave" )

set_pass0_restoreFile( "ioc-las-mec-xps1.sav"                  )
...
create_monitor_set( "ioc-las-mec-xps1.req", 30, "" );
