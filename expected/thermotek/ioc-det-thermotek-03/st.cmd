...
##############################################################
drvAsynIPPortConfigure( "bus0", "digi-det-portable2:2104", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/thermotek.db", "P=DET:TTK:03, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-det-thermotek-03.sav" )
set_pass1_restoreFile( "ioc-det-thermotek-03.sav" )

# Initialize the IOC and start processing records
iocInit()

# Start autosave backups
create_monitor_set( "ioc-det-thermotek-03.req", 5, "" )
