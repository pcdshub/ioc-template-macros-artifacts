...
epicsEnvSet( "IOCNAME",	  "ioc-ued-thermotek-01" )
epicsEnvSet( "ENGINEER",  "Michael Browne" )
epicsEnvSet( "LOCATION",  "UED" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:UED:TTK:01" )
...
< envPaths
epicsEnvSet("TOP", "/reg/g/pcds/epics/ioc/ued/thermotek/R1.0.1/build")
cd("$(IOCTOP)")
...
##############################################################
drvAsynIPPortConfigure( "bus0", "moxa-ued-01:4008", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/thermotek.db", "P=UED:TTK:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-ued-thermotek-01.sav" )
set_pass1_restoreFile( "ioc-ued-thermotek-01.sav" )

# Initialize the IOC and start processing records
iocInit()

# Start autosave backups
create_monitor_set( "ioc-ued-thermotek-01.req", 5, "" )
