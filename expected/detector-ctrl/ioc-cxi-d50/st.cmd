...
## Asyn record support
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=CXI:DS2:TE-TECH1,R=:asyn,PORT=bus0,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus0","digi-cxi-21:2015", 0, 0, 0)
dbLoadRecords("$(ASYN)/db/asynRecord.db","P=CXI:DS2:TE-TECH2,R=:asyn,PORT=bus1,ADDR=0,OMAX=0,IMAX=0")
drvAsynIPPortConfigure ("bus1","digi-cxi-21:2016", 0, 0, 0)
...
dbLoadRecords("db/TE_tech.db",  "TE_cont=CXI:DS2:TE-TECH1, bus=0")
dbLoadRecords("db/TE_tech.db",  "TE_cont=CXI:DS2:TE-TECH2, bus=1")
dbLoadRecords($(DETDB_EPICS), "PRED=CXI:DS2, PRE=CXI:D50, MPDQ0=100, MPAQ0=101, MPDQ1=102, MPAQ1=103, MPDQ2=104, MPAQ2=105, MPDQ3=106, MPAQ3=107, MPHQ0=0, MPHQ1=1, MPHQ2=2, MPHQ3=3, MPC=202, DET=CXI:USER:DS2")
