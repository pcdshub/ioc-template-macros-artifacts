...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-mec-epix")
epicsEnvSet("ENGINEER",  "Zachary Lentz (zlentz)")
epicsEnvSet("LOCATION",  "IOC:MEC:EPIX")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=MEC:EPIX:01, PREM=MEC:D60, DLVCHN=206, ALVCHN=207, PLVCHN=205, HVCHN=7")
