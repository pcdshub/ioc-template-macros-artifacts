...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xcs-det")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "XCS:R35:IOC:39:DET")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "XCS:IOC:DET")
...
dbLoadRecords($(DETDB_EPICS), "PRED=XCS:DET, PRE=XCS:DET, MPDQ0=0, MPAQ0=1, MPDQ1=2, MPAQ1=3, MPDQ2=4, MPAQ2=5, MPDQ3=6, MPAQ3=7, MPHQ0=200, MPHQ1=201, MPHQ2=202, MPHQ3=203, MPC=102, DET=XCS:USER:DET")
