...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xcs-lam-epix-1")
epicsEnvSet("ENGINEER",  "Rajan Plumley (rajan-01)")
epicsEnvSet("LOCATION",  "XCS:LAM:EPIX:01")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XCS:LAM:EPIX:01")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=XCS:LAM:EPIX:01, PREM=XCS:LAM, DLVCHN=2, ALVCHN=3, PLVCHN=4, HVCHN=101")
