...
epicsEnvSet("LOCATION",  "DET:EPIX:2")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:DET:EPIX:2")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=DET:EPIX:2:01, PREM=DET:MBL2, DLVCHN=0, ALVCHN=1, PLVCHN=2, HVCHN=200")
dbLoadRecords("db/detector-epix-peltier.db", "DET=DET:EPIX:2:02, PREM=DET:MBL2, DLVCHN=4, ALVCHN=5, PLVCHN=3, HVCHN=202")
dbLoadRecords("db/detector-epix-peltier.db", "DET=DET:EPIX:2:03, PREM=DET:MBL2, DLVCHN=100, ALVCHN=101, PLVCHN=104, HVCHN=204")
dbLoadRecords("db/detector-epix-peltier.db", "DET=DET:EPIX:2:04, PREM=DET:MBL2, DLVCHN=106, ALVCHN=107, PLVCHN=105, HVCHN=207")
