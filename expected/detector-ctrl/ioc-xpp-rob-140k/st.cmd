...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xpp-rob-140k")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "XPP:ROB:140K")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XPP:ROB:140K")
...
dbLoadRecords("db/detector-140k.db", "DET=XPP:ROB:140K, PREM=XPP:DET, DLVCHN=100, ALVCHN=101, HVCHN=204")
