...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xcs-gon-epix-4")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "XCS:DET:EPIX")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XCS:DET:EPIX:04")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=XCS:DET:EPIX:04, PREM=XCS:DET, DLVCHN=206, ALVCHN=207, PLVCHN=205, HVCHN=103")
