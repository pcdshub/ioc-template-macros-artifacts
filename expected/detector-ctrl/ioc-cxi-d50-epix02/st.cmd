...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-cxi-d50-epix02")
epicsEnvSet("ENGINEER",  "Jason Koglin (koglin)")
epicsEnvSet("LOCATION",  "CXI:D50:IOC:02:DET")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "CXI:IOC:D50:EPIX02")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=CXI:D50:EPIX:02, PREM=CXI:D50, DLVCHN=100, ALVCHN=101, PLVCHN=102, HVCHN=0")
