...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-det-cspad")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "DET:CSPAD")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:DET:CSPAD")
...
dbLoadRecords($(DETDB_DAQ), "PRED=DET:CSPAD, PRE=DET:MBL, MPDQ0=0, MPAQ0=1, MPDQ1=2, MPAQ1=3, MPDQ2=4, MPAQ2=5, MPDQ3=6, MPAQ3=7, MPHQ0=200, MPHQ1=201, MPHQ2=202, MPHQ3=203, MPC=102, DET=DET:USER:DET")
