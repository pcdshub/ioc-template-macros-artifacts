...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-mec-epix-2")
epicsEnvSet("ENGINEER",  "Sameen Yunus (sfsyunus)")
epicsEnvSet("LOCATION",  "IOC:MEC:EPIX:02")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:MEC:EPIX:02")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=MEC:EPIX:02, PREM=MEC:D60, DLVCHN=200, ALVCHN=201, PLVCHN=204, HVCHN=4")
