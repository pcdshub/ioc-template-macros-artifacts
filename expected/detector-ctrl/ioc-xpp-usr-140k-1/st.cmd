...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xpp-usr-140k-1")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "XPP:R31:IOC:13:140K")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XPP:USR:140K:01")
...
dbLoadRecords("db/detector-140k.db", "DET=XPP:USR:140K:01, PREM=XPP:R39, DLVCHN=6, ALVCHN=7, HVCHN=102")
