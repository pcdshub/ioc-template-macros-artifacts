...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xcs-gon-140k-2")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "XCS:GON:IOC:140K")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XCS:DET:140K:02")
...
dbLoadRecords("db/detector-140k.db", "DET=XCS:DET:140K:02, PREM=XCS:DET, DLVCHN=200, ALVCHN=201, HVCHN=100")
