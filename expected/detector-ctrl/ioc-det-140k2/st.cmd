...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-det-140k2")
epicsEnvSet("ENGINEER",  "Silke Nelson (snelson)")
epicsEnvSet("LOCATION",  "DET:140K:2")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:DET:140K:2")
...
dbLoadRecords("db/detector-140k.db", "DET=DET:140K:2:04, PREM=DET:MBL2, DLVCHN=100, ALVCHN=101, HVCHN=204")
dbLoadRecords("db/detector-140k.db", "DET=DET:140K:2:06, PREM=DET:MBL2, DLVCHN=104, ALVCHN=105, HVCHN=206")
dbLoadRecords("db/detector-140k.db", "DET=DET:140K:2:07, PREM=DET:MBL2, DLVCHN=106, ALVCHN=107, HVCHN=207")
