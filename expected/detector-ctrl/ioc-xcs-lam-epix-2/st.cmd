...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xcs-lam-epix-2")
epicsEnvSet("ENGINEER",  "Rajan Plumley (rajan-01)")
epicsEnvSet("LOCATION",  "XCS:LAM:EPIX:02")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XCS:LAM:EPIX:02")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=XCS:LAM:EPIX:02, PREM=XCS:LAM, DLVCHN=5, ALVCHN=6, PLVCHN=7, HVCHN=102")
