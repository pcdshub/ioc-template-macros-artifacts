...
epicsEnvSet( "IOCNAME",      "ioc-mec-streak-01" )
epicsEnvSet( "ENGINEER" , "joaoprod" )
epicsEnvSet( "LOCATION",     "MEC" )
epicsEnvSet( "IOCSH_PS1", "ioc-mec-streak-01>" )
epicsEnvSet( "IOC_PV",       "IOC:MEC:STREAK:01" )
...
#epicsEnvSet( "IOC",       "IOC:MEC:STREAK:01" )

epicsEnvSet( "CAM_PV",       "MEC:STREAK:01" )

# Set Max array size
#epicsEnvSet( "EPICS_CA_MAX_ARRAY_BYTES", "20000000" )
epicsEnvSet( "EPICS_CA_MAX_ARRAY_BYTES", "20000000" )

epicsEnvSet( "VISAR_IP",      "172.21.46.71"       )
epicsEnvSet( "VISAR_PORT_C",	  "1001"     )
epicsEnvSet( "VISAR_PORT_D",	  "1002"     )
epicsEnvSet( "VISAR_CAL_FILE",	  "/reg/g/pcds/epics/ioc/mec/visar/R1.0.4/VISAR1.txt"     )


# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "EVR:MEC:STREAK:01" )
...
dbLoadRecords( "db/shadowEvr.db", "LOCAL=EVR:MEC:STREAK:01:TRIG0,REMOTE=EVR:MEC:USR01:TRIG4,CAM=$(CAM_PV)" )
