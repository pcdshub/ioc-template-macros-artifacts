#!/reg/g/pcds/package/epics/3.14/ioc/common/dg/R2.0.3/bin/linux-x86_64/delaygenApp


< envPaths

epicsEnvSet( "ENGINEER" , "Aalayah Spencer(spencera)" )
epicsEnvSet( "IOCSH_PS1", "ioc-xpp-delaygen2>" )
epicsEnvSet( "IOCENAME",  "IOC:XPP:DELAYGEN2" )
epicsEnvSet( "IOCPVROOT", "XPP:IOC:DDG:02")
epicsEnvSet( "LOCATION",  "XPP:USR")
epicsEnvSet( "IP",        "delaygen-xpp-02"       )
epicsEnvSet( "DG",        "XPP:DDG:02"     )
epicsEnvSet( "IOC_TOP",   "/reg/g/pcds/package/epics/3.14/ioc/common/dg/R2.0.3"   )
epicsEnvSet( "TOP",       "/reg/g/pcds/epics/ioc/xpp/dg/R0.0.4/build"      )
