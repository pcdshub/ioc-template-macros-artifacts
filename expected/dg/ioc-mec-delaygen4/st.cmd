...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen4>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN4" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:04")
epicsEnvSet( "LOCATION",  "MEC:M64A:42")
epicsEnvSet( "IP",        "delaygen-mec-04"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:04"     )
