...
epicsEnvSet( "IOCSH_PS1", "ioc-xcs-delaygen1>" )
epicsEnvSet( "IOCENAME",  "IOC:XCS:DELAYGEN1" )
epicsEnvSet( "IOCPVROOT", "IOC:XCS:DELAYGEN:01")
epicsEnvSet( "LOCATION",  "IOC:XCS:DELAYGEN:01")
epicsEnvSet( "IP",        "delaygen-xcs-01"       )
epicsEnvSet( "DG",        "XCS:MOB:DDG:01"     )
