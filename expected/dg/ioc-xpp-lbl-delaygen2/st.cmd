...
epicsEnvSet( "IOCSH_PS1", "ioc-xpp-lbl-delaygen2>" )
epicsEnvSet( "IOCENAME",  "IOC:XPP:LBL:DELAYGEN2" )
epicsEnvSet( "IOCPVROOT", "XPP:IOC:LBL:DDG:02")
epicsEnvSet( "LOCATION",  "XPP:LBL:USR")
epicsEnvSet( "IP",        "delaygen-lbl-02"       )
epicsEnvSet( "DG",        "XPP:LBL:DDG:02"     )
