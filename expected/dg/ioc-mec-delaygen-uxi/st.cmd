...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen-uxi>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN:UXI" )
epicsEnvSet( "IOCPVROOT", "MEC:IOC:DDG:UXI")
epicsEnvSet( "LOCATION",  "MEC")
epicsEnvSet( "IP",        "delaygen-mec-uxi"       )
epicsEnvSet( "DG",        "MEC:DDG:UXI"     )
