#!/reg/g/pcds/package/epics/3.14/ioc/common/dg/R3.0.0/bin/rhel7-x86_64/delaygenApp


< envPaths

epicsEnvSet( "ENGINEER" , "Daniel Damiani (ddamiani)" )
epicsEnvSet( "IOCSH_PS1", "ioc-xcs-delaygen2>" )
epicsEnvSet( "IOCENAME",  "IOC:XCS:DELAYGEN2" )
epicsEnvSet( "IOCPVROOT", "IOC:XCS:DELAYGEN:02")
epicsEnvSet( "LOCATION",  "IOC:XCS:DELAYGEN:02")
epicsEnvSet( "IP",        "delaygen-xcs-02"       )
epicsEnvSet( "DG",        "XCS:MOB:DDG:02"     )
epicsEnvSet( "IOC_TOP",   "/reg/g/pcds/package/epics/3.14/ioc/common/dg/R3.0.0"   )
epicsEnvSet( "TOP",       "/reg/g/pcds/epics/ioc/xcs/dg/R3.0.0/build"      )
