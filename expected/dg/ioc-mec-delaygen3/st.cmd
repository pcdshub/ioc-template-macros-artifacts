...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen3>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN3" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:03")
epicsEnvSet( "LOCATION",  "MEC:M64A:42")
epicsEnvSet( "IP",        "delaygen-mec-03"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:03"     )
