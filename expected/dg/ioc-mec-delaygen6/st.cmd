...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen6>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN6" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:06")
epicsEnvSet( "LOCATION",  "MEC:LAS:TABL")
epicsEnvSet( "IP",        "delaygen-mec-06"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:06"     )
