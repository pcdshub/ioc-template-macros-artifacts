...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen8>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN8" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:08")
epicsEnvSet( "LOCATION",  "MEC:LAS:TABL")
epicsEnvSet( "IP",        "delaygen-mec-08"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:08"     )
