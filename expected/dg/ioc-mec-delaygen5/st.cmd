...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen5>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN5" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:05")
epicsEnvSet( "LOCATION",  "MEC:M64A:42")
epicsEnvSet( "IP",        "delaygen-mec-05"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:05"     )
