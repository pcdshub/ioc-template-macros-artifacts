...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen2>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN2" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:02")
epicsEnvSet( "LOCATION",  "MEC:M64A:42")
epicsEnvSet( "IP",        "delaygen-mec-02"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:02"     )
