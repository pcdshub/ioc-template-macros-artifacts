...
epicsEnvSet( "IOCSH_PS1", "ioc-xpp-lbl-delaygen1>" )
epicsEnvSet( "IOCENAME",  "IOC:XPP:LBL:DELAYGEN1" )
epicsEnvSet( "IOCPVROOT", "XPP:IOC:LBL:DDG:01")
epicsEnvSet( "LOCATION",  "XPP:LBL:USR")
epicsEnvSet( "IP",        "delaygen-lbl-01"       )
epicsEnvSet( "DG",        "XPP:LBL:DDG:01"     )
