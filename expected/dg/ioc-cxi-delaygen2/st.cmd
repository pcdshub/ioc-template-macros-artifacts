#!/reg/g/pcds/package/epics/3.14/ioc/common/dg/R2.0.1/bin/linux-x86_64/delaygenApp


< envPaths

epicsEnvSet( "ENGINEER" , "Teddy Rendahl (trendahl)" )
epicsEnvSet( "IOCSH_PS1", "ioc-cxi-delaygen2>" )
epicsEnvSet( "IOCPVROOT", "IOC:CXI:DELAYGEN2" )
epicsEnvSet( "IP",        "delaygen-cxi-02"       )
epicsEnvSet( "DG",        "CXI:MOB:DDG:02"     )
epicsEnvSet( "IOC_TOP",    "/reg/g/pcds/package/epics/3.14/ioc/common/dg/R2.0.1"   )
epicsEnvSet( "TOP",       "/reg/g/pcds/epics/ioc/cxi/dg/R1.0.0/build"      )
...
dbLoadRecords( "db/iocAdmin.db",			"IOC=$(IOCPVROOT)" )
