...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-delaygen7>" )
epicsEnvSet( "IOCENAME",  "IOC:MEC:DELAYGEN7" )
epicsEnvSet( "IOCPVROOT", "MEC:LAS:IOC:DDG:07")
epicsEnvSet( "LOCATION",  "MEC:LAS:TABL")
epicsEnvSet( "IP",        "delaygen-mec-07"       )
epicsEnvSet( "DG",        "MEC:LAS:DDG:07"     )
