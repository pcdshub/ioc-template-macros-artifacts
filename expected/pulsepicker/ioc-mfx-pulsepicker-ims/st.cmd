...
epicsEnvSet( "LOCATION", "MFX:DIA" )
# Local protocol for MEC specific
epicsEnvSet( "STREAM_PROTOCOL_PATH", "protocol" )
# Picker motor settings
epicsEnvSet( "PP_PORT",  "smc-mfx-06.pcdsn:2103" )
epicsEnvSet( "PP_MOTOR", "07" )
# X translation settings
epicsEnvSet( "XT_PORT",  "smc-mfx-06.pcdsn:2101" )
epicsEnvSet( "XT_MOTOR", "05" )
# Y translation settings
epicsEnvSet( "YT_PORT",  "smc-mfx-06.pcdsn:2102" )
epicsEnvSet( "YT_MOTOR", "06" )
# PV settings
epicsEnvSet( "LOC", "MFX" )
epicsEnvSet( "SYS", "DIA" )
epicsEnvSet( "MMS", "MMS" )
epicsEnvSet( "IOC",    "ioc-mfx-pulsepicker-ims" )
epicsEnvSet( "IOC_PV", "MFX:IOC:PP:IMS" )
...
dbLoadRecords("db/iocAdmin.db",         "IOC=MFX:IOC:PP:IMS")
