...
epicsEnvSet( "PP_PORT",  "digi-cxi-31.pcdsn:2107" )
epicsEnvSet( "PP_MOTOR", "14" )
# X translation settings
epicsEnvSet( "XT_PORT",  "digi-cxi-31.pcdsn:2105" )
epicsEnvSet( "XT_MOTOR", "12" )
# Y translation settings
epicsEnvSet( "YT_PORT",  "digi-cxi-31.pcdsn:2106" )
epicsEnvSet( "YT_MOTOR", "13" )
# PV settings
epicsEnvSet( "LOC", "CXI" )
epicsEnvSet( "SYS", "DS1" )
epicsEnvSet( "MMS", "MMS" )
epicsEnvSet( "IOC",    "ioc-cxi-ds1-pulsepicker-ims" )
epicsEnvSet( "IOC_PV", "CXI:IOC:DS1:PP:IMS" )
...
dbLoadRecords("db/iocAdmin.db",         "IOC=CXI:IOC:DS1:PP:IMS")
