...
< envPaths
epicsEnvSet( "ENGINEER", "Nicholas Lentz (nlentz)" )
epicsEnvSet( "LOCATION", "MEC:HXM" )
# Local protocol for MEC specific
epicsEnvSet( "STREAM_PROTOCOL_PATH", "protocol" )
# Picker motor settings
epicsEnvSet( "PP_PORT",  "moxa-xrt-mec05.pcdsn:4003" )
epicsEnvSet( "PP_MOTOR", "18" )
# X translation settings
epicsEnvSet( "XT_PORT",  "moxa-xrt-mec05.pcdsn:4002" )
epicsEnvSet( "XT_MOTOR", "17" )
# Y translation settings
epicsEnvSet( "YT_PORT",  "moxa-xrt-mec05.pcdsn:4001" )
epicsEnvSet( "YT_MOTOR", "15" )
# PV settings
epicsEnvSet( "LOC", "MEC" )
epicsEnvSet( "SYS", "HXM" )
epicsEnvSet( "MMS", "MMS" )
epicsEnvSet( "IOC",    "ioc-mec-pulsepicker-ims" )
epicsEnvSet( "IOC_PV", "MEC:IOC:PULSEPICKER:IMS" )
...
dbLoadRecords("db/iocAdmin.db",         "IOC=MEC:IOC:PULSEPICKER:IMS")
