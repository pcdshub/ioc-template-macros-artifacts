...
< envPaths
epicsEnvSet( "ENGINEER", "Alex Donoghue (alexd)" )
...
epicsEnvSet( "PP_PORT",  "digi-xcs-12.pcdsn:2112" )
epicsEnvSet( "PP_MOTOR", "09" )
# X translation settings
epicsEnvSet( "XT_PORT",  "digi-xcs-12.pcdsn:2111" )
epicsEnvSet( "XT_MOTOR", "08" )
# Y translation settings
epicsEnvSet( "YT_PORT",  "digi-xcs-12.pcdsn:2113" )
epicsEnvSet( "YT_MOTOR", "21" )
# PV settings
epicsEnvSet( "LOC", "XCS" )
epicsEnvSet( "SYS", "SB2" )
epicsEnvSet( "MMS", "MMS" )
epicsEnvSet( "IOC",    "ioc-xcs-pulsepicker-ims" )
epicsEnvSet( "IOC_PV", "XCS:IOC:PULSEPICKER:IMS" )
...
dbLoadRecords("db/iocAdmin.db",         "IOC=XCS:IOC:PULSEPICKER:IMS")
