...
epicsEnvSet( "PP_PORT",  "digi-cxi-32.pcdsn:2116" )
epicsEnvSet( "PP_MOTOR", "16" )
# X translation settings
epicsEnvSet( "XT_PORT",  "digi-cxi-32.pcdsn:2115" )
epicsEnvSet( "XT_MOTOR", "15" )
# Y translation settings
epicsEnvSet( "YT_PORT",  "digi-cxi-32.pcdsn:2112" )
epicsEnvSet( "YT_MOTOR", "12" )
# PV settings
epicsEnvSet( "LOC", "CXI" )
epicsEnvSet( "SYS", "DIA" )
epicsEnvSet( "MMS", "MMS" )
epicsEnvSet( "IOC",    "ioc-cxi-pulsepicker-ims" )
epicsEnvSet( "IOC_PV", "CXI:IOC:PP:IMS" )
...
dbLoadRecords("db/iocAdmin.db",         "IOC=CXI:IOC:PP:IMS")
