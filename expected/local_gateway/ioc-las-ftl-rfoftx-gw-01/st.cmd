...
gwname=ioc-las-ftl-rfoftx-gw-01
gwprefix=NET:IOC:LAS:FTL:RFOFTX:GW:01
cagprogram="/cds/group/pcds/epics/extensions/gateway/R2.1.2.0-1.4.1/bin/$EPICS_HOST_ARCH/gateway"
cagvardir=/reg/d/iocData/ioc-las-ftl-rfoftx-gw-01/iocInfo
cagcfgdir=`pwd`
...
export EPICS_CAS_BEACON_ADDR_LIST=`echo 192.168.2.255 | awk '{for (i=1;i<=NF;i++) printf "%s:5065 ", $i;printf "\n";}' -`
export EPICS_CAS_INTF_ADDR_LIST=172.21.161.21
export EPICS_CAS_IGNORE_ADDR_LIST="$EPICS_CAS_IGNORE_ADDR_LIST 172.21.161.21:$EPICS_CA_SERVER_PORT"
cagflags=
