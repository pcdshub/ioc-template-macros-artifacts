...
gwname=ioc-las-ftl-pfts-gw-01
gwprefix=NET:IOC:LAS:FTL:PFTS:GW:01
cagprogram="/cds/group/pcds/epics/extensions/gateway/R2.1.2.0-1.4.1/bin/$EPICS_HOST_ARCH/gateway"
cagvardir=/reg/d/iocData/ioc-las-ftl-pfts-gw-01/iocInfo
cagcfgdir=`pwd`
...
export EPICS_CAS_BEACON_ADDR_LIST=`echo 192.168.0.255 | awk '{for (i=1;i<=NF;i++) printf "%s:5065 ", $i;printf "\n";}' -`
