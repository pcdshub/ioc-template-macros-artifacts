...
epicsEnvSet("IOCNAME",    "ioc-las-dso4000-02" )
epicsEnvSet("ENGINEER",   "tjohnson")
epicsEnvSet("LOCATION",   "Laser Hall R13")
...
#drvAsynIPPortConfigure("DSO","scope-las-dso4000-02:4000",0,0,0)
vxi11Configure("DSO","scope-las-dso4000-02",0,"0.0","inst0",0,0)
