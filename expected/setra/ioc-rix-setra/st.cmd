...
< envPaths
epicsEnvSet( "ENGINEER" , "Cynthia Melendrez (cymel123)" )
epicsEnvSet( "IOCSH_PS1", "ioc-rix-setra>" )
epicsEnvSet( "IOC_PV",    "RIX:IOC:SETRA:01"   )
...
drvAsynIPPortConfigure( "SETRA0", "cnt-rix-setra01:502 TCP", 0, 0, 1 )
...
dbLoadRecords( "db/setra.db",       "DEV=RIX:SETRA:01,N=0" )
