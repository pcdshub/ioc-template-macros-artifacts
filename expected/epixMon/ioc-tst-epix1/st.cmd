...
epicsEnvSet("IOCNAME", "ioc-tst-epix1" )
epicsEnvSet("ENGINEER", "Michael Browne (mcbrowne)" )
epicsEnvSet("LOCATION", "unknown" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:TST:EPIX:1")
...
dbLoadRecords("db/epixMon_trigger.db", "BASE=EPIX:MFX:1")

PgpRegister("PGP0", 0x20, 8, 0)

EpixMonRegister("EPIX:MFX:1", "PGP0", "EPIX:MFX:1:RUNNING")

# Load remaining record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV),P=$(IOC_PV):" )

dbLoadRecords("db/epixMon.db", "IOC=$(IOC_PV),BASE=EPIX:MFX:1,BOX=PGP0,MASK=32,SRPV3=0")
