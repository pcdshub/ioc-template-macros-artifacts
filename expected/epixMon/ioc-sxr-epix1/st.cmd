...
dbLoadRecords("db/epixMon_trigger.db", "BASE=SXR:EPIX:1")

PgpRegister("PGP0", 0x40, 8, 0)

EpixMonRegister("SXR:EPIX:1", "PGP0", "SXR:EPIX:1:RUNNING")

# Load remaining record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV),P=$(IOC_PV):" )

dbLoadRecords("db/epixMon.db", "IOC=$(IOC_PV),BASE=SXR:EPIX:1,BOX=PGP0,MASK=64,SRPV3=0")
