...
dbLoadRecords("db/epixMon_trigger.db", "BASE=DET:EPIXHR:01")

PgpRegister("PGP0", 0x10, 8, 0)

EpixMonRegister("DET:EPIXHR:01", "PGP0", "DET:EPIXHR:01:RUNNING")

# Load remaining record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV),P=$(IOC_PV):" )

dbLoadRecords("db/epixHrMon.db", "IOC=$(IOC_PV),BASE=DET:EPIXHR:01,BOX=PGP0,MASK=16,SRPV3=1")
