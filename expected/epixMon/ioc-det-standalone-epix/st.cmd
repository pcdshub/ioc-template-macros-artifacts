...
epicsEnvSet("IOCNAME", "ioc-det-standalone-epix" )
epicsEnvSet("ENGINEER", "Daniel Damiani (ddamiani)" )
epicsEnvSet("LOCATION", "DET:STD:EPIX" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:DET:STD:EPIX")
...
dbLoadRecords("db/epixMon_trigger.db", "BASE=DET:STD:EPIX:1")

PgpRegister("PGP0", 0x20, 8, 0)

EpixMonRegister("DET:STD:EPIX:1", "PGP0", "DET:STD:EPIX:1:RUNNING")

# Load remaining record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV),P=$(IOC_PV):" )

dbLoadRecords("db/epixMon.db", "IOC=$(IOC_PV),BASE=DET:STD:EPIX:1,BOX=PGP0,MASK=32,SRPV3=0")
