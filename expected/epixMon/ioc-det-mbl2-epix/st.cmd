...
epicsEnvSet("IOCNAME", "ioc-det-mbl2-epix" )
...
dbLoadRecords("db/epixMon_trigger.db", "BASE=DET:MBL2:EPIX:1")

PgpRegister("PGP0", 0x10, 8, 0)

EpixMonRegister("DET:MBL2:EPIX:1", "PGP0", "DET:MBL2:EPIX:1:RUNNING")

# Load remaining record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV),P=$(IOC_PV):" )

dbLoadRecords("db/epixMon.db", "IOC=$(IOC_PV),BASE=DET:MBL2:EPIX:1,BOX=PGP0,MASK=16,SRPV3=0")
