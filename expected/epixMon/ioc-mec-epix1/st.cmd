...
epicsEnvSet("IOCNAME", "ioc-mec-epix1" )
epicsEnvSet("ENGINEER", "Michael Browne (mcbrowne)" )
epicsEnvSet("LOCATION", "unknown" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:MEC:EPIX:1")
...
dbLoadRecords("db/epixMon_trigger.db", "BASE=MEC:EPIX:1")

PgpRegister("PGP0", 0x10, 8, 0)

EpixMonRegister("MEC:EPIX:1", "PGP0", "MEC:EPIX:1:RUNNING")

# Load remaining record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV),P=$(IOC_PV):" )

dbLoadRecords("db/epixMon.db", "IOC=$(IOC_PV),BASE=MEC:EPIX:1,BOX=PGP0,MASK=16,SRPV3=0")
