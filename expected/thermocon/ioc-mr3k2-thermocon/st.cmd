...
epicsEnvSet( "IOCSH_PS1", "ioc-mr3k2-thermocon>" )
epicsEnvSet( "IOC_PV",    "IOC:MR3K2:KBH:CHL"   )
...
drvAsynIPPortConfigure( "THERMOCON0", "ser-rix-01:4008 TCP", 0, 0, 0 )
...
dbLoadRecords( "db/thermocon.db",       "DEV=MR3K2:KBH:CHL,N=0" )
