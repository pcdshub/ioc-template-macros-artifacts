...
epicsEnvSet( "IOCSH_PS1", "ioc-mr2k2-thermocon>" )
epicsEnvSet( "IOC_PV",    "IOC:MR2K2:FLAT:CHL"   )
epicsEnvSet( "LOCATION",  "RIX R03")
epicsEnvSet( "IOCTOP",    "/reg/g/pcds/epics/ioc/common/thermocon/R2.0.0"   )
epicsEnvSet( "TOP",       "/reg/g/pcds/epics/ioc/rix/thermocon/R2.0.0/build"      )
...
drvAsynIPPortConfigure( "THERMOCON0", "ser-rix-01:4007 TCP", 0, 0, 0 )
...
dbLoadRecords( "db/thermocon.db",       "DEV=MR2K2:FLAT:CHL,N=0" )
