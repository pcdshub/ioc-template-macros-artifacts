...
dbLoadRecords("db/epixMon_trigger.db", "BASE=XPP:USR:EPIX:01")



PgpRegister("PGP0", 0x10, 0x8, 0)

EpixMonRegister("XPP:USR:EPIX:01", "PGP0", "XPP:USR:EPIX:01:RUNNING")
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=XPP:USR:EPIX:01,PREM=XPP:R39,DLVCHN=300,ALVCHN=301,PLVCHN=302,HVCHN=100,AMB_OMSL=supervisory,AMB_DOL=20")



dbLoadRecords("db/epixMon.db", "IOC=$(IOC_PV),BASE=XPP:USR:EPIX:01,BOX=PGP0,MASK=$(PGP0_MASK),SRPV3=0,FIRM=0")
