...
epicsEnvSet("IOCNAME", "ioc-xpp-detmbl-epix2" )
...
dbLoadRecords("db/detector-epix-peltier.db", "DET=XPP:USR:EPIX:02,PREM=DET:MBL,DLVCHN=103,ALVCHN=102,PLVCHN=105,HVCHN=205,AMB_OMSL=supervisory,AMB_DOL=20")
