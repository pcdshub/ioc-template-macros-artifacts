...
drvAsynIPPortConfigure("GT0","gentec-mec-las-meter1:10001",0,0,0)
...
dbLoadRecords("db/gentec.db", "BASE=MEC:LAS:GENTEC:01,PORT=GT0")
dbLoadRecords("db/asynRecord.db", "P=MEC:LAS:GENTEC:01,R=:ASYN,PORT=GT0,ADDR=0,OMAX=0,IMAX=0")
