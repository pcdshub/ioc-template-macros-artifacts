...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lps-02>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LPS:02" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LPS:IOC:02")
epicsEnvSet( "LOCATION",  "MEC:LPL:LPS:IOC:02")
epicsEnvSet( "IP",        "someServer"       )
epicsEnvSet( "IP_PORT",	  "1234"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LPS:02"     )
