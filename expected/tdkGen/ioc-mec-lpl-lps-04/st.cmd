...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lps-04>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LPS:04" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LPS:IOC:04")
epicsEnvSet( "LOCATION",  "MEC:LPL:LPS:IOC:04")
epicsEnvSet( "IP",        "someServer"       )
epicsEnvSet( "IP_PORT",	  "1234"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LPS:04"     )
