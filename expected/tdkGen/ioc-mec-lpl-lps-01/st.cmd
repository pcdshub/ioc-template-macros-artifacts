...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lps-01>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LPS:01" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LPS:IOC:01")
epicsEnvSet( "LOCATION",  "MEC:LPL:LPS:IOC:01")
epicsEnvSet( "IP",        "moxa-mec-02"       )
epicsEnvSet( "IP_PORT",	  "4005"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LPS:01"     )
