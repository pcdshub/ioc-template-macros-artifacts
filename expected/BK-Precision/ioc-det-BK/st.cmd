...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-det-BK")
epicsEnvSet("ENGINEER",  "Daniel Damiani (ddamiani)")
epicsEnvSet("LOCATION",  "IOC:DET:MBL:BK1")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:DET:MBL:BK1")
epicsEnvSet("IOCTOP",    "/reg/g/pcds/package/epics/3.14/ioc/common/BK-Precision/R1.1.0")
epicsEnvSet("TOP",       "/reg/g/pcds/package/epics/3.14/ioc/det/BK-Precision/R1.0.0/build")
...
drvAsynIPPortConfigure ("bus0","digi-det-portable1:2015",0,0,0)
#
...
dbLoadRecords("db/BK_Precision.db","cont=DET:MBL:BK1, bus=0")
