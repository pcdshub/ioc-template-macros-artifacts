...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-tmo-usr-BK-01")
epicsEnvSet("ENGINEER",  "baljamal")
epicsEnvSet("LOCATION",  "TMO:IP1:BKP:01")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:TMO:USR:BKP:01")
...
dbLoadRecords("db/BK_Precision.db","cont=TMO:USR:BK:01, bus=0")
