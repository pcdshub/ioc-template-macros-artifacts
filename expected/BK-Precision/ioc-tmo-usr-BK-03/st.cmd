...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-tmo-usr-BK-03")
epicsEnvSet("ENGINEER",  "baljamal")
epicsEnvSet("LOCATION",  "TMO:IP1:BKP:03")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:TMO:USR:BKP:03")
...
dbLoadRecords("db/BK_Precision.db","cont=TMO:USR:BK:03, bus=0")
