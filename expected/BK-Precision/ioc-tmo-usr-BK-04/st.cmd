...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-tmo-usr-BK-04")
epicsEnvSet("ENGINEER",  "baljamal")
epicsEnvSet("LOCATION",  "TMO:IP1:BKP:04")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:TMO:USR:BKP:04")
...
dbLoadRecords("db/BK_Precision.db","cont=TMO:USR:BK:04, bus=0")
