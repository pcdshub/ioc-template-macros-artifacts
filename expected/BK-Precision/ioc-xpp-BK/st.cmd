...
< envPaths
epicsEnvSet("IOCNAME",   "ioc-xpp-BK")
epicsEnvSet("ENGINEER",  "Daniel Damiani (ddamiani)")
epicsEnvSet("LOCATION",  "IOC:XPP:USR:BK1")
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> ")
epicsEnvSet("IOC_PV",    "IOC:XPP:USR:BK1")
epicsEnvSet("IOCTOP",    "/reg/g/pcds/package/epics/3.14/ioc/common/BK-Precision/R1.1.0")
epicsEnvSet("TOP",       "/reg/g/pcds/package/epics/3.14/ioc/xpp/BK-Precision/R1.0.0/build")
...
drvAsynIPPortConfigure ("bus0","digi-xpp-13:2003",0,0,0)
#
...
dbLoadRecords("db/BK_Precision.db","cont=XPP:USR:BK1, bus=0")
