...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mec-mpod" )
epicsEnvSet( "ENGINEER",     "gwbrown (Garth Brown)" )
epicsEnvSet( "LOCATION",     "MEC:R64B:VME:14" )
...
epicsEnvSet( "IOC_PV",       "IOC:MEC:MPOD" )
epicsEnvSet( "PRE",          "MEC:DET:MPD" )
epicsEnvSet( "CRATE",        "mpod-mec-01" )
...
# low voltage 8-channel module (+8)
...
dbLoadRecords("db/mpod_hvmodule_8channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=1,M2=10,MOD=10")
...
# See $(TOP)/MIB_NOTE.
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputStatus",              176, 1.0)
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputSupervisionBehavior", 160, 1.0)
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputCurrentRiseRate",     48,  1.0)
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputUserConfig",          48,  1.0)
