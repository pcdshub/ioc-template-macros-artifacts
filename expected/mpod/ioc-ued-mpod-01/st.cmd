...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-ued-mpod-01" )
epicsEnvSet( "ENGINEER",     "mcbrowne" )
...
epicsEnvSet( "IOC_PV",       "IOC:UED:MPOD:01" )
epicsEnvSet( "PRE",          "UED:01:MPD" )
epicsEnvSet( "CRATE",        "mpod-ued-01" )
...
dbLoadRecords("db/mpod_hvmodule_8channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=00")
dbLoadRecords("db/mpod_module_8channel_CgSv.db","HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=00")
