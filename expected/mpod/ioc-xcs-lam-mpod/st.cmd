...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-lam-mpod" )
epicsEnvSet( "ENGINEER",     "Silke Nelson (snelson)" )
epicsEnvSet( "LOCATION",     "XCS:LAM:IOC:MPOD" )
...
epicsEnvSet( "IOC_PV",       "XCS:IOC:LAM:MPOD" )
epicsEnvSet( "PRE",          "XCS:LAM:MPD" )
epicsEnvSet( "CRATE",        "mpod-xcs-lam1" )
...
# high voltage 8-channel module (pos->+500V)
