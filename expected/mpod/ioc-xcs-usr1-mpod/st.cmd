...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-usr1-mpod" )
epicsEnvSet( "ENGINEER",     "Silke Nelson (snelson)" )
epicsEnvSet( "LOCATION",     "XCS:R42:IOC:01:MPOD" )
...
epicsEnvSet( "IOC_PV",       "XCS:IOC:DET:MPD" )
epicsEnvSet( "PRE",          "XCS:DET:MPD" )
epicsEnvSet( "CRATE",        "mpod-xcs-usr1" )
...
# high voltage 8-channel module (pos->+6000V)
dbLoadRecords("db/mpod_hvmodule_8channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=")
dbLoadRecords("db/mpod_module_8channel_CgSv.db","HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=")
# low voltage 8-channel module (pos->8V)
