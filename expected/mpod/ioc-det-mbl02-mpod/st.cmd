...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-det-mbl02-mpod" )
...
epicsEnvSet( "IOC_PV",       "DET:IOC:DET:MPOD:2" )
epicsEnvSet( "PRE",          "DET:MBL2:MPD" )
epicsEnvSet( "CRATE",        "mpod-det-portable2" )
...
dbLoadRecords("db/mpod_hvmodule_16channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=")
dbLoadRecords("db/mpod_module_16channel_CgSv.db","HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=")
...
# low voltage 8-channel module (+30V)
