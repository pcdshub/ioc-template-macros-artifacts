...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-mpod-d51" )
epicsEnvSet( "ENGINEER",     "snelson (Silke Nelson)" )
epicsEnvSet( "LOCATION",     "CXI:R58:IOC:01:MPOD" )
...
epicsEnvSet( "IOC_PV",       "CXI:IOC:MPOD:D51" )
epicsEnvSet( "PRE",          "CXI:D51:MPD" )
epicsEnvSet( "CRATE",        "mpod-cxi-d51" )
...
dbLoadRecords("db/mpod_hvmodule_16channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=0")
dbLoadRecords("db/mpod_module_16channel_CgSv.db","HOST=$(CRATE),PRE=$(PRE),M1=,M2=,MOD=0")
...
# low voltage 8-channel module (+8V)
dbLoadRecords("db/mpod_lvmodule_8channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=2,M2=20,MOD=20")
dbLoadRecords("db/mpod_module_8channel_CgSv.db","HOST=$(CRATE),PRE=$(PRE),M1=2,M2=20,MOD=20")
# low voltage 8-channel module (+8V)
dbLoadRecords("db/mpod_lvmodule_8channel.db", "HOST=$(CRATE),PRE=$(PRE),M1=3,M2=30,MOD=30")
dbLoadRecords("db/mpod_module_8channel_CgSv.db","HOST=$(CRATE),PRE=$(PRE),M1=3,M2=30,MOD=30")
...
# See $(TOP)/MIB_NOTE.
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputStatus",              440, 1.0)
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputSupervisionBehavior", 400, 1.0)
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputCurrentRiseRate",     120,  1.0)
Snmp2cWalk("$(CRATE)", "guru", "WIENER-CRATE-MIB::outputUserConfig",          120,  1.0)
