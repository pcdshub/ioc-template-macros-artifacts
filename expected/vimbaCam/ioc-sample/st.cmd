...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-sample" )
epicsEnvSet( "ENGINEER",     "Your Name (yourusername)" )
epicsEnvSet( "LOCATION",     "Bldg XXX, HUTCH XXX, ?" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "XXX:IOC:GIGE:2" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "XXX:CAM:GIGE:2:NoEvr" )
...
epicsEnvSet( "CAM_ID",       "" )
epicsEnvSet( "CAM_PV",       "XXX:CAM:GIGE:2" )
