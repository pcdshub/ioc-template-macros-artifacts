...
export EVR_PV=MFX:GDE:01:NoEvr
export TRIG_CH=0

export IOC_PV=MFX:IOC:GDE:01
export CAM=MFX:GDE:01
export HUTCH=mfx

export IF=ETH0

export SYNCTS="/reg/g/pcds/epics/ioc/common/vimbaCam/R1.1.0/children/build/iocBoot/ioc-mfx-goldeye1/syncts-ioc-mfx-goldeye1.cmd"
