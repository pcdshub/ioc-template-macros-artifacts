...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-goldeye1" )
epicsEnvSet( "ENGINEER",     "Michael Browne (mcbrowne)" )
epicsEnvSet( "LOCATION",     "Somewhere in TMO" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MFX:IOC:GDE:01" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "MFX:GDE:01:NoEvr" )
...
epicsEnvSet( "CAM_ID",       "DEV_000F31F42E1B" )
epicsEnvSet( "CAM_PV",       "MFX:GDE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Goldeye_G-130" )
