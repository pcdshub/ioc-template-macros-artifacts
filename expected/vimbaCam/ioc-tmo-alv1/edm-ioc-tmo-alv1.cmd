...
export EVR_PV=TMO:EVR:ALV:1
export TRIG_CH=4

export IOC_PV=TMO:IOC:ALV:01
export CAM=TMO:ALV:01
export HUTCH=tmo

export IF=ETH0

export SYNCTS="/reg/g/pcds/epics/ioc/common/vimbaCam/R1.1.0/children/build/iocBoot/ioc-tmo-alv1/syncts-ioc-tmo-alv1.cmd"
