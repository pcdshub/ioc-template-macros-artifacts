...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-chl-04>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:CHL:04" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:CHL:IOC:04")
epicsEnvSet( "LOCATION",  "MEC:LPL:CHL:IOC:04")
epicsEnvSet( "IP",        "moxa-mec-02"       )
epicsEnvSet( "IP_PORT",	  "4004"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:CHL:04"     )
