...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-chl-03>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:CHL:03" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:CHL:IOC:03")
epicsEnvSet( "LOCATION",  "MEC:LPL:CHL:IOC:03")
epicsEnvSet( "IP",        "moxa-mec-02"       )
epicsEnvSet( "IP_PORT",	  "4003"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:CHL:03"     )
