...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-chl-02>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:CHL:02" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:CHL:IOC:02")
epicsEnvSet( "LOCATION",  "MEC:LPL:CHL:IOC:02")
epicsEnvSet( "IP",        "moxa-mec-02"       )
epicsEnvSet( "IP_PORT",	  "4002"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:CHL:02"     )
