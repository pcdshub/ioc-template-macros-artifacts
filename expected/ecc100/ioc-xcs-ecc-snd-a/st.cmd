...
epicsEnvSet("IOCNAME", "ioc-xcs-ecc-snd-a" )
epicsEnvSet("ENGINEER", "Michael Browne (mcbrowne)" )
epicsEnvSet("LOCATION", "unknown" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:XCS:SND:ECC:A")
< envPaths
...
drvAsynIPPortConfigure("IP0","ecc-xcs-snd-a:2101",0,0,0)
...
dbLoadRecords "db/eccTest.db", "P=XCS:SND:ECC:A,PORT=IP0,DEV=ECC0"

dbLoadRecords( "db/iocSoft.db",            "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV)" )

dbLoadRecords("db/ecc_alias.db", "OLD=XCS:SND:ECC:A,NEW=XCS:SND:T1:Y1,M=0")
dbLoadRecords("db/ecc_alias.db", "OLD=XCS:SND:ECC:A,NEW=XCS:SND:T1:Y2,M=1")
dbLoadRecords("db/ecc_alias.db", "OLD=XCS:SND:ECC:A,NEW=XCS:SND:T1:CHI1,M=2")
