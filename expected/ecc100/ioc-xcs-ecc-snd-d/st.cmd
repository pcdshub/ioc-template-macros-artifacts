...
epicsEnvSet("IOCNAME", "ioc-xcs-ecc-snd-d" )
epicsEnvSet("ENGINEER", "Michael Browne (mcbrowne)" )
epicsEnvSet("LOCATION", "unknown" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:XCS:SND:ECC:D")
< envPaths
...
drvAsynIPPortConfigure("IP0","ecc-xcs-snd-d:2101",0,0,0)
...
dbLoadRecords "db/eccTest.db", "P=XCS:SND:ECC:D,PORT=IP0,DEV=ECC0"

dbLoadRecords( "db/iocSoft.db",            "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "IOC=$(IOC_PV)" )

dbLoadRecords("db/ecc_alias.db", "OLD=XCS:SND:ECC:D,NEW=XCS:SND:T4:CHI2,M=0")
dbLoadRecords("db/ecc_alias.db", "OLD=XCS:SND:ECC:D,NEW=XCS:SND:T4:DH,M=1")
