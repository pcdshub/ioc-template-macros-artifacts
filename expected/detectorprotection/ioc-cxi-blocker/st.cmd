...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-blocker" )
epicsEnvSet( "ENGINEER",     "Kaushik Malapati (kaushikm)" )
epicsEnvSet( "LOCATION",     "CXI:CSPAD:BLOCKER" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	     "IOC:CXI:CSPAD:BLOCKER" )
...
dbLoadRecords( "db/iocSoft.db",             "IOC=IOC:CXI:CSPAD:BLOCKER" )
dbLoadRecords( "db/save_restoreStatus.db",  "P=IOC:CXI:CSPAD:BLOCKER:" )

# Load detprot records
dbLoadRecords("db/detprot.db", "NAME=CXI:CSPAD:BLOCKER,PICKER=XRT:DIA:MMS:16, OPTLINK1=, OPTVAL1=, OPTLINK2=, OPTVAL2=, OPTLINK3=, OPTVAL3=")
