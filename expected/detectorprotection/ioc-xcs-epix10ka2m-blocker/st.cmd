...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-epix10ka2m-blocker" )
epicsEnvSet( "ENGINEER",     "Kaushik Malapati (kaushikm)" )
epicsEnvSet( "LOCATION",     "XCS SB2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	     "IOC:XCS:EPIX:BLOCKER" )
epicsEnvSet( "IOCTOP",	     "/reg/g/pcds/epics/ioc/common/detectorprotection/R3.0.0" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/xcs/detectorprotection/R3.0.0/build" )
cd( "$(IOCTOP)" )
...
dbLoadRecords( "db/iocSoft.db",             "IOC=IOC:XCS:EPIX:BLOCKER" )
dbLoadRecords( "db/save_restoreStatus.db",  "P=IOC:XCS:EPIX:BLOCKER:" )

# Load detprot records
dbLoadRecords("db/detprot.db", "NAME=XCS:EPIX:BLOCKER,PICKER=XCS:SB2:MMS:09, OPTLINK1=, OPTVAL1=, OPTLINK2=, OPTVAL2=, OPTLINK3=, OPTVAL3=")
