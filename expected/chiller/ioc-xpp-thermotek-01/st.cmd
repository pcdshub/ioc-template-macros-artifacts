...
epicsEnvSet( "IOCNAME",	  "ioc-xpp-thermotek-01" )
epicsEnvSet( "ENGINEER",  "Maarten Thomas-Bosum (bosum123)" )
epicsEnvSet( "LOCATION",  "XPP:R33:E1" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:XPP:TTK:01" )
...
##############################################################
drvAsynIPPortConfigure( "bus0", "moxa-xpp-06:4007", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/thermotek.db", "P=XPP:ROB:TTK:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-xpp-thermotek-01.sav" )
set_pass1_restoreFile( "ioc-xpp-thermotek-01.sav" )

# Initialize the IOC and start processing records
iocInit()

# Start autosave backups
create_monitor_set( "ioc-xpp-thermotek-01.req", 5, "" )
