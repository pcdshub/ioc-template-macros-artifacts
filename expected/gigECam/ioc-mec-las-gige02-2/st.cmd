...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-las-gige02-2")
...
epicsEnvSet("IOC_PV", "MEC:LAS:GIGE:IOC2")
...
epicsEnvSet( "CAM_IP",		"192.168.2.10" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:LAS:GIGE:CAM2" )
