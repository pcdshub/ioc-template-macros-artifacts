...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-03" )
epicsEnvSet( "ENGINEER",     "Rehan Nazir (rnazir)" )
epicsEnvSet( "LOCATION",     "XCS GigE 3" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:03" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:03:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-03" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:03" )
