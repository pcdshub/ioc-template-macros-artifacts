...
epicsEnvSet( "TPR_PV",       "TMO:CAM:14:NoTpr" )
epicsEnvSet( "EVR_PV",       "TMO:CAM:14:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-tmo-14" )
epicsEnvSet( "CAM_PV",       "TMO:CAM:14" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "8020" )
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ETH,IF_NUM=0" )
