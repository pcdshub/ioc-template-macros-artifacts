...
export EVR_PV=TMO:CAM:14:NoEvr
export TRIG_CH=0
export IOC_PV=TMO:CAM:14:IOC
export CAM=TMO:CAM:14
export HUTCH=TMO

export IF=ETH

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-tmo-14/syncts-ioc-cam-tmo-14.cmd"
