#!/reg/g/pcds/epics/ioc/common/gigECam/R5.0.0/bin/rhel7-x86_64/gigeTpr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/txi/gigECam/R1.0.0/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im2l1-gige" )
epicsEnvSet( "ENGINEER",     "Josue Zamudio (jozamudi)" )
epicsEnvSet( "LOCATION",     "L1S01-IM2L1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM2L1:PPM:CAM:IOC" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/gigECam/R5.0.0" )
...
epicsEnvSet( "EVR_PV",       "IM2L1:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM2L1:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_PV",       "IM2L1:PPM:CAM" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM2L1:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=enp67s0f0,IF_NUM=5" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/txi/gigECam/R1.0.0/build/iocBoot/$(IOCNAME)/edm-$(IOCNAME).cmd"
