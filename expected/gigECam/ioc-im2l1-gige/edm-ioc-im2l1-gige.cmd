...
export TPR_PV=TXI:CAM:TPR:01
export TPE_PV=IM2L1:PPM:CAM:TPE
export TPR_TR=00
export TPR_CH=${TPR_TR}
export TPR_SE=${TPR_CH}
export IOC_PV=IM2L1:PPM:CAM:IOC
export CAM=IM2L1:PPM:CAM
export HUTCH=TXI
...
pushd /reg/g/pcds/epics/ioc/common/gigECam/R5.0.0/screenLinks
edm -x -eolc	\
	-m "IOC=${IOC_PV}"		\
	-m "TPR=${TPR_PV}"		\
	-m "TPR_PV=${TPR_PV}"	\
