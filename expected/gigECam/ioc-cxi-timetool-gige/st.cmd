...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-timetool-gige" )
epicsEnvSet( "ENGINEER",     "Divya Thanasekaran (divya)" )
epicsEnvSet( "LOCATION",     "CXI Timetool viewing camera on DSB" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:TIMETOOL:GIGE" )
...
epicsEnvSet( "TPR_PV",       "CXI:TIMETOOL:GIGE:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:TIMETOOL:GIGE:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-timetool" )
epicsEnvSet( "CAM_PV",       "CXI:TIMETOOL:GIGE" )
