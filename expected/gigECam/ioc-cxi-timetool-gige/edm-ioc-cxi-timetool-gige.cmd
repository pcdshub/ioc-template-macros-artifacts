...
export EVR_PV=CXI:TIMETOOL:GIGE:NoEvr
export TRIG_CH=0
export IOC_PV=IOC:CXI:TIMETOOL:GIGE
export CAM=CXI:TIMETOOL:GIGE
export HUTCH=cxi
...
pushd /reg/g/pcds/package/epics/3.14/ioc/common/gigECam/R5.0.1/screenLinks
edm -x -eolc	\
	-m "IOC=${IOC_PV}"		\
	-m "EVR=${EVR_PV}"		\
	-m "CH=${TRIG_CH}"		\
