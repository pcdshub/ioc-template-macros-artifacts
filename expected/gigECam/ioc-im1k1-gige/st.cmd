...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im1k1-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-K1S10-IM1K1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM1K1:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM1K1:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM1K1:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_PV",       "IM1K1:PPM:CAM" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM1K1:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=enp69s0f0,IF_NUM=5" )
