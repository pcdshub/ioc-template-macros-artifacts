...
epicsEnvSet( "TPR_PV",       "CXI:DG2:GIGE:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:EVR:DG2:GIGE" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-dg2" )
epicsEnvSet( "CAM_PV",       "CXI:DG2:GIGE" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "7771" )
...
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),EVR=$(EVR_PV),TRIG_CH=2,EVR_USED=1" )
