...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-04" )
epicsEnvSet( "ENGINEER",     "Ernesto Paiser (paiser)" )
epicsEnvSet( "LOCATION",     "XCS GigE 4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:04" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:4" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-04" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG046B" )
epicsEnvSet( "HTTP_PORT",    "7804" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD),IP3E=Enabled" )

# Load both devEvrInfo.db and devTprInfo.db so python programs can test for both sets of PVs
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),EVR=$(EVR_PV),TRIG_CH=3,EVR_USED=1" )
