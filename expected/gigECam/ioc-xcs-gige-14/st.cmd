...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-14" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "XCS Split and Delay DO" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:14" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:14:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:14:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-14" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:14" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG192B" )
epicsEnvSet( "HTTP_PORT",    "7814" )
