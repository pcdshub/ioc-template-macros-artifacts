...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-las-gige03-6")
...
epicsEnvSet("IOC_PV", "MEC:LAS:GIGE:IOC6")
...
epicsEnvSet( "CAM_IP",		"192.168.6.10" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:LAS:GIGE:CAM6" )
