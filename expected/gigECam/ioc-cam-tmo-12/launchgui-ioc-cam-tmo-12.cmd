...
export EVR_PV=TMO:CAM:12:NoEvr
export TRIG_CH=0
export IOC_PV=TMO:CAM:12:IOC
export CAM=TMO:CAM:12
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-tmo-12/syncts-ioc-cam-tmo-12.cmd"
