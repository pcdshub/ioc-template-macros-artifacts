...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cam-tmo-12" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "B950-TMO" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TMO:CAM:12:IOC" )
...
epicsEnvSet( "TPR_PV",       "TMO:CAM:12:NoTpr" )
epicsEnvSet( "EVR_PV",       "TMO:CAM:12:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-tmo-12" )
epicsEnvSet( "CAM_PV",       "TMO:CAM:12" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG282B" )
epicsEnvSet( "HTTP_PORT",    "8018" )
