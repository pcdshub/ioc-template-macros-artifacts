...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-02" )
epicsEnvSet( "ENGINEER",     "Alex Batyuk (batyuk)" )
epicsEnvSet( "LOCATION",     "MFX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:02" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:EVR:01" )
...
epicsEnvSet( "CAM_IP",       "gige-mfx-02" )
epicsEnvSet( "CAM_PV",       "MFX:GIGE:02" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "35202" )
