#!/reg/g/pcds/epics/ioc/common/gigECam/R5.0.5/bin/rhel7-x86_64/gige
...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-mono-gige04" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-K1S11" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MR2K1:MONO:CAM:04:IOC" )
...
epicsEnvSet( "TPR_PV",       "MR2K1:MONO:CAM:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "MR2K1:MONO:CAM:04:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-kfe-mono-04" )
epicsEnvSet( "CAM_PV",       "MR2K1:MONO:CAM:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG917C" )
epicsEnvSet( "HTTP_PORT",    "8004" )
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ETH0,IF_NUM=0" )
