...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-gige-06" )
epicsEnvSet( "ENGINEER",     "Kaushik Malapati (kaushikm)" )
epicsEnvSet( "LOCATION",     "qRIXS GIGE 06" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:GIGE:06" )
...
epicsEnvSet( "TPR_PV",       "QRIX:GIGE:06:NoTpr" )
epicsEnvSet( "EVR_PV",       "QRIX:GIGE:06:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "QRIX:GIGE:06:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-qrix-gige-06" )
epicsEnvSet( "CAM_PV",       "QRIX:GIGE:06" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:GIGE:06:TPE,PORT=$(TPR_PORT)")
