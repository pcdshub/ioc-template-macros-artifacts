...
export EVR_PV=LAMP:CAM:01:NoEvr
export TRIG_CH=0
export IOC_PV=LAMP:CAM:01:IOC
export CAM=LAMP:CAM:01
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-tmo-lamp-01/syncts-ioc-cam-tmo-lamp-01.cmd"
