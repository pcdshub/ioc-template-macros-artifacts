...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-lbl-02" )
epicsEnvSet( "ENGINEER",     "Jackson Sheppard (sheppard)" )
epicsEnvSet( "LOCATION",     "XPP" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:LBL:02" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:LBL:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:LBL:02:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-lbl-02" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:LBL:02" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG145B" )
epicsEnvSet( "HTTP_PORT",    "7826" )
