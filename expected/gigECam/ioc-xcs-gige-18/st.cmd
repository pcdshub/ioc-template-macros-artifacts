...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-18" )
epicsEnvSet( "ENGINEER",     "Silke Nelson (snelson)" )
epicsEnvSet( "LOCATION",     "XCS GigE 18" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:18" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:18:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:18:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-ljc-side" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:18" )
