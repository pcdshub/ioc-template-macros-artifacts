...
epicsEnvSet( "EVR_PV",       "CRIX:GIGE:06:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "CRIX:GIGE:06:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-crix-gige-06" )
epicsEnvSet( "CAM_PV",       "CRIX:GIGE:06" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8806" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=CRIX:GIGE:06:TPE,PORT=$(TPR_PORT)")
