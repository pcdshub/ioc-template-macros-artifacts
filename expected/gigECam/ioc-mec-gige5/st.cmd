#!/reg/g/pcds/package/epics/3.14/ioc/common/gigECam/R1.11.1/bin/linux-x86_64/gige

# Run common startup commands for linux soft IOC's
< /reg/d/iocCommon/All/pre_linux.cmd

< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-gige5")
epicsEnvSet("ENGINEER", "Zhou Xing (zxing)" )
epicsEnvSet("LOCATION", "MEC Time Tool" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("EPICS_CA_MAX_ARRAY_BYTES", "8000000" )
epicsEnvSet("IOC_PV", "MEC:IOC:GIGE:05")
epicsEnvSet("IOCTOP", "/reg/g/pcds/package/epics/3.14/ioc/common/gigECam/R1.11.1")
epicsEnvSet("TOP", "/reg/g/pcds/package/epics/3.14/ioc/mec/gigECam/R1.14.3/build")

# Network name or IP addr for gigE camera
epicsEnvSet( "CAM_IP",		"gige-mec-cam05" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:GIGE:05" )
