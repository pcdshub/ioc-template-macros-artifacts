#!/reg/g/pcds/epics/ioc/common/gigECam/R3.3.0/bin/linux-x86_64/gige

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-01" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "XPP SB1 YAG" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/gigECam/R3.3.0" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/xpp/gigECam/R2.0.7/build" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "XPP:GIGE:EVR:01" )
epicsEnvSet( "TRIG_PV",      "$(EVR_PV):TRIG2" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-01" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG030B" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD),IP2E=Enabled" )
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),IOC=$(IOC_PV),EVR=$(EVR_PV),TRIG_CH=2,EVR_USED=1" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/xpp/gigECam/R2.0.7/build/iocBoot/$(IOCNAME)/edm-$(IOCNAME).cmd"
