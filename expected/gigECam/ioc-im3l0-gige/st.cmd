...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im3l0-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-L0S16-IM3L0" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM3L0:PPM:CAM:IOC" )
...
# Setup EVR env vars
epicsEnvSet( "EVR_PV",       "IM3L0:PPM:CAM:EVR" )
...
epicsEnvSet( "CAM_IP",       "192.168.30.10" )
epicsEnvSet( "CAM_PV",       "IM3L0:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8030" )
...
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),IOC=$(IOC_PV),EVR=$(EVR_PV),TRIG_CH=0,EVR_USED=1" )

# Load netstat records
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=enp70s0f2,IF_NUM=7" )
