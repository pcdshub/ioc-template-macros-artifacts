...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-05" )
epicsEnvSet( "ENGINEER",     "Ernesto Paiser (paiser)" )
epicsEnvSet( "LOCATION",     "XCS GigE 5" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:05" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:05:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-05" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:05" )
