...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LJV:OFFAXIS:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:EVR:GIGE:LJV:OFFAXIS" )
...
epicsEnvSet( "CAM_IP",       "gige-ljv-offaxis" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LJV:OFFAXIS" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG125C" )
epicsEnvSet( "HTTP_PORT",    "7818" )
