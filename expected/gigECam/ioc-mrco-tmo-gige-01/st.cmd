...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mrco-tmo-gige-01" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "TMO MRCO 01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MRCO:CAM:01:IOC" )
...
epicsEnvSet( "TPR_PV",       "MRCO:CAM:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "MRCO:CAM:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mrco-tmo-01" )
epicsEnvSet( "CAM_PV",       "MRCO:CAM:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG201B" )
epicsEnvSet( "HTTP_PORT",    "8070" )
