...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-03" )
epicsEnvSet( "ENGINEER",     "Jackson Sheppard (sheppard)" )
epicsEnvSet( "LOCATION",     "XPP GigE 3 LIB" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:03" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:03:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-03" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:03" )
