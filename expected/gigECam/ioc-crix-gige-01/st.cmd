...
epicsEnvSet( "EVR_PV",       "CRIX:GIGE:01:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "CRIX:GIGE:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-crix-gige-01" )
epicsEnvSet( "CAM_PV",       "CRIX:GIGE:01" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=CRIX:GIGE:01:TPE,PORT=$(TPR_PORT)")
