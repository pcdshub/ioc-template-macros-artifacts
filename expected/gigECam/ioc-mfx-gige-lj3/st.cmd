...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-lj3" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "MFX GigE LJ3" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:LJ3" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:LJ3:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:LJ3:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mfx-lj3" )
epicsEnvSet( "CAM_PV",       "MFX:GIGE:LJ3" )
