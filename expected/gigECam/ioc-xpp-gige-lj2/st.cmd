...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-lj2" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE LJ2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:LJ2" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:LJ2:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:LJ2:NoEvr" )
...
epicsEnvSet( "CAM_PV",       "XPP:GIGE:LJ2" )
