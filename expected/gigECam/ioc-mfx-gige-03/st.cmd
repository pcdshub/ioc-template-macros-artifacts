#!/reg/g/pcds/epics/ioc/common/gigECam/R5.0.1/bin/linux-x86_64/gige
...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-03" )
epicsEnvSet( "ENGINEER",     "Alex Batyuk (batyuk)" )
epicsEnvSet( "LOCATION",     "MFX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:03" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/gigECam/R5.0.1" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:EVR:02" )
...
epicsEnvSet( "CAM_IP",       "gige-mfx-03" )
epicsEnvSet( "CAM_PV",       "MFX:GIGE:03" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "35209" )
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ETH0,IF_NUM=2" )
