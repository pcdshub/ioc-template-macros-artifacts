...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-rtdsk0-gige" )
epicsEnvSet( "ENGINEER",     "Mike Estrada (mkestra)" )
epicsEnvSet( "LOCATION",     "B930-RTDSK0" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RTDSK0:GIGE:01" )
...
epicsEnvSet( "TPR_PV",       "RTDSK0:GIGE:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "RTDSK0:GIGE:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-kfe-rtdsk0-01" )
epicsEnvSet( "CAM_PV",       "RTDSK0:GIGE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG158B" )
epicsEnvSet( "HTTP_PORT",    "8114" )
