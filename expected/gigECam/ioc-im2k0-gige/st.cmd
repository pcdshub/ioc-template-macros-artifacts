...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im2k0-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-K0S4-IM2K0" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM2K0:XTES:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM2K0:XTES:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM2K0:XTES:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.20.10" )
epicsEnvSet( "CAM_PV",       "IM2K0:XTES:CAM" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM2K0:XTES:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=enp69s0f2,IF_NUM=7" )
