...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cam-kfe-zos-01" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-ZOS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "ST1K1:ZOS:CAM:01:IOC" )
...
epicsEnvSet( "TPR_PV",       "ST1K1:ZOS:CAM:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "ST1K1:ZOS:CAM:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-kfe-zos-01" )
epicsEnvSet( "CAM_PV",       "ST1K1:ZOS:CAM:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "FLIR_A65" )
