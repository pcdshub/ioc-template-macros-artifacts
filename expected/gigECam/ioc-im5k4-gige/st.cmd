...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im5k4-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "TMO-GS2-IM5K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM5K4:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM5K4:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM5K4:PPM:CAM:TPE" )
epicsEnvSet( "TPR_TR",       "02" )
epicsEnvSet( "TPR_CH",       "02" )
epicsEnvSet( "TPR_SE",       "02" )
epicsEnvSet( "TPR_PORT",     "trig0" )

cd( "$(IOCTOP)" )
# Specify camera env variables
epicsEnvSet( "CAM_IP",       "192.168.54.10" )
epicsEnvSet( "CAM_PV",       "IM5K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8054" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM5K4:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENP69S0F1,IF_NUM=3" )
