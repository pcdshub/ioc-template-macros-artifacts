...
export TPE_PV=IM5K4:PPM:CAM:TPE
export TPR_TR=02
export TPR_CH=${TPR_TR}
export TPR_SE=${TPR_CH}
export IOC_PV=IM5K4:PPM:CAM:IOC
export CAM=IM5K4:PPM:CAM
export HUTCH=TMO

export IF=ENP69S0F1

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-im5k4-gige/syncts-ioc-im5k4-gige.cmd"
