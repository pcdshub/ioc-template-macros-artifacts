...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-gige6")
epicsEnvSet("ENGINEER", "Zhou Xing (zxing)" )
epicsEnvSet("LOCATION", "MEC GIGE 6" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("EPICS_CA_MAX_ARRAY_BYTES", "8000000" )
epicsEnvSet("IOC_PV", "MEC:IOC:GIGE:06")
...
epicsEnvSet( "CAM_IP",		"gige-mec-cam06" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:GIGE:06" )
