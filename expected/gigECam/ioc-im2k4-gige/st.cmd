...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im2k4-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-K4S33-IM2K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM2K4:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM2K4:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM2K4:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.24.10" )
epicsEnvSet( "CAM_PV",       "IM2K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8024" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM2K4:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=enp69s0f3,IF_NUM=3" )
