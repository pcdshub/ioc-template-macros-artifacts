...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-las-gige02-3")
...
epicsEnvSet("IOC_PV", "MEC:LAS:GIGE:IOC3")
...
epicsEnvSet( "CAM_IP",		"192.168.3.10" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:LAS:GIGE:CAM3" )
