...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-lj1" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "XCS GigE LJ1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:LJ1" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LJ1:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:LJ1" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-lj1" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LJ1" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG145B" )
epicsEnvSet( "HTTP_PORT",    "7820" )
