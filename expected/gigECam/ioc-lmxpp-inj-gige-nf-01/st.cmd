...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lmxpp-inj-gige-nf-01" )
epicsEnvSet( "ENGINEER",     "Tyler Johnson (tjohnson)" )
epicsEnvSet( "LOCATION",     "XPP Injection TILE" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LMXPP:INJ_DP1_TF1_NF1" )
...
epicsEnvSet( "TPR_PV",       "LMXPP:INJ_DP1_TF1_NF1:NoTpr" )
epicsEnvSet( "EVR_PV",       "LMXPP:INJ_DP1_TF1_NF1:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.84.210" )
epicsEnvSet( "CAM_PV",       "LMXPP:INJ_DP1_TF1_NF1" )
