...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-04" )
epicsEnvSet( "ENGINEER",     "Jackson Sheppard (sheppard)" )
epicsEnvSet( "LOCATION",     "XPP GigE 04 LIB" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:04" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:04:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-04" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:04" )
