...
export EVR_PV=LAMP:CAM:02:NoEvr
export TRIG_CH=0
export IOC_PV=LAMP:CAM:02:IOC
export CAM=LAMP:CAM:02
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-tmo-lamp-02/syncts-ioc-cam-tmo-lamp-02.cmd"
