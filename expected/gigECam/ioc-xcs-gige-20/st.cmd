...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-20" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "XCS GigE 20" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:20" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:20:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:20:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-20" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:20" )
