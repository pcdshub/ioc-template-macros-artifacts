...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-19" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "XPP GigE 19" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:19" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:19:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:19:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-19" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:19" )
