...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-19" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "XCS GigE 19" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:19" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:19:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:19" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-19" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:19" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG319B" )
epicsEnvSet( "HTTP_PORT",    "7819" )
