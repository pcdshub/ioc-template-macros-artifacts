...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-lj3" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE LJ3" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:LJ3" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:LJ3:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:LJ3:NoEvr" )
...
epicsEnvSet( "CAM_PV",       "XPP:GIGE:LJ3" )
