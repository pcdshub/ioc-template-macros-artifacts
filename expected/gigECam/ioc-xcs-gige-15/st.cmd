...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-15" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "XCS Split and Delay T4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:15" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:15:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:15:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-15" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:15" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG192B" )
epicsEnvSet( "HTTP_PORT",    "7815" )
