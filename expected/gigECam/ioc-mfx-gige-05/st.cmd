...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-05" )
epicsEnvSet( "ENGINEER",     "Alex Batyuk (batyuk)" )
epicsEnvSet( "LOCATION",     "MFX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:05" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:05:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mfx-05" )
epicsEnvSet( "CAM_PV",       "MFX:GIGE:05" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "30090" )
