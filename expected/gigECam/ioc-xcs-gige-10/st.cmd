...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-10" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "XCS Periscope Line" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:10" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:10:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:10:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-10" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:10" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG917C" )
