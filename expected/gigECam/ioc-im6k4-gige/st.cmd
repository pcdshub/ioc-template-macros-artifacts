#!/reg/g/pcds/epics/ioc/common/gigECam/R5.1.0/bin/rhel7-x86_64/gigeTpr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im6k4-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "TMO-GS3-IM6K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM6K4:PPM:CAM:IOC" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/gigECam/R5.1.0" )
...
epicsEnvSet( "EVR_PV",       "IM6K4:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM6K4:PPM:CAM:TPE" )
epicsEnvSet( "TPR_TR",       "03" )
epicsEnvSet( "TPR_CH",       "03" )
epicsEnvSet( "TPR_SE",       "03" )
epicsEnvSet( "TPR_PORT",     "trig0" )

cd( "$(IOCTOP)" )
# Specify camera env variables
epicsEnvSet( "CAM_IP",       "192.168.64.10" )
epicsEnvSet( "CAM_PV",       "IM6K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG2460B" )
epicsEnvSet( "HTTP_PORT",    "8064" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM6K4:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENP69S0F0,IF_NUM=6" )
...
dbpf $(CAM_PV):LAUNCH_GUI "/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/$(IOCNAME)/launchgui-$(IOCNAME).cmd"

# Final delay before auto-start image acquisition
epicsThreadSleep 3
dbpf $(CAM_PV):Acquire 1
epicsThreadSleep 3
system( "/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/$(IOCNAME)/syncts-$(IOCNAME).cmd" )
var DEBUG_TS_FIFO 1
