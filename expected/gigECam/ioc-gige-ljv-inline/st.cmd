#!/cds/group/pcds/epics/ioc/common/gigECam/R5.0.5/bin/rhel7-x86_64/gige

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/xcs/gigECam/R5.1.0/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-gige-ljv-inline" )
epicsEnvSet( "ENGINEER",     "Silke Nelson (snelson)" )
epicsEnvSet( "LOCATION",     "Liquid Jet Chamber" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:LJV:INLINE" )
epicsEnvSet( "IOCTOP",       "/cds/group/pcds/epics/ioc/common/gigECam/R5.0.5" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LJV:INLINE:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:EVR:GIGE:LJV:INLINE" )

# Setup EVR env vars
epicsEnvSet( "TRIG_PV",      "$(EVR_PV):TRIG6" )
...
epicsEnvSet( "CAM_IP",       "gige-ljv-inline" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LJV:INLINE" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "7817" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD),IP6E=Enabled" )

# Load both devEvrInfo.db and devTprInfo.db so python programs can test for both sets of PVs
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),EVR=$(EVR_PV),TRIG_CH=6,EVR_USED=1" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/xcs/gigECam/R5.1.0/build/iocBoot/$(IOCNAME)/launchgui-$(IOCNAME).cmd"
