...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tm2k2-gige-01" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "CRIX ATM 01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TM2K2:GIGE:01" )
...
epicsEnvSet( "EVR_PV",       "TM2K2:GIGE:01:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "TM2K2:GIGE:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "tm2k2-gige-01" )
epicsEnvSet( "CAM_PV",       "TM2K2:GIGE:01" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=TM2K2:GIGE:01:TPE,PORT=$(TPR_PORT)")
