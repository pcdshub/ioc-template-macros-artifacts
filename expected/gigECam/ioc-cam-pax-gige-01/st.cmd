#!/reg/g/pcds/epics/ioc/common/gigECam/R5.0.3/bin/rhel7-x86_64/gigeTpr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/rix/gigECam/R5.0.3/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cam-pax-gige-01" )
epicsEnvSet( "ENGINEER",     "Sainyam Nagar (nagar123)" )
epicsEnvSet( "LOCATION",     "PAX GIGE 01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PAX:GIGE:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/gigECam/R5.0.3" )
...
epicsEnvSet( "EVR_PV",       "RIX:PAX:GIGE:01:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "RIX:PAX:GIGE:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-pax-gige-01" )
epicsEnvSet( "CAM_PV",       "RIX:PAX:GIGE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8801" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=RIX:PAX:GIGE:01:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENO2,IF_NUM=1" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/rix/gigECam/R5.0.3/build/iocBoot/$(IOCNAME)/edm-$(IOCNAME).cmd"
