...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-las-gige02-1")
...
epicsEnvSet("IOC_PV", "MEC:LAS:GIGE:IOC1")
...
epicsEnvSet( "CAM_IP",		"192.168.1.10" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:LAS:GIGE:CAM1" )
