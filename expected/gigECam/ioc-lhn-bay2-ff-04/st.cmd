#!/reg/g/pcds/epics/ioc/common/gigECam/R5.0.4/bin/rhel7-x86_64/gige
...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay2-ff-04" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "LHN Bay 2; MPC BTS FF" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY2:CAM:07" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/gigECam/R5.0.4" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY2:CAM:07:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BAY2:CAM:07:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-las-lhn-bay2-07" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY2:CAM:07" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA1600-60gm" )
epicsEnvSet( "HTTP_PORT",    "7811" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/las/gigECam/R0.3.6/build/iocBoot/$(IOCNAME)/launchgui-$(IOCNAME).cmd"
