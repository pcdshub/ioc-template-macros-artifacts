...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-lbl-03" )
epicsEnvSet( "ENGINEER",     "Jackson Sheppard (sheppard)" )
epicsEnvSet( "LOCATION",     "XPP" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:LBL:03" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:LBL:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:LBL:03:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-lbl-03" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:LBL:03" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG145B" )
epicsEnvSet( "HTTP_PORT",    "7827" )
