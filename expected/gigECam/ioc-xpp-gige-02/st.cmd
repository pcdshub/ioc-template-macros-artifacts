...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-02" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE 2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:02" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:02:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-02" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:02" )
