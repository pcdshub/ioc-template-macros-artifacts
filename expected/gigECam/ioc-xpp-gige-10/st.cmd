...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-10" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE 10" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:10" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:10:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:10:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-10" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:10" )
