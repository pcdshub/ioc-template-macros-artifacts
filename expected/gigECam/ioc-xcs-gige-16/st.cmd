...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-16" )
epicsEnvSet( "ENGINEER",     "Jose E. Ortiz" )
epicsEnvSet( "LOCATION",     "XCS GigE 16" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:16" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:16:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:16" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-16" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:16" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG030B" )
epicsEnvSet( "HTTP_PORT",    "7816" )
