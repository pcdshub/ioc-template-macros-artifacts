...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-gige-05" )
epicsEnvSet( "ENGINEER",     "Tyler Pennebaker (pennebak)" )
epicsEnvSet( "LOCATION",     "CXI SC3 INLINE" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:GIGE:05" )
...
epicsEnvSet( "TPR_PV",       "CXI:GIGE:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:GIGE:EVR:05" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-05" )
epicsEnvSet( "CAM_PV",       "CXI:GIGE:05" )
