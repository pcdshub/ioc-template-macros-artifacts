...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-lj4" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "XCS GigE LJ4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:LJ4" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LJ4:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:LJ4" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-lj4" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LJ4" )
