...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im3k4-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "TMO-GS1-IM3K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM3K4:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM3K4:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM3K4:PPM:CAM:TPE" )
epicsEnvSet( "TPR_TR",       "00" )
epicsEnvSet( "TPR_CH",       "00" )
epicsEnvSet( "TPR_SE",       "00" )
epicsEnvSet( "TPR_PORT",     "trig0" )

cd( "$(IOCTOP)" )
# Specify camera env variables
epicsEnvSet( "CAM_IP",       "192.168.34.10" )
epicsEnvSet( "CAM_PV",       "IM3K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8034" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM3K4:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENP70S0F1,IF_NUM=2" )
