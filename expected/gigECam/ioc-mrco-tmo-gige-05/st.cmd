...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mrco-tmo-gige-05" )
epicsEnvSet( "ENGINEER",     "Basil Aljamal (baljamal)" )
epicsEnvSet( "LOCATION",     "TMO MRCO Solid State Chamber" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MRCO:CAM:05:IOC" )
...
epicsEnvSet( "TPR_PV",       "MRCO:CAM:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "MRCO:CAM:05:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-tmo-mrco-05" )
epicsEnvSet( "CAM_PV",       "MRCO:CAM:05" )
