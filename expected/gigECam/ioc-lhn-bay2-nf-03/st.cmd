...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay2-nf-03" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "LHN Bay 2; MPC NF1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY2:CAM:05" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY2:CAM:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BAY2:CAM:05:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.161.76" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY2:CAM:05" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA1600-60gm" )
epicsEnvSet( "HTTP_PORT",    "7810" )
