...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay2-nf-01" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "LHN Bay 2; AMPHOS NF" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY2:CAM:01" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY2:CAM:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BAY2:CAM:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.161.73" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY2:CAM:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA1600-60gm" )
epicsEnvSet( "HTTP_PORT",    "7808" )
