...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bts-ff-01" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "Laser Hall, Beam Transport System FF camera" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BTS:CAM:02" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BTS:CAM:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BTS:CAM:02:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.160.21" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BTS:CAM:02" )
