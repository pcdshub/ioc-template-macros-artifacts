...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-st1k4-gige" )
epicsEnvSet( "ENGINEER",     "Mike Estrada (mkestra)" )
epicsEnvSet( "LOCATION",     "B940-008-ST1K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:ST1K4:GIGE:01" )
...
epicsEnvSet( "TPR_PV",       "ST1K4:GIGE:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "ST1K4:GIGE:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-kfe-st1k4-01" )
epicsEnvSet( "CAM_PV",       "ST1K4:GIGE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG158B" )
epicsEnvSet( "HTTP_PORT",    "8358" )
