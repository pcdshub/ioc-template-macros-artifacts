...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cam-pax-gige-02" )
epicsEnvSet( "ENGINEER",     "Sainyam Nagar (nagar123)" )
epicsEnvSet( "LOCATION",     "PAX GIGE 02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PAX:GIGE:02" )
...
epicsEnvSet( "EVR_PV",       "RIX:PAX:GIGE:02:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "RIX:PAX:GIGE:02:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-pax-gige-02" )
epicsEnvSet( "CAM_PV",       "RIX:PAX:GIGE:02" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=RIX:PAX:GIGE:02:TPE,PORT=$(TPR_PORT)")
