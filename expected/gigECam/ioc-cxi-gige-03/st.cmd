...
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/cxi/gigECam/R5.0.1/build" )
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-gige-03" )
epicsEnvSet( "ENGINEER",     "Rajan Plumley (rajan-01)" )
epicsEnvSet( "LOCATION",     "CXI SC3 OFFAXIS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:GIGE:03" )
...
epicsEnvSet( "TPR_PV",       "CXI:GIGE:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:GIGE:EVR:03" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-03" )
epicsEnvSet( "CAM_PV",       "CXI:GIGE:03" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "7773" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/cxi/gigECam/R5.0.1/build/iocBoot/$(IOCNAME)/edm-$(IOCNAME).cmd"
