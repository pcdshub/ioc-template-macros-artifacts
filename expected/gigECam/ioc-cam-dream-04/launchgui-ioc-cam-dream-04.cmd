...
export EVR_PV=DREAM:CAM:04:NoEvr
export TRIG_CH=0
export IOC_PV=DREAM:CAM:04:IOC
export CAM=DREAM:CAM:04
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-dream-04/syncts-ioc-cam-dream-04.cmd"
