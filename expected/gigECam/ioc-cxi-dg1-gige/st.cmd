...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-dg1-gige" )
epicsEnvSet( "ENGINEER",     "Divya Thanasekaran (divya)" )
epicsEnvSet( "LOCATION",     "CXI DG1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "CXI:IOC:DG1:GIGE" )
...
epicsEnvSet( "TPR_PV",       "CXI:DG1:GIGE:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:EVR:DG1:GIGE" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-dg1" )
epicsEnvSet( "CAM_PV",       "CXI:DG1:GIGE" )
...
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),EVR=$(EVR_PV),TRIG_CH=1,EVR_USED=1" )
