...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay4-nf-01" )
epicsEnvSet( "ENGINEER",     "Tyler Johnson (tjohnson)" )
epicsEnvSet( "LOCATION",     "Laser Hall Alignment NF camera" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY4:CAM:01" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY4:CAM:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "EVR:LAS:LHN:04:NF" )
...
epicsEnvSet( "CAM_IP",       "172.21.160.175" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY4:CAM:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA2500-20gm" )
