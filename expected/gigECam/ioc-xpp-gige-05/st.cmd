...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-05" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE 05" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:05" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:05:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-05" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:05" )
