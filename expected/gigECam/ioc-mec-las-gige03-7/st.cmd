...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-las-gige03-7")
...
epicsEnvSet("IOC_PV", "MEC:LAS:GIGE:IOC7")
...
epicsEnvSet( "CAM_IP",		"192.168.7.10" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:LAS:GIGE:CAM7" )
