...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-13" )
epicsEnvSet( "ENGINEER",     "Rehan Nazir (rnazir)" )
epicsEnvSet( "LOCATION",     "XCS GigE 13" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:13" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:13:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:13:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-13" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:13" )
