...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-02" )
epicsEnvSet( "ENGINEER",     "Ernesto Paiser (paiser)" )
epicsEnvSet( "LOCATION",     "XCS GigE 2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:02" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:02:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-02" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:02" )
