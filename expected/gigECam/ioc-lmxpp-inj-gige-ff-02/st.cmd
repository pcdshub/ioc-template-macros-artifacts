...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lmxpp-inj-gige-ff-02" )
epicsEnvSet( "ENGINEER",     "Tyler Johnson (tjohnson)" )
epicsEnvSet( "LOCATION",     "XPP Injection TILE" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LMXPP:INJ_DP2_TF1_FF1" )
...
epicsEnvSet( "TPR_PV",       "LMXPP:INJ_DP2_TF1_FF1:NoTpr" )
epicsEnvSet( "EVR_PV",       "LMXPP:INJ_DP2_TF1_FF1:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.84.212" )
epicsEnvSet( "CAM_PV",       "LMXPP:INJ_DP2_TF1_FF1" )
...
dbpf $(CAM_PV):LAUNCH_EDM "/reg/g/pcds/epics/ioc/xpp/gigECam/R2.0.7/build/iocBoot/$(IOCNAME)/launchgui-$(IOCNAME).cmd"
