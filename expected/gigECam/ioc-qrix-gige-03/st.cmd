...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-gige-03" )
epicsEnvSet( "ENGINEER",     "Sainyam Nagar (nagar123)" )
epicsEnvSet( "LOCATION",     "qRIXS GIGE 03" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:GIGE:03" )
...
epicsEnvSet( "TPR_PV",       "QRIX:GIGE:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "QRIX:GIGE:03:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "QRIX:GIGE:03:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-qrix-gige-03" )
epicsEnvSet( "CAM_PV",       "QRIX:GIGE:03" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:GIGE:03:TPE,PORT=$(TPR_PORT)")
