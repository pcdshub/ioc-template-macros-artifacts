...
< envPaths
epicsEnvSet("IOCNAME", "ioc-mec-las-gige02-4")
...
epicsEnvSet("IOC_PV", "MEC:LAS:GIGE:IOC4")
...
epicsEnvSet( "CAM_IP",		"192.168.4.10" )

# PV prefix for gigE camera
epicsEnvSet( "CAM",			"MEC:LAS:GIGE:CAM4" )
