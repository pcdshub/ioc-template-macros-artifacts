...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im4k2-gige" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "K2S08-IM4K2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM4K2:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM4K2:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM4K2:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.42.10" )
epicsEnvSet( "CAM_PV",       "IM4K2:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8042" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM4K2:PPM:CAM:TPE,PORT=$(TPR_PORT)")
