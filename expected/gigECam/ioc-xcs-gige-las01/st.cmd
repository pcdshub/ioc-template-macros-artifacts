...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-las01" )
epicsEnvSet( "ENGINEER",     "Carolyn Gee (cagee)" )
epicsEnvSet( "LOCATION",     "XCS GigE laser 01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:LAS01" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LAS01:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:LAS01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-las01" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LAS01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG319C" )
