...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-lj1" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE LJ1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:LJ1" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:LJ1:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:LJ1:NoEvr" )
...
epicsEnvSet( "CAM_PV",       "XPP:GIGE:LJ1" )
