...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-cvmi-gige01" )
epicsEnvSet( "ENGINEER",     "Adam Egger (aegger)" )
epicsEnvSet( "LOCATION",     "TMO-CVMI01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IMCVMI01:PPM:CAM:IOC" )
...
epicsEnvSet( "TPR_PV",       "IMCVMI01:PPM:CAM:NoTpr" )
epicsEnvSet( "EVR_PV",       "IMCVMI01:PPM:CAM:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-tmo-05" )
epicsEnvSet( "CAM_PV",       "IMCVMI01:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "8096" )
