...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-18" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "XPP GigE 18" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:18" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:18:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:18:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-18" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:18" )
