...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im1k3-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "B940-008-K0S12-IM1K3" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM1K3:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM1K3:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM1K3:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.13.10" )
epicsEnvSet( "CAM_PV",       "IM1K3:PPM:CAM" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM1K3:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=enp69s0f0,IF_NUM=4" )
