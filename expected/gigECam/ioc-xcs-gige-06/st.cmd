...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-06" )
epicsEnvSet( "ENGINEER",     "Ernesto Paiser (paiser)" )
epicsEnvSet( "LOCATION",     "XCS GigE 6" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:06" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:06:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:06:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-06" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:06" )
