...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-07" )
epicsEnvSet( "ENGINEER",     "Ernesto Paiser (paiser)" )
epicsEnvSet( "LOCATION",     "XCS GigE 7" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:07" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:07:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:07:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-07" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:07" )
