...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-21" )
epicsEnvSet( "ENGINEER",     "Carolyn Gee (cagee)" )
epicsEnvSet( "LOCATION",     "XCS GigE 21" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:21" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:21:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:21:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-21" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:21" )
