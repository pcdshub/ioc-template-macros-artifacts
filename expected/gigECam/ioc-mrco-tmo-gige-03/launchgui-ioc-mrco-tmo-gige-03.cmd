...
export EVR_PV=MRCO:CAM:03:NoEvr
export TRIG_CH=0
export IOC_PV=MRCO:CAM:03:IOC
export CAM=MRCO:CAM:03
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-mrco-tmo-gige-03/syncts-ioc-mrco-tmo-gige-03.cmd"
