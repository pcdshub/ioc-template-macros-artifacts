...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mrco-tmo-gige-03" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "TMO MRCO 03" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MRCO:CAM:03:IOC" )
...
epicsEnvSet( "TPR_PV",       "MRCO:CAM:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "MRCO:CAM:03:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mrco-tmo-03" )
epicsEnvSet( "CAM_PV",       "MRCO:CAM:03" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "8072" )
