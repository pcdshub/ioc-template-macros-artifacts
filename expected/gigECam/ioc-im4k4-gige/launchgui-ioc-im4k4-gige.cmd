...
export TPE_PV=IM4K4:PPM:CAM:TPE
export TPR_TR=01
export TPR_CH=${TPR_TR}
export TPR_SE=${TPR_CH}
export IOC_PV=IM4K4:PPM:CAM:IOC
export CAM=IM4K4:PPM:CAM
export HUTCH=TMO

export IF=ENP70S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-im4k4-gige/syncts-ioc-im4k4-gige.cmd"
