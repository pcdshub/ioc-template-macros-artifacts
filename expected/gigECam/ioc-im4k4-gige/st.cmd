...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im4k4-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "TMO-GS1-IM4K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM4K4:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM4K4:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM4K4:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.44.10" )
epicsEnvSet( "CAM_PV",       "IM4K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8044" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM4K4:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENP70S0F0,IF_NUM=5" )
