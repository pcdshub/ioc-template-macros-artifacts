...
export EVR_PV=IMLI3K4:PPM:CAM:NoEvr
export TRIG_CH=0
export IOC_PV=IMLI3K4:PPM:CAM:IOC
export CAM=IMLI3K4:PPM:CAM
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-li3k4-gige/syncts-ioc-li3k4-gige.cmd"
