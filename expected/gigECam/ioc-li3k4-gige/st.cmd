...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-li3k4-gige" )
epicsEnvSet( "ENGINEER",     "Adam Egger (aegger)" )
epicsEnvSet( "LOCATION",     "TMO-LI3K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IMLI3K4:PPM:CAM:IOC" )
...
epicsEnvSet( "TPR_PV",       "IMLI3K4:PPM:CAM:NoTpr" )
epicsEnvSet( "EVR_PV",       "IMLI3K4:PPM:CAM:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-tmo-li3k4" )
epicsEnvSet( "CAM_PV",       "IMLI3K4:PPM:CAM" )
