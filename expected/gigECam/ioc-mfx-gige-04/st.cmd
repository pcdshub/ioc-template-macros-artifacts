...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-04" )
epicsEnvSet( "ENGINEER",     "Alex Batyuk (batyuk)" )
epicsEnvSet( "LOCATION",     "MFX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:04" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:04:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mfx-04" )
epicsEnvSet( "CAM_PV",       "MFX:GIGE:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "30088" )
