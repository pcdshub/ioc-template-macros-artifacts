...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-01" )
epicsEnvSet( "ENGINEER",     "Rehan Nazir (rnazir)" )
epicsEnvSet( "LOCATION",     "XCS GigE 1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:01" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:01:NoEvr" )
...
epicsEnvSet( "CAM_PV",       "XCS:GIGE:01" )
