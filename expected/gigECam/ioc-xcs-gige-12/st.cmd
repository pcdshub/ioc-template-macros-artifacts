...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-12" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "XCS Split and Delay DI" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:12" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:12:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:12:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-12" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:12" )
