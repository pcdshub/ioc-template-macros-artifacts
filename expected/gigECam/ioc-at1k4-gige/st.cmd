...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-at1k4-gige" )
epicsEnvSet( "ENGINEER",     "Adam Egger" )
epicsEnvSet( "LOCATION",     "B940-008-K1S10-ST1K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "AT1K4:PPM:CAM:IOC" )
...
epicsEnvSet( "TPR_PV",       "AT1K4:PPM:CAM:NoTpr" )
epicsEnvSet( "EVR_PV",       "AT1K4:PPM:CAM:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.92.88" )
epicsEnvSet( "CAM_PV",       "AT1K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "9187" )
