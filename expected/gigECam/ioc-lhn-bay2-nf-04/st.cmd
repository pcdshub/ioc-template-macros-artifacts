...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay2-nf-04" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "LHN Bay 2; MPC BTS NF" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY2:CAM:08" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY2:CAM:08:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BAY2:CAM:08:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-las-lhn-bay2-08" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY2:CAM:08" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA1600-60gm" )
epicsEnvSet( "HTTP_PORT",    "7812" )
