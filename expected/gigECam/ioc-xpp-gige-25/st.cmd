...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-25" )
epicsEnvSet( "ENGINEER",     "Tyler Pennebaker (pennebak)" )
epicsEnvSet( "LOCATION",     "XPP GigE 25" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:25" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:25:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:25:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-25" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:25" )
