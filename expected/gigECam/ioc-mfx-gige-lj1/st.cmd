...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-lj1" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "MFX GigE LJ1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:LJ1" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:LJ1:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:LJ1:NoEvr" )
...
epicsEnvSet( "CAM_PV",       "MFX:GIGE:LJ1" )
