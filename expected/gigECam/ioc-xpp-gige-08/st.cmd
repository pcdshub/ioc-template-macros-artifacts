...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-08" )
epicsEnvSet( "ENGINEER",     "Vincent Esposito (espov)" )
epicsEnvSet( "LOCATION",     "XPP GigE 08" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:08" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:08:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:08:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-08" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:08" )
