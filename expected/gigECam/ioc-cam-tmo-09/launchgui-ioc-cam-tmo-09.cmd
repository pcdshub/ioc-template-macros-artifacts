...
export EVR_PV=TMO:CAM:09:NoEvr
export TRIG_CH=0
export IOC_PV=TMO:CAM:09:IOC
export CAM=TMO:CAM:09
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-tmo-09/syncts-ioc-cam-tmo-09.cmd"
