...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-gige-07" )
epicsEnvSet( "ENGINEER",     "Divya Thanasekaran (divya)" )
epicsEnvSet( "LOCATION",     "CXI SC2 Offaxis" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:GIGE:07" )
...
epicsEnvSet( "TPR_PV",       "CXI:GIGE:07:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:GIGE:07:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-07" )
epicsEnvSet( "CAM_PV",       "CXI:GIGE:07" )
