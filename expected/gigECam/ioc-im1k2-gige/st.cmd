...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im1k2-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "K2S02-IM1K2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM1K2:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM1K2:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM1K2:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.12.10" )
epicsEnvSet( "CAM_PV",       "IM1K2:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8012" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM1K2:PPM:CAM:TPE,PORT=$(TPR_PORT)")
