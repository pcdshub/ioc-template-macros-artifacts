...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay2-nf-02" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "LHN Bay 2; OPCPA NF1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY2:CAM:03" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY2:CAM:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BAY2:CAM:03:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.161.74" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY2:CAM:03" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA1600-60gm" )
epicsEnvSet( "HTTP_PORT",    "7809" )
