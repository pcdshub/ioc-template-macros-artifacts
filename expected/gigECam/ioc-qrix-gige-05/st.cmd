...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-gige-05" )
epicsEnvSet( "ENGINEER",     "Kaushik Malapati (kaushikm)" )
epicsEnvSet( "LOCATION",     "qRIXS GIGE 05" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:GIGE:05" )
...
epicsEnvSet( "TPR_PV",       "QRIX:GIGE:05:NoTpr" )
epicsEnvSet( "EVR_PV",       "QRIX:GIGE:05:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "QRIX:GIGE:05:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-qrix-gige-05" )
epicsEnvSet( "CAM_PV",       "QRIX:GIGE:05" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:GIGE:05:TPE,PORT=$(TPR_PORT)")
