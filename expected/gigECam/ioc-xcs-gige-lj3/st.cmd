...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-lj3" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "XCS GigE LJ3" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:LJ3" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LJ3:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:LJ3" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-lj3" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LJ3" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG125C" )
epicsEnvSet( "HTTP_PORT",    "7822" )
