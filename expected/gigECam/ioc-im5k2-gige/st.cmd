...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-im5k2-gige" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "K2S13-IM5K2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IM5K2:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "IM5K2:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "IM5K2:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.52.10" )
epicsEnvSet( "CAM_PV",       "IM5K2:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8052" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=IM5K2:PPM:CAM:TPE,PORT=$(TPR_PORT)")
