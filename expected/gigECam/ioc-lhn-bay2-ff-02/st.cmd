...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bay2-ff-02" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "LHN Bay 2; OPCPA FF" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BAY2:CAM:04" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BAY2:CAM:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BAY2:CAM:04:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.161.75" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BAY2:CAM:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "Basler_acA1600-60gm" )
epicsEnvSet( "HTTP_PORT",    "7806" )
