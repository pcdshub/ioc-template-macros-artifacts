...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mrco-tmo-gige-04" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "TMO MRCO 04" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MRCO:CAM:04:IOC" )
...
epicsEnvSet( "TPR_PV",       "MRCO:CAM:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "MRCO:CAM:04:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mrco-tmo-04" )
epicsEnvSet( "CAM_PV",       "MRCO:CAM:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "8073" )
