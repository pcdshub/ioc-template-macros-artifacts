...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-08" )
epicsEnvSet( "ENGINEER",     "Ernesto Paiser (paiser)" )
epicsEnvSet( "LOCATION",     "XCS GigE 8" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:08" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:08:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:08:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-08" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:08" )
