...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mrco-tmo-gige-02" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "TMO MRCO 02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "MRCO:CAM:02:IOC" )
...
epicsEnvSet( "TPR_PV",       "MRCO:CAM:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "MRCO:CAM:02:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mrco-tmo-02" )
epicsEnvSet( "CAM_PV",       "MRCO:CAM:02" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146B" )
epicsEnvSet( "HTTP_PORT",    "8071" )
