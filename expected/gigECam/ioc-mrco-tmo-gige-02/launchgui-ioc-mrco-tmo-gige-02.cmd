...
export EVR_PV=MRCO:CAM:02:NoEvr
export TRIG_CH=0
export IOC_PV=MRCO:CAM:02:IOC
export CAM=MRCO:CAM:02
export HUTCH=TMO

export IF=ENP1S0F0

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-mrco-tmo-gige-02/syncts-ioc-mrco-tmo-gige-02.cmd"
