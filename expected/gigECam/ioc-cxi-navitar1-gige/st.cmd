...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-navitar1-gige" )
epicsEnvSet( "ENGINEER",     "Divya Thanasekaran (divya)" )
epicsEnvSet( "LOCATION",     "CXI Navitar viewing camera on SC1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:NAVITAR1:GIGE" )
...
epicsEnvSet( "TPR_PV",       "CXI:NAVITAR1:GIGE:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:NAVITAR1:GIGE:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-navitar1" )
epicsEnvSet( "CAM_PV",       "CXI:NAVITAR1:GIGE" )
