...
epicsEnvSet( "EVR_PV",       "CRIX:GIGE:05:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "CRIX:GIGE:05:TPE" )
epicsEnvSet( "TPR_TR",       "04" )
epicsEnvSet( "TPR_CH",       "04" )
epicsEnvSet( "TPR_SE",       "04" )
epicsEnvSet( "TPR_PORT",     "trig0" )

cd( "$(IOCTOP)" )
# Specify camera env variables
epicsEnvSet( "CAM_IP",       "cam-crix-gige-05" )
epicsEnvSet( "CAM_PV",       "CRIX:GIGE:05" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8805" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=CRIX:GIGE:05:TPE,PORT=$(TPR_PORT)")
