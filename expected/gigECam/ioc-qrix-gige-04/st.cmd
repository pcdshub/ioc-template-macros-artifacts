...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-gige-04" )
epicsEnvSet( "ENGINEER",     "Sainyam Nagar (nagar123)" )
epicsEnvSet( "LOCATION",     "qRIXS GIGE 04" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:GIGE:04" )
...
epicsEnvSet( "TPR_PV",       "QRIX:GIGE:04:NoTpr" )
epicsEnvSet( "EVR_PV",       "QRIX:GIGE:04:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "QRIX:GIGE:04:TPE" )
epicsEnvSet( "TPR_TR",       "0" )
epicsEnvSet( "TPR_CH",       "" )
epicsEnvSet( "TPR_SE",       "" )
...
epicsEnvSet( "CAM_IP",       "cam-qrix-gige-04" )
epicsEnvSet( "CAM_PV",       "QRIX:GIGE:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8574" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:GIGE:04:TPE,PORT=$(TPR_PORT)")
