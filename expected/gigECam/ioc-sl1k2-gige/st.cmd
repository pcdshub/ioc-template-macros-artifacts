...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-sl1k2-gige" )
epicsEnvSet( "ENGINEER",     "Zachary Lentz (zlentz)" )
epicsEnvSet( "LOCATION",     "K2S01-SL1K2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "SL1K2:EXIT:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "SL1K2:EXIT:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "SL1K2:EXIT:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.112.10" )
epicsEnvSet( "CAM_PV",       "SL1K2:EXIT:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8112" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=SL1K2:EXIT:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ETH,IF_NUM=5" )
