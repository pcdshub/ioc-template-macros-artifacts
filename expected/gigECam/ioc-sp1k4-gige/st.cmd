...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-sp1k4-gige" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "TMO-SP1K4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "SP1K4:PPM:CAM:IOC" )
...
epicsEnvSet( "EVR_PV",       "SP1K4:PPM:CAM:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "SP1K4:PPM:CAM:TPE" )
...
epicsEnvSet( "CAM_IP",       "192.168.74.10" )
epicsEnvSet( "CAM_PV",       "SP1K4:PPM:CAM" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8045" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=SP1K4:PPM:CAM:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENP65S0F0,IF_NUM=4" )
