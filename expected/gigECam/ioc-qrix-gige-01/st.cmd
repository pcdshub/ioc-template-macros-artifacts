...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-gige-01" )
epicsEnvSet( "ENGINEER",     "Will Wright (wwright8)" )
epicsEnvSet( "LOCATION",     "qRIXS GIGE 01, facing East" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:GIGE:01" )
...
epicsEnvSet( "TPR_PV",       "QRIX:GIGE:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "QRIX:GIGE:01:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "QRIX:GIGE:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-qrix-gige-01" )
epicsEnvSet( "CAM_PV",       "QRIX:GIGE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8573" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:GIGE:01:TPE,PORT=$(TPR_PORT)")
