...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-lbl-03" )
epicsEnvSet( "ENGINEER",     "Alex Batyuk (batyuk)" )
epicsEnvSet( "LOCATION",     "MFX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:LBL:03" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:LBL:03:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:LBL:03:NoEvr" )
...
epicsEnvSet( "CAM_PV",       "MFX:GIGE:LBL:03" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG145B" )
epicsEnvSet( "HTTP_PORT",    "30085" )
