...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-13" )
epicsEnvSet( "ENGINEER",     "Vincent Esposto (espov)" )
epicsEnvSet( "LOCATION",     "XPP Gig 13" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:13" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:13:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:13:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-13" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:13" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG030B" )
epicsEnvSet( "HTTP_PORT",    "7813" )
