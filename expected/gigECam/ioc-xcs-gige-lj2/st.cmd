...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-lj2" )
epicsEnvSet( "ENGINEER",     "Jyoti Joshi (jjoshi)" )
epicsEnvSet( "LOCATION",     "XCS GigE LJ2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:LJ2" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:LJ2:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:EVR:LJ2" )

# Setup EVR env vars
epicsEnvSet( "TRIG_PV",      "$(EVR_PV):TRIG5" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-lj2" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:LJ2" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG125B" )
...
dbLoadRecords( "$(EVRDB)", "IOC=$(IOC_PV),EVR=$(EVR_PV),CARD=$(EVR_CARD),IP5E=Enabled" )

# Load both devEvrInfo.db and devTprInfo.db so python programs can test for both sets of PVs
dbLoadRecords( "db/devEvrInfo.db",				"DEV=$(CAM_PV),EVR=$(EVR_PV),TRIG_CH=5,EVR_USED=1" )
