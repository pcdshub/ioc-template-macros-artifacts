...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lhn-bts-nf-01" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "Laser Hall, Beam Transport System NF camera" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:BTS:CAM:01" )
...
epicsEnvSet( "TPR_PV",       "LAS:LHN:BTS:CAM:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "LAS:LHN:BTS:CAM:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "172.21.160.22" )
epicsEnvSet( "CAM_PV",       "LAS:LHN:BTS:CAM:01" )
