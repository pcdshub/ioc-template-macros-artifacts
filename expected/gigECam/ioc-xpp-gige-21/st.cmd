...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-21" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "XPP GigE 21" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:21" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:21:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:21:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-21" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:21" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG234B" )
epicsEnvSet( "HTTP_PORT",    "7830" )
