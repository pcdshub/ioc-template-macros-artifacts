...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xpp-gige-20" )
epicsEnvSet( "ENGINEER",     "Aalayah Spencer (spencera)" )
epicsEnvSet( "LOCATION",     "XPP GigE 20" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XPP:GIGE:20" )
...
epicsEnvSet( "TPR_PV",       "XPP:GIGE:20:NoTpr" )
epicsEnvSet( "EVR_PV",       "XPP:GIGE:20:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xpp-20" )
epicsEnvSet( "CAM_PV",       "XPP:GIGE:20" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MakoG234B" )
epicsEnvSet( "HTTP_PORT",    "7825" )
