...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-gige-08" )
epicsEnvSet( "ENGINEER",     "Divya Thanasekaran (divya)" )
epicsEnvSet( "LOCATION",     "CXI SC1 Offaxis" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:GIGE:08" )
...
epicsEnvSet( "TPR_PV",       "CXI:GIGE:08:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:GIGE:08:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-08" )
epicsEnvSet( "CAM_PV",       "CXI:GIGE:08" )
