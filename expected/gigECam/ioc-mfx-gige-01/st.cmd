...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-mfx-gige-01" )
epicsEnvSet( "ENGINEER",     "Alex Batyuk (batyuk)" )
epicsEnvSet( "LOCATION",     "MFX" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:MFX:GIGE:01" )
...
epicsEnvSet( "TPR_PV",       "MFX:GIGE:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "MFX:GIGE:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-mfx-01" )
epicsEnvSet( "CAM_PV",       "MFX:GIGE:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG146C" )
epicsEnvSet( "HTTP_PORT",    "35206" )
