...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cxi-gige-06" )
epicsEnvSet( "ENGINEER",     "Tyler Pennebak (pennebak)" )
epicsEnvSet( "LOCATION",     "CXI SC2 Inline" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CXI:GIGE:06" )
...
epicsEnvSet( "TPR_PV",       "CXI:GIGE:06:NoTpr" )
epicsEnvSet( "EVR_PV",       "CXI:GIGE:06:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-cxi-06" )
epicsEnvSet( "CAM_PV",       "CXI:GIGE:06" )
