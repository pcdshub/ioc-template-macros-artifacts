#!/reg/g/pcds/epics/ioc/common/gigECam/R5.1.0/bin/rhel7-x86_64/gige
...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-cam-peppex-01" )
epicsEnvSet( "ENGINEER",     "Maarten Thomas-Bosum (bosum123)" )
epicsEnvSet( "LOCATION",     "Undulator Hall PEPPEX Stand" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TMO:CAM:PEPPEX:IOC" )
...
epicsEnvSet( "TPR_PV",       "TMO:CAM:PEPPEX:01:NoTpr" )
epicsEnvSet( "EVR_PV",       "TMO:CAM:PEPPEX:01:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "cam-tmo-peppex-01" )
epicsEnvSet( "CAM_PV",       "TMO:CAM:PEPPEX:01" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG125B" )
epicsEnvSet( "HTTP_PORT",    "8119" )
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENP1S0F0,IF_NUM=0" )
