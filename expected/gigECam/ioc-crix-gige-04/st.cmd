...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-crix-gige-04" )
epicsEnvSet( "ENGINEER",     "Tyler Johnson (tjohnson)" )
epicsEnvSet( "LOCATION",     "ChemRIXS GIGE 01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CRIX:GIGE:04" )
...
epicsEnvSet( "EVR_PV",       "CRIX:GIGE:04:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "CRIX:GIGE:04:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-crix-gige-04" )
epicsEnvSet( "CAM_PV",       "CRIX:GIGE:04" )
epicsEnvSet( "CAM_PORT",     "CAM" )
epicsEnvSet( "MODEL",        "MantaG419B" )
epicsEnvSet( "HTTP_PORT",    "8804" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=CRIX:GIGE:04:TPE,PORT=$(TPR_PORT)")
...
dbLoadRecords("db/netstat.template", "P=$(IOC_PV),IF=ENO1,IF_NUM=1" )
