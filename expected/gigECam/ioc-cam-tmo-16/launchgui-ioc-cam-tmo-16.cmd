...
export EVR_PV=TMO:CAM:16:NoEvr
export TRIG_CH=0
export IOC_PV=TMO:CAM:16:IOC
export CAM=TMO:CAM:16
export HUTCH=TMO

export IF=ETH

export SYNCTS="/reg/g/pcds/epics/ioc/tmo/gigECam/R5.1.0/build/iocBoot/ioc-cam-tmo-16/syncts-ioc-cam-tmo-16.cmd"
