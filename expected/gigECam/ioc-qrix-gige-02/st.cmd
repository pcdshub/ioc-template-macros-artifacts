...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-gige-02" )
epicsEnvSet( "ENGINEER",     "Will Wright (wwright8)" )
epicsEnvSet( "LOCATION",     "qRIXS GIGE 02, facing South" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:GIGE:02" )
...
epicsEnvSet( "TPR_PV",       "QRIX:GIGE:02:NoTpr" )
epicsEnvSet( "EVR_PV",       "QRIX:GIGE:02:NoEvr" )

# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPE_PV",       "QRIX:GIGE:02:TPE" )
...
epicsEnvSet( "CAM_IP",       "cam-qrix-gige-02" )
epicsEnvSet( "CAM_PV",       "QRIX:GIGE:02" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:GIGE:02:TPE,PORT=$(TPR_PORT)")
