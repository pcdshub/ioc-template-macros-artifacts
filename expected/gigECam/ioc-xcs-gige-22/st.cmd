...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-gige-22" )
epicsEnvSet( "ENGINEER",     "Rehan Nazir (rnazir)" )
epicsEnvSet( "LOCATION",     "XCS GigE 22" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:GIGE:22" )
...
epicsEnvSet( "TPR_PV",       "XCS:GIGE:22:NoTpr" )
epicsEnvSet( "EVR_PV",       "XCS:GIGE:22:NoEvr" )
...
epicsEnvSet( "CAM_IP",       "gige-xcs-22" )
epicsEnvSet( "CAM_PV",       "XCS:GIGE:22" )
