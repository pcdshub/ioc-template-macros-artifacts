...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lco-01>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LCO:01" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LCO:IOC:01")
epicsEnvSet( "LOCATION",  "MEC:LPL:LCO:IOC:01")
epicsEnvSet( "IP",        "172.21.76.188"       )
epicsEnvSet( "IP_PORT",	  "502"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LCO:01"     )
