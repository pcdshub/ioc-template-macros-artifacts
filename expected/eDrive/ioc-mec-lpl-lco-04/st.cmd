...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lco-04>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LCO:04" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LCO:IOC:04")
epicsEnvSet( "LOCATION",  "MEC:LPL:LCO:IOC:04")
epicsEnvSet( "IP",        "172.21.76.195"       )
epicsEnvSet( "IP_PORT",	  "502"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LCO:04"     )
