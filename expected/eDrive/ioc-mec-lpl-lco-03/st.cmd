...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lco-03>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LCO:03" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LCO:IOC:03")
epicsEnvSet( "LOCATION",  "MEC:LPL:LCO:IOC:03")
epicsEnvSet( "IP",        "172.21.76.194"       )
epicsEnvSet( "IP_PORT",	  "502"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LCO:03"     )
