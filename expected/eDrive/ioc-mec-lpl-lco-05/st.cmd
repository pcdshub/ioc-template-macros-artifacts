...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lco-05>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LCO:05" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LCO:IOC:05")
epicsEnvSet( "LOCATION",  "MEC:LPL:LCO:IOC:05")
epicsEnvSet( "IP",        "172.21.76.196"       )
epicsEnvSet( "IP_PORT",	  "502"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LCO:05"     )
