...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-lpl-lco-06>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:LPL:LCO:06" )
epicsEnvSet( "IOCPVROOT", "MEC:LPL:LCO:IOC:06")
epicsEnvSet( "LOCATION",  "MEC:LPL:LCO:IOC:06")
epicsEnvSet( "IP",        "172.21.76.197"       )
epicsEnvSet( "IP_PORT",	  "502"     )
epicsEnvSet( "BASE_NAME", "MEC:LPL:LCO:06"     )
