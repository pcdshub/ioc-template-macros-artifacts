...
epicsEnvSet( "IOC_PV",    "XCS:LC20:IOC:01" )
...
epicsEnvSet( "DEV0", "XCS:SDS:LC20:01" )
drvAsynIPPortConfigure( "DEV0", "moxa-xcs-10:4001 TCP", 0, 0, 0 )
dbLoadRecords( "db/lc20.db", "DEV=XCS:SDS:LC20:01,PORT=DEV0" )
#asynSetTraceMask( "DEV0", 0, 9 )
#asynSetTraceIOMask( "DEV0", 0, 2 )
#asynSetTraceFile( "DEV0",0,"$(IOC_DATA)/$(IOC)/iocInfo/" )

epicsEnvSet( "DEV1", "XCS:SDS:LC20:02" )
drvAsynIPPortConfigure( "DEV1", "moxa-xcs-10:4002 TCP", 0, 0, 0 )
dbLoadRecords( "db/lc20.db", "DEV=XCS:SDS:LC20:02,PORT=DEV1" )
