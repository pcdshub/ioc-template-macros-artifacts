...
epicsEnvSet( "IOC_PV",    "XPP:LC20:IOC:01" )
...
epicsEnvSet( "DEV0", "XPP:SDS:LC20:01" )
drvAsynIPPortConfigure( "DEV0", "moxa-xpp-06:4013 TCP", 0, 0, 0 )
dbLoadRecords( "db/lc20.db", "DEV=XPP:SDS:LC20:01,PORT=DEV0" )
#asynSetTraceMask( "DEV0", 0, 9 )
#asynSetTraceIOMask( "DEV0", 0, 2 )
#asynSetTraceFile( "DEV0",0,"$(IOC_DATA)/$(IOC)/iocInfo/" )

epicsEnvSet( "DEV1", "XPP:SDS:LC20:02" )
drvAsynIPPortConfigure( "DEV1", "moxa-xpp-06:4014 TCP", 0, 0, 0 )
dbLoadRecords( "db/lc20.db", "DEV=XPP:SDS:LC20:02,PORT=DEV1" )
#asynSetTraceMask( "DEV1", 0, 9 )
#asynSetTraceIOMask( "DEV1", 0, 2 )
#asynSetTraceFile( "DEV1",0,"$(IOC_DATA)/$(IOC)/iocInfo/" )

epicsEnvSet( "DEV2", "XPP:SDS:LC20:03" )
drvAsynIPPortConfigure( "DEV2", "moxa-xpp-06:4015 TCP", 0, 0, 0 )
dbLoadRecords( "db/lc20.db", "DEV=XPP:SDS:LC20:03,PORT=DEV2" )
#asynSetTraceMask( "DEV2", 0, 9 )
#asynSetTraceIOMask( "DEV2", 0, 2 )
#asynSetTraceFile( "DEV2",0,"$(IOC_DATA)/$(IOC)/iocInfo/" )

epicsEnvSet( "DEV3", "XPP:SDS:LC20:04" )
drvAsynIPPortConfigure( "DEV3", "moxa-xpp-06:4016 TCP", 0, 0, 0 )
dbLoadRecords( "db/lc20.db", "DEV=XPP:SDS:LC20:04,PORT=DEV3" )
