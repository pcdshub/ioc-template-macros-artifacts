...
< envPaths
epicsEnvSet("IOCNAME", "ioc-xcs-lodcm" )
epicsEnvSet("ENGINEER", "Daniel Damiani (ddamiani)" )
epicsEnvSet("LOCATION", "XCS:R44:E19" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:XCS:LODCM")
epicsEnvSet("IOCTOP", "/reg/g/pcds/package/epics/3.14/ioc/common/lodcm/R1.0.0")
epicsEnvSet("TOP", "/reg/g/pcds/package/epics/3.14/ioc/xcs/lodcm/R1.0.0/build")
...
dbLoadRecords( "db/lodcm.db", "NAME=XCS:LODCM,MPRE=XCS:LODCM" )
