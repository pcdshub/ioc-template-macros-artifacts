...
epicsEnvSet( "IOCSH_PS1", "ioc-lm1k4-com-ell-01>" )
epicsEnvSet( "IOCPVROOT", "IOC:LM1K4:COM_DP1_TF1_SL1:ELL:0"   )
...
drvAsynSerialPortConfigure(ELL0, "/dev/ftdi-DT03B9Z5")
...
## Asyn record support
dbLoadRecords( "db/asynRecord.db","P=LM1K4:COM_DP1_TF1_SL1:ELL,R=,PORT=ELL0,ADDR=0,OMAX=0,IMAX=0")

#------------------------------------------------------------------------------
# Load record instances
dbLoadRecords( "db/ellALL.db", "BASE=LM1K4:COM_DP1_TF1_SL1:ELL:M1,ADDRESS=1,PORT=ELL0" )
dbLoadRecords( "db/ell6.db", "BASE=LM1K4:COM_DP1_TF1_SL1:ELL:M1,ADDRESS=1,PORT=ELL0" )




dbLoadRecords( "db/ellport.db", "BASE=LM1K4:COM_DP1_TF1_SL1:ELL:PORT0,PORT=ELL0" )
