...
< envPaths
epicsEnvSet("IOCNAME", "ioc-cxi-hmp01" )
epicsEnvSet("ENGINEER", "Divya Thanasekaran (divya)" )
epicsEnvSet("LOCATION", "CXI:HMP:01" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:CXI:HMP:01")
...
drvAsynIPPortConfigure( "CXI:HMP:01", "hmp-cxi-01:5025 TCP", 0, 0, 0 )

asynSetTraceMask( "CXI:HMP:01", 0, 0x1 ) # logging for normal operation

# Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):" )
dbLoadRecords( "db/hmp4030.db", "HMP=CXI:HMP:01,PORT=CXI:HMP:01" )
