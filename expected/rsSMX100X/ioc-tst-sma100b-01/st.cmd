...
epicsEnvSet( "IOCNAME",	  "ioc-tst-sma100b-01" )
epicsEnvSet( "ENGINEER",  "tjohnson" )
epicsEnvSet( "LOCATION",  "B950 R221 FTL" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:LAS:FTL:SGN:01" )
...
##############################################################
drvAsynIPPortConfigure( "bus0", "sgn-las-sma100b-01:5025", 0, 0, 0 )
...
dbLoadRecords( "db/SMA.db", "BASE=LAS:FTL:SGN:01, PORT=bus0" )
#dbLoadRecords( "db/SMA.db", "BASE=LAS:FTL:SGN:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-tst-sma100b-01.sav" )
...
create_monitor_set( "ioc-tst-sma100b-01.req", 5, "" )
