...
epicsEnvSet( "EPICS_NAME",           "IOC:XPP:SB3:LCH:IMS" )
epicsEnvSet( "LOCATION",             "XPP:SB3"  )
epicsEnvSet( "IOCSH_PS1",            "ioc-xpp-sb3-lch-ims> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-xpp-sb3-lch-ims/autosave" )

set_pass0_restoreFile( "ioc-xpp-sb3-lch-ims.sav"                  )

# Initialize the IOC and start processing records
iocInit()

create_monitor_set( "ioc-xpp-sb3-lch-ims.req", 30, "" );
