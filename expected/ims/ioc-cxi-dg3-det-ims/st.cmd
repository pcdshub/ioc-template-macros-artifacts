...
epicsEnvSet( "EPICS_NAME",           "IOC:CXI:DG3:DET:IMS" )
epicsEnvSet( "LOCATION",             "CXI:XXX"  )
epicsEnvSet( "IOCSH_PS1",            "ioc-cxi-dg3-det-ims> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-cxi-dg3-det-ims/autosave" )

set_pass0_restoreFile( "ioc-cxi-dg3-det-ims.sav"                  )

# Initialize the IOC and start processing records
iocInit()

create_monitor_set( "ioc-cxi-dg3-det-ims.req", 30, "" );
