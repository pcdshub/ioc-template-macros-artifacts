...
epicsEnvSet( "EPICS_NAME",           "IOC:CXI:USR:SC2:DUMB:IMS" )
epicsEnvSet( "LOCATION",             "CXI:XXX"  )
epicsEnvSet( "IOCSH_PS1",            "ioc-cxi-usr-sc2-dumb-ims> " )
...
set_savefile_path    ( "$(IOC_DATA)/ioc-cxi-usr-sc2-dumb-ims/autosave" )

set_pass0_restoreFile( "ioc-cxi-usr-sc2-dumb-ims.sav"                  )

# Initialize the IOC and start processing records
iocInit()

create_monitor_set( "ioc-cxi-usr-sc2-dumb-ims.req", 30, "" );
