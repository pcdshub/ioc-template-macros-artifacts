...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-hex3>" )
epicsEnvSet( "IOCPVROOT", "IOC:MEC:HEX3"   )
...
drvAsynIPPortConfigure("PI887_0", "hexapod-mec-03:50000 TCP", 0, 0, 0 )

# Load record instances
dbLoadRecords( "db/iocSoft.db",			"IOC=IOC:MEC:HEX3" )
dbLoadRecords( "db/save_restoreStatus.db",	"P=IOC:MEC:HEX3:" )
dbLoadRecords( "db/asynRecord.db",		"Dev=MEC:HEX:03,PORT=PI887_0" )
dbLoadRecords( "db/PIHexapod887.db",		"baseName=MEC:HEX:03,port=PI887_0" )
...
# Setup autosave
save_restoreSet_status_prefix( "IOC:MEC:HEX3:" )
