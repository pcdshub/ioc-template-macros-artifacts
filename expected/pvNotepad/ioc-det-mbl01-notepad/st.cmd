...
epicsEnvSet( "EPICS_NAME", "IOC:DET:MBL01:NOTEPAD" )
epicsEnvSet( "ENGINEER",  "Michael Browne (mcbrowne)" )
epicsEnvSet( "LOCATION",  "SLAC:LCLS" )
epicsEnvSet( "IOCSH_PS1", "ioc-det-mbl01-notepad> ")
...
dbLoadRecords("$(TOP)/db/hutch.db",    "PV=DET:MBL:01:HUTCH")
...
set_savefile_path   ( "$(IOC_DATA)/ioc-det-mbl01-notepad/autosave" )

set_pass0_restoreFile( "ioc-det-mbl01-notepad.sav" )        #just restore the settings
set_pass1_restoreFile( "ioc-det-mbl01-notepad.sav" )        #just restore the settings
...
create_monitor_set( "ioc-det-mbl01-notepad.req", 30, "" )
