...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-wfs01" )
epicsEnvSet( "ENGINEER",     "Michael Browne (mcbrowne)" )
epicsEnvSet( "LOCATION",     "Heinz Lab WFS" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:WFS:01" )
...
epicsEnvSet( "EVR_PV",       "LAS:WFS:EVR:01" )
# Setup EVR env vars
