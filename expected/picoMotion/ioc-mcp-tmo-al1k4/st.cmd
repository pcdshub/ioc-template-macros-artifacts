...
epicsEnvSet("IOC", "ioc-mcp-tmo-al1k4")
epicsEnvSet("IOCSH_PS1", "$(IOC)> ")
epicsEnvSet("EPICS_NAME", "AL1K4:L2SI:MCP:IOC")
epicsEnvSet("IOCTOP","/reg/g/pcds/epics/ioc/common/picoMotion/R4.0.1")
epicsEnvSet("TOP","/reg/g/pcds/epics/ioc/kfe/picoMotion/R1.0.1/build")
epicsEnvSet("STREAM_PROTOCOL_PATH", "$(IOCTOP)/protocol" )
epicsEnvSet("IP", "mcp-tmo-al1k4")
epicsEnvSet("Port", "P0")
epicsEnvSet("CtrlBase", "M")
epicsEnvSet("PREFIX", "AL1K4:L2SI:MCP")
