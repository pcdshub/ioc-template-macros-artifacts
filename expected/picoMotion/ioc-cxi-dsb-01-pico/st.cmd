...
epicsEnvSet("IOC", "ioc-cxi-dsb-01-pico")
epicsEnvSet("IOCSH_PS1", "$(IOC)> ")
epicsEnvSet("EPICS_NAME", "IOC:CXI:DSB:01:PICO" )
...
dbLoadRecords("db/basic_motor.db","C=0,S=0,P=,M=CXI:DSB:PIC:01,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_0,$(OPEN_MM)")
dbLoadRecords("db/basic_motor.db","C=0,S=1,P=,M=CXI:DSB:PIC:02,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_1,$(OPEN_MM)")
dbLoadRecords("db/basic_motor.db","C=0,S=2,P=,M=CXI:DSB:PIC:03,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_2,$(OPEN_MM)")
dbLoadRecords("db/basic_motor.db","C=0,S=3,P=,M=CXI:DSB:PIC:04,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_3,$(OPEN_MM)")
dbLoadRecords("db/basic_motor.db","C=0,S=4,P=,M=CXI:DSB:PIC:05,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_4,$(OPEN_MM)")
dbLoadRecords("db/basic_motor.db","C=0,S=5,P=,M=CXI:DSB:PIC:06,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_5,$(OPEN_MM)")
...
dbLoadRecords("db/asynRecord.db", "P=mcf-cxi-dsb-01,R=:asyn,PORT=mcf-cxi-dsb-01,ADDR=0,IMAX=0,OMAX=0")
drvAsynIPPortConfigure("mcf-cxi-dsb-01","mcf-cxi-dsb-01:23 TCP",0,0,0)
PMNC87xxConfig(0,"mcf-cxi-dsb-01")
