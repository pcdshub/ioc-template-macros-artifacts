...
epicsEnvSet("IOC", "ioc-cxi-sc2-02-pico")
epicsEnvSet("IOCSH_PS1", "$(IOC)> ")
epicsEnvSet("EPICS_NAME", "IOC:CXI:SC2:02:PICO" )
...
dbLoadRecords("db/basic_motor.db","C=0,S=0,P=,M=CXI:LAS:PIC:07,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_0,$(OPEN_DEGREES)")
dbLoadRecords("db/basic_motor.db","C=0,S=1,P=,M=CXI:LAS:PIC:08,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_1,$(OPEN_DEGREES)")
dbLoadRecords("db/basic_motor.db","C=0,S=2,P=,M=CXI:LAS:PIC:09,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_2,$(OPEN_DEGREES)")
dbLoadRecords("db/basic_motor.db","C=0,S=3,P=,M=CXI:LAS:PIC:10,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_3,$(OPEN_DEGREES)")
dbLoadRecords("db/basic_motor.db","C=0,S=4,P=,M=CXI:LAS:PIC:11,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_4,$(OPEN_DEGREES)")
dbLoadRecords("db/basic_motor.db","C=0,S=5,P=,M=CXI:LAS:PIC:12,DTYP=PMNC87xx,DIR=Pos,INIT='',DESC=PICO_5,$(OPEN_DEGREES)")
...
dbLoadRecords("db/asynRecord.db", "P=mcf-cxi-sc2-02,R=:asyn,PORT=mcf-cxi-sc2-02,ADDR=0,IMAX=0,OMAX=0")
drvAsynIPPortConfigure("mcf-cxi-sc2-02","mcf-cxi-sc2-02:23 TCP",0,0,0)
PMNC87xxConfig(0,"mcf-cxi-sc2-02")
