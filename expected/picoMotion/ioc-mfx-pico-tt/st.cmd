...
epicsEnvSet("IOC", "ioc-mfx-pico-tt")
epicsEnvSet("IOCSH_PS1", "$(IOC)> ")
epicsEnvSet("EPICS_NAME", "IOC:MFX:LAS:PIC:TT")
...
epicsEnvSet("IP", "mcf-mfx-las2")
epicsEnvSet("Port", "P0")
epicsEnvSet("CtrlBase", "M")
epicsEnvSet("PREFIX", "MFX:LAS:PIC:TT")
...
dbLoadRecords("db/basic_asyn_motor.db","P=$(PREFIX):,M=02,DTYP='asynMotor',DIR=Pos,INIT='',DESC=02,PORT=$(CtrlBase)0,ADDR=1,$(OPEN_MM)")
