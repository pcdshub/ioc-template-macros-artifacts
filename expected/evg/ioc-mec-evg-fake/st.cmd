...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-evg-fake>" )
epicsEnvSet( "IOCPVROOT", "IOC:MEC:EVG:0"   )
...
drvAsynIPPortConfigure("EVG0", "ioc-mec-evg:10200 TCP", 0, 0, 0 )
drvAsynIPPortConfigure("EVG1", "ioc-mec-evg:10200 TCP", 0, 0, 0 )
...
dbLoadRecords( "db/evg.db",              	"PREFIX=FAKE,PORT=EVG0,PORTX=EVG1,REBOOT=$(IOCPVROOT):SYSRESET.PROC" )
...
dbpf FAKE:ECS:SYS0:1:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:2:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:3:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:4:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:5:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:6:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:7:SEQ.PROC 1
dbpf FAKE:ECS:SYS0:8:SEQ.PROC 1
