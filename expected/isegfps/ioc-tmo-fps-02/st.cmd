...
##############################################################
drvAsynIPPortConfigure( "bus0", "isegfps-tmo-mgbt-02:10001", 0, 0, 0 )
...
dbLoadRecords( "db/isegfps.template", "BASE=TMO:FPS:02, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-tmo-fps-02.sav" )
...
create_monitor_set( "ioc-tmo-fps-02.req", 5, "" )
