...
##############################################################
drvAsynIPPortConfigure( "bus0", "isegfps-tmo-mgbt-01:10001", 0, 0, 0 )
...
dbLoadRecords( "db/isegfps.template", "BASE=TMO:FPS:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-tmo-fps-01.sav" )
...
create_monitor_set( "ioc-tmo-fps-01.req", 5, "" )
