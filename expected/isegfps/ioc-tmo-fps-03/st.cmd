...
##############################################################
drvAsynIPPortConfigure( "bus0", "isegfps-tmo-mgbt-03:10001", 0, 0, 0 )
...
dbLoadRecords( "db/isegfps.template", "BASE=TMO:FPS:03, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-tmo-fps-03.sav" )
...
create_monitor_set( "ioc-tmo-fps-03.req", 5, "" )
