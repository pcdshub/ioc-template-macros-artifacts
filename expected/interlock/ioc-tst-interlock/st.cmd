...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tst-interlock" )
epicsEnvSet( "ENGINEER",     "Kaushik Malapati (kaushikm)" )
epicsEnvSet( "LOCATION",     "Location" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TST:IOC:IL" )
...
dbLoadRecords( "db/interlock.db", "BASE=TST:IL:01, DESC=" )
dbLoadRecords( "db/interlock.db", "BASE=TST:IL:02, DESC=" )
dbLoadRecords( "db/interlock.db", "BASE=TST:IL:03, DESC=" )
dbLoadRecords( "db/interlock.db", "BASE=TST:IL:04, DESC=" )
dbLoadRecords( "db/interlock.db", "BASE=TST:IL:05, DESC=" )
