...
epicsEnvSet( "IOCSH_PS1", "ioc-las-lhn-slice-02>" )
epicsEnvSet( "IOCPVROOT", "IOC:LAS:LHN:SLICE:02"   )
...
drvAsynSerialPortConfigure("SLICE0", "/dev/slice-000552")
...
## Asyn record support
dbLoadRecords( "db/asynRecord.db","P=LAS:LHN:SLICE:02,R=,PORT=SLICE0,ADDR=0,OMAX=0,IMAX=0")

#------------------------------------------------------------------------------
# Load record instances
dbLoadRecords( "db/slice-dhv-ctl.db", "BASE=LAS:LHN:SLICE:02,PORT=SLICE0" )
dbLoadRecords( "db/slice-dhv-chan.db", "BASE=LAS:LHN:SLICE:02,CH=1,PORT=SLICE0" )
dbLoadRecords( "db/slice-dhv-chan.db", "BASE=LAS:LHN:SLICE:02,CH=2,PORT=SLICE0" )
