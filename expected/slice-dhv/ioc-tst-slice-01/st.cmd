...
epicsEnvSet( "IOCSH_PS1", "ioc-tst-slice-01>" )
epicsEnvSet( "IOCPVROOT", "IOC:TST:SLICE:0"   )
epicsEnvSet( "LOCATION",  "ASC Timing Lab")
epicsEnvSet( "IOC_TOP",   "/cds/group/pcds/epics/ioc/common/slice-dhv/R1.0.1"   )
epicsEnvSet( "TOP",       "/cds/group/pcds/epics/ioc/common/slice-dhv/R1.0.1/children/build"      )
...
drvAsynSerialPortConfigure("SLICE0", "/dev/slice-00000000001A")
...
## Asyn record support
dbLoadRecords( "db/asynRecord.db","P=LAS:TST:SLICE:01,R=,PORT=SLICE0,ADDR=0,OMAX=0,IMAX=0")

#------------------------------------------------------------------------------
# Load record instances
dbLoadRecords( "db/slice-dhv-ctl.db", "BASE=LAS:TST:SLICE:01,PORT=SLICE0" )
dbLoadRecords( "db/slice-dhv-chan.db", "BASE=LAS:TST:SLICE:01,CH=1,PORT=SLICE0" )
dbLoadRecords( "db/slice-dhv-chan.db", "BASE=LAS:TST:SLICE:01,CH=2,PORT=SLICE0" )
