...
< envPaths
epicsEnvSet("IOCNAME", "ioc-crix-usr-ls336" )
epicsEnvSet("ENGINEER", "Aalayah Spencer (spencera)" )
epicsEnvSet("LOCATION", "CRIX:IOC:TCT:LS336" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:CRIX:USR:TCT")
...
drvAsynIPPortConfigure( "CRIX:USR:TCT:01", "lakeshore-crix-01:7777 TCP", 0, 0, 0 )

asynSetTraceMask( "CRIX:USR:TCT:01", 0, 0x1 ) # logging for normal operation

# Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV)" )
dbLoadRecords( "db/ls336.db", "TCT=CRIX:USR:TCT:01,PORT=CRIX:USR:TCT:01,DSCAN=1,CSCAN=5" )
