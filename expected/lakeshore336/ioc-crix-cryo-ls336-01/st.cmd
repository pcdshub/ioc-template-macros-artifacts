...
drvAsynIPPortConfigure( "CRIX:CRYO:TCT:01", "lakeshore-crix-cryo-01:7777 TCP", 0, 0, 0 )

asynSetTraceMask( "CRIX:CRYO:TCT:01", 0, 0x1 ) # logging for normal operation

# Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)" )
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV)" )
dbLoadRecords( "db/ls336.db", "TCT=CRIX:CRYO:TCT:01,PORT=CRIX:CRYO:TCT:01,DSCAN=1,CSCAN=5" )
