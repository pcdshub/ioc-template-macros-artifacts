...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-tpr-andor1" )
epicsEnvSet( "ENGINEER",     "Michael Browne (mcbrowne)" )
epicsEnvSet( "LOCATION",     "TMO (daq-tmo-andor-01)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TMO:IOC:ANDOR:TPR:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/tprStandalone/R1.2.0" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/tmo/tprStandalone/R1.2.0/build" )
cd( "$(IOCTOP)" )

# Set Max array size
epicsEnvSet( "EPICS_CA_MAX_ARRAY_BYTES", "20000000" )
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "TMO:ANDOR:TPR:01" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=TMO:ANDOR:TPR:01,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=TMO:ANDOR:TPR:01:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:ANDOR:TPR:01,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=TMO:IOC:ANDOR:TPR:01" )
dbLoadRecords( "db/iocRelease.db",			"IOC=TMO:IOC:ANDOR:TPR:01" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=TMO:IOC:ANDOR:TPR:01:SR:" )
