#!/cds/group/pcds/epics/ioc/common/tprStandalone/R1.2.0/bin/rhel7-x86_64/tpr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-det-asc-tpr2" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "DET (daq-det-evr01)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "DET:IOC:ASC:TPR:02" )
epicsEnvSet( "IOCTOP",       "/cds/group/pcds/epics/ioc/common/tprStandalone/R1.2.0" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/det/tprStandalone/R1.2.0/build" )
cd( "$(IOCTOP)" )

# Set Max array size
epicsEnvSet( "EPICS_CA_MAX_ARRAY_BYTES", "20000000" )
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "DET:ASC:TPR:02" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=DET:ASC:TPR:02,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=DET:ASC:TPR:02:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:02,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=DET:IOC:ASC:TPR:02" )
dbLoadRecords( "db/iocRelease.db",			"IOC=DET:IOC:ASC:TPR:02" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=DET:IOC:ASC:TPR:02:SR:" )
