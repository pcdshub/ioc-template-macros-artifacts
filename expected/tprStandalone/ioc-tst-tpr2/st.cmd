...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tst-tpr2" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "Lab" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TST:IOC:TPR:02" )
epicsEnvSet( "IOCTOP",       "/cds/group/pcds/epics/ioc/common/tprStandalone/R1.2.0" )
epicsEnvSet( "BUILD_TOP",    "/cds/group/pcds/epics/ioc/common/tprStandalone/R1.2.0/children/build" )
cd( "$(IOCTOP)" )

# Set Max array size
epicsEnvSet( "EPICS_CA_MAX_ARRAY_BYTES", "20000000" )
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "TST:TPR:02" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=TST:TPR:02,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=TST:TPR:02:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=TST:TPR:02,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=TST:IOC:TPR:02" )
dbLoadRecords( "db/iocRelease.db",			"IOC=TST:IOC:TPR:02" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=TST:IOC:TPR:02:SR:" )
