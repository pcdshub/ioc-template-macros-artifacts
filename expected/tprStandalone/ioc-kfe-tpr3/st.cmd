#!/reg/g/pcds/epics/ioc/common/tprStandalone/R1.1.6/bin/rhel7-x86_64/tpr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-tpr3" )
epicsEnvSet( "ENGINEER",     "Bruce Hill (bhill)" )
epicsEnvSet( "LOCATION",     "KFE (ctl-kfe-cam-03)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "KFE:IOC:CAM:TPR:03" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/tprStandalone/R1.1.6" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/kfe/tprStandalone/R1.0.2/build" )
cd( "$(IOCTOP)" )

# Set Max array size
epicsEnvSet( "EPICS_CA_MAX_ARRAY_BYTES", "20000000" )
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "KFE:CAM:TPR:03" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=KFE:CAM:TPR:03,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=KFE:CAM:TPR:03:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=KFE:CAM:TPR:03,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=KFE:IOC:CAM:TPR:03" )
dbLoadRecords( "db/iocRelease.db",			"IOC=KFE:IOC:CAM:TPR:03" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=KFE:IOC:CAM:TPR:03:SR:" )
