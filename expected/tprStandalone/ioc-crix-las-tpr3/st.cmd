...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-crix-las-tpr3" )
epicsEnvSet( "ENGINEER",     "Michael Browne" )
epicsEnvSet( "LOCATION",     "CRIX laser (ctl-las-crix-srv03)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "CRIX:IOC:LAS:TPR:03" )
...
epicsEnvSet( "TPR_PV",       "CRIX:LAS:TPR:03" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=CRIX:LAS:TPR:03,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=CRIX:LAS:TPR:03:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=CRIX:LAS:TPR:03,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=CRIX:IOC:LAS:TPR:03" )
dbLoadRecords( "db/iocRelease.db",			"IOC=CRIX:IOC:LAS:TPR:03" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=CRIX:IOC:LAS:TPR:03:SR:" )
