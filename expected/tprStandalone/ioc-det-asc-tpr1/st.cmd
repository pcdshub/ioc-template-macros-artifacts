...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-det-asc-tpr1" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "DET (daq-det-standalone)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "DET:IOC:ASC:TPR:01" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=DET:ASC:TPR:01,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=DET:ASC:TPR:01:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=DET:ASC:TPR:01,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=DET:IOC:ASC:TPR:01" )
dbLoadRecords( "db/iocRelease.db",			"IOC=DET:IOC:ASC:TPR:01" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=DET:IOC:ASC:TPR:01:SR:" )
