...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lm1k4-las-tpr4" )
epicsEnvSet( "ENGINEER",     "Michael Browne" )
epicsEnvSet( "LOCATION",     "LM1K4 laser (ctl-las-ip4-srv01)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "LM1K4:IOC:TPR:04" )
...
epicsEnvSet( "TPR_PV",       "LM1K4:TPR:04" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=LM1K4:TPR:04,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=LM1K4:TPR:04:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=LM1K4:TPR:04,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=LM1K4:IOC:TPR:04" )
dbLoadRecords( "db/iocRelease.db",			"IOC=LM1K4:IOC:TPR:04" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=LM1K4:IOC:TPR:04:SR:" )
