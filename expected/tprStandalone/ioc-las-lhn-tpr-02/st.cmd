...
epicsEnvSet( "TPR_PV",       "LAS:LHN:TPR:02" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=LAS:LHN:TPR:02,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=LAS:LHN:TPR:02:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=LAS:LHN:TPR:02,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=LAS:IOC:LHN:TPR:02" )
dbLoadRecords( "db/iocRelease.db",			"IOC=LAS:IOC:LHN:TPR:02" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=LAS:IOC:LHN:TPR:02:SR:" )
