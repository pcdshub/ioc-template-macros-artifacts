...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-tpr2" )
epicsEnvSet( "ENGINEER",     "Michael Browne" )
epicsEnvSet( "LOCATION",     "TMO (ctl-tmo-cam-02)" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TMO:IOC:CAM:TPR:02" )
...
epicsEnvSet( "TPR_PV",       "TMO:CAM:TPR:02" )
...
# TPR driver DB
dbLoadRecords("db/pcie_tprTrig.db",    "DEV=TMO:CAM:TPR:02,PORT=trig0,NAME=$(IOCNAME)")
#dbLoadRecords("db/pcie_tprTrig.db",   "DEV=TMO:CAM:TPR:02:1,LOCA=B84,IOC_UNIT=TR01,INST=1,PORT=trig1")
...
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=TIME_TEST,TSE=-1,EVNT=9")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=FIDTEST_TS1,TSE=-2,EVNT=FIDTEST_TS1")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=FIDTEST_TS2,TSE=-2,EVNT=FIDTEST_TS2")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=FIDTEST_TS3,TSE=-2,EVNT=FIDTEST_TS3")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=FIDTEST_TS4,TSE=-2,EVNT=FIDTEST_TS4")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=FIDTEST_TS5,TSE=-2,EVNT=FIDTEST_TS5")
#dbLoadRecords("db/subRec.db", "DEVICE=TMO:CAM:TPR:02,NAME=FIDTEST_TS6,TSE=-2,EVNT=FIDTEST_TS6")
...
dbLoadRecords( "db/iocSoft.db",				"IOC=TMO:IOC:CAM:TPR:02" )
dbLoadRecords( "db/iocRelease.db",			"IOC=TMO:IOC:CAM:TPR:02" )

# Setup autosave
dbLoadRecords( "db/save_restoreStatus.db",	"P=TMO:IOC:CAM:TPR:02:SR:" )
