#!/reg/g/pcds/epics/ioc/common/Leviton/R2.4.1/bin/rhel7-x86_64/Leviton

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-pwr-r02" )
epicsEnvSet( "ENGINEER",     "Will Wright (wwright8)" )
epicsEnvSet( "LOCATION",     "B950-233-R02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PWR:R02:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/Leviton/R2.4.1" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/rix/Sentry4/R2.4.1/build" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_24.db", "HOST=power-rix-r02-01,PRE=RIX:PWR:R02:01" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:R02:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-r02-01" )
...
Snmp2cWalk("power-rix-r02-01", "public", "$(FIRST_MIB_Sentry4_24)", $(MIB_CNT_Sentry4_24), 2.0)
