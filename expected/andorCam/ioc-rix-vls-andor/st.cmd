#!/reg/g/pcds/epics/ioc/common/andorCam/R1.3.0/bin/rhel7-x86_64/andorTpr

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-vls-andor" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "RIX Var. Line Grating Spec, USB to host daq-rix-andor-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "RIX:VLS:IOC:CAM:01" )
...
# Set APP
epicsEnvSet( "APP",          "andorTpr" )

epicsEnvSet( "EVR_PV",       "RIX:VLS:CAM:01:NoEvr" )
# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "RIX:ANDOR:TPR:01" )
epicsEnvSet( "TPE_PV",       "RIX:VLS:CAM:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "" )
epicsEnvSet( "CAM_PV",       "RIX:VLS:CAM:01" )
epicsEnvSet( "CAM_ID",       "30931" )
...
dbLoadDatabase( "$(IOCTOP)/dbd/andorTpr.dbd" )
andorTpr_registerRecordDeviceDriver(pdbbase)
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=RIX:VLS:CAM:01:TPE,PORT=$(TPR_PORT)")
