...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-dir-andor" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "RIX direct beam detector, USB to host daq-tmo-andor-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "RIX:DIR:IOC:CAM:01" )
...
epicsEnvSet( "EVR_PV",       "RIX:DIR:CAM:01:NoEvr" )
# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "RIX:ANDOR:TPR:01" )
epicsEnvSet( "TPE_PV",       "RIX:DIR:CAM:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "" )
epicsEnvSet( "CAM_PV",       "RIX:DIR:CAM:01" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=RIX:DIR:CAM:01:TPE,PORT=$(TPR_PORT)")
