...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-norm-andor" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "RIX norm detector, USB to host daq-rix-andor-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "RIX:NORM:IOC:CAM:01" )
...
epicsEnvSet( "EVR_PV",       "RIX:NORM:CAM:01:NoEvr" )
# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "RIX:ANDOR:TPR:01" )
epicsEnvSet( "TPE_PV",       "RIX:NORM:CAM:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "" )
epicsEnvSet( "CAM_PV",       "RIX:NORM:CAM:01" )
epicsEnvSet( "CAM_ID",       "19581" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=RIX:NORM:CAM:01:TPE,PORT=$(TPR_PORT)")
