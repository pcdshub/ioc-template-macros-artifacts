...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-andor1" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "TMO Var. Line Grating Spec, USB to host daq-tmo-andor-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "TMO:VLS:IOC:CAM:01" )
...
epicsEnvSet( "EVR_PV",       "TMO:VLS:CAM:01:NoEvr" )
# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "TMO:ANDOR:TPR:01" )
epicsEnvSet( "TPE_PV",       "TMO:VLS:CAM:01:TPE" )
...
epicsEnvSet( "CAM_IP",       "" )
epicsEnvSet( "CAM_PV",       "TMO:VLS:CAM:01" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=TMO:VLS:CAM:01:TPE,PORT=$(TPR_PORT)")
