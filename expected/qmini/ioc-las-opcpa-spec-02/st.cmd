#!/cds/group/pcds/epics/ioc/common/qmini/R1.0.3/bin/rhel7-x86_64/qmini

< envPaths

epicsEnvSet( "ENGINEER" , "tjohnson" )
epicsEnvSet( "IOCSH_PS1", "ioc-las-opcpa-spec-02>" )
epicsEnvSet( "IOCENAME", "IOC:LAS:OPCPA:SPEC:02" )
epicsEnvSet( "IOCPVROOT", "IOC:LAS:OPCPA:QMINI:02")
epicsEnvSet( "LOCATION",  "NEH Laser Hall Bay 2")
epicsEnvSet( "BASE_NAME", "LAS:OPCPA:QMINI:02"     )
...
epicsEnvSet( "SERIAL", "20424" )

# Set APP
epicsEnvSet( "APP",			 "qmini" )

epicsEnvSet( "EVR_PV",       "LAS:OPCPA:QMINI:02:NoEvr" )
# Setup EVR Vars
...
dbLoadRecords( "db/adjust.db",              	"P=$(BASE_NAME),STAGE=LAS:OPCPA:MCS2:02:m3" )
