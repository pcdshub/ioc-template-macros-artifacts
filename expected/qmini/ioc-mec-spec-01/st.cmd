...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-spec-01>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:SPEC:01" )
epicsEnvSet( "IOCPVROOT", "IOC:MEC:LAS_SPL_SP1")
epicsEnvSet( "LOCATION",  "MEC SPL Enclosure Compressor")
epicsEnvSet( "BASE_NAME", "MEC:LAS_SPL_SP1"     )
...
epicsEnvSet( "SERIAL", "20606" )

# Setup EVR Vars
epicsEnvSet( "EVR_PV",       "MEC:LAS_SPL_SP1:NoEvr" )
