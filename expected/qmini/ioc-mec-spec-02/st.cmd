...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-spec-02>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:SPEC:02" )
epicsEnvSet( "IOCPVROOT", "IOC:MEC:LAS_SPL_SP2")
epicsEnvSet( "LOCATION",  "MEC SPL Enclosure Vitara")
epicsEnvSet( "BASE_NAME", "MEC:LAS_SPL_VIT_SP1"     )
...
epicsEnvSet( "SERIAL", "20605" )

# Setup EVR Vars
epicsEnvSet( "EVR_PV",       "MEC:LAS_SPL_VIT_SP1:NoEvr" )
