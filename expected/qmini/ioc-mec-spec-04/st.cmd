...
epicsEnvSet( "IOCSH_PS1", "ioc-mec-spec-04>" )
epicsEnvSet( "IOCENAME", "IOC:MEC:SPEC:04" )
epicsEnvSet( "IOCPVROOT", "IOC:MEC:LAS_SPL_SP4")
epicsEnvSet( "LOCATION",  "MEC SPL Enclosure")
epicsEnvSet( "BASE_NAME", "MEC:LAS_SPL_FLT_SP1"     )
...
epicsEnvSet( "SERIAL", "21297" )

# Setup EVR Vars
epicsEnvSet( "EVR_PV",       "MEC:LAS_SPL_FLT_SP1:NoEvr" )
