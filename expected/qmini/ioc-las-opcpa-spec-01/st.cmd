#!/cds/group/pcds/epics/ioc/common/qmini/R1.0.2/bin/rhel7-x86_64/qmini

< envPaths

epicsEnvSet( "ENGINEER" , "tjohnson" )
epicsEnvSet( "IOCSH_PS1", "ioc-las-opcpa-spec-01>" )
epicsEnvSet( "IOCENAME", "IOC:LAS:OPCPA:SPEC:01" )
epicsEnvSet( "IOCPVROOT", "IOC:LAS:OPCPA:QMINI:01")
epicsEnvSet( "LOCATION",  "NEH Laser Lab")
epicsEnvSet( "BASE_NAME", "LAS:OPCPA:QMINI:01"     )
epicsEnvSet( "IOCTOP",    "/cds/group/pcds/epics/ioc/common/qmini/R1.0.2"   )
...
epicsEnvSet( "SERIAL", "21292" )

# Set APP
epicsEnvSet( "APP",			 "qmini" )

epicsEnvSet( "EVR_PV",       "LAS:OPCPA:QMINI:01:NoEvr" )
# Setup EVR Vars
...
dbLoadRecords( "db/qmini.db", "P=$(BASE_NAME),PORT=$(USBPORT),DEFAULT_EC=$(DEFAULT_EC),TIMING_MODE=$(TIMING_MODE),STAGE_CNTL=1" )

dbLoadRecords( "db/adjust.db",              	"P=$(BASE_NAME),STAGE=LAS:OPCPA:MCS2:01:m3" )
