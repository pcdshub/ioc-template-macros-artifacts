...
epicsEnvSet( "IOCSH_PS1", "ioc-cxi-spec-01>" )
epicsEnvSet( "IOCENAME", "IOC:CXI:SPEC:01" )
epicsEnvSet( "IOCPVROOT", "IOC:CXI:LAS:SPL:SP1")
epicsEnvSet( "LOCATION",  "CXI Laser Table")
epicsEnvSet( "BASE_NAME", "CXI:LAS:SPL:SP1"     )
...
epicsEnvSet( "SERIAL", "21343" )

# Set APP
epicsEnvSet( "APP",			 "qmini" )

epicsEnvSet( "EVR_PV",       "CXI:LAS:SPL:SP1:NoEvr" )
# Setup EVR Vars
