...
epicsEnvSet( "IOCSH_PS1", "ioc-kfe-k4-vac-support>" )
...
drvAsynIPPortConfigure("B940:009:R20:GCT:01", "ser-tmo-01:4001 TCP", 0, 0, 0 )
...
dbLoadRecords( "db/vac_mks937b_serial_cc.template", "device=EM1K0:GMD:GCC:10,port=B940:009:R20:GCT:01,channel=1,addr=253,fastEvt=1,medEvt=2,slowEvt=3,setpointA=$(MKS937B_cc_setA_ch1),setpointB=$(MKS937B_cc_setB_ch1),setpointC=$(MKS937B_cc_setC_ch1),setpointD=$(MKS937B_cc_setD_ch1)" )
