...
epicsEnvSet( "IOCSH_PS1", "ioc-kfe-k2-vac-support>" )
...
drvAsynIPPortConfigure("B940:009:R09:PCI:05", "pci-kfe-vac-05:23 TCP", 0, 0, 0 )
#asynSetTraceMask( "B940:009:R09:PCI:05", 0, 0x19) # log everything
#asynSetTraceIOMask( "B940:009:R09:PCI:05", 0, 1)  # Escape the strings.
dbLoadRecords( "db/asynRecord.db","P=B940:009:R09:PCI:05,R=,PORT=B940:009:R09:PCI:05,ADDR=0,OMAX=0,IMAX=0")
...
dbLoadRecords( "db/qpc.db", "BASE=B940:009:R09:PCI:05,PORT=B940:009:R09:PCI:05" )
dbLoadRecords( "db/qpc_ch.db", "BASE=PC1K1:ZOS:PIP:01,PORT=B940:009:R09:PCI:05,CONTROLLER=B940:009:R09:PCI:05,CHANNEL=1,TTLCHAN=5" )
dbLoadRecords( "db/qpc_ch.db", "BASE=PC1K1:ZOS:PIP:02,PORT=B940:009:R09:PCI:05,CONTROLLER=B940:009:R09:PCI:05,CHANNEL=2,TTLCHAN=6" )
dbLoadRecords( "db/qpc_ch.db", "BASE=MR1K2:SWITCH:PIP:01,PORT=B940:009:R09:PCI:05,CONTROLLER=B940:009:R09:PCI:05,CHANNEL=3,TTLCHAN=7" )
dbLoadRecords( "db/qpc_ch.db", "BASE=TV1K1:PLEG:PIP:01,PORT=B940:009:R09:PCI:05,CONTROLLER=B940:009:R09:PCI:05,CHANNEL=4,TTLCHAN=8" )
