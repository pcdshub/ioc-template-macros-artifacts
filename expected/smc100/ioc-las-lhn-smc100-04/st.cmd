...
epicsEnvSet( "EPICS_NAME", "IOC:LAS:LHN:SMC100:04" )
epicsEnvSet( "LOCATION",   "LAS:FS14:VIT"  )
epicsEnvSet( "IOCSH_PS1",  "ioc-las-lhn-smc100-04> " )
...
dbLoadRecords( "db/save_restoreStatus.db",      "IOC=$(EPICS_NAME),P=LAS:FS14:MMN:FQ" )

# Load EPICS records for motor
dbLoadRecords( "db/smc100.db","P=LAS:FS14:MMN:FQ,M=,PORT=SMC100_1,ADDR=0,DESC=LHN FS14 Vitara Freq Ctrl,EGU=mm,DIR=Neg,VELO=0.16,VBAS=0,ACCL=0.1,BDST=0,BVEL=0.04,BACC=0.2,MRES=0.0000977,PREC=5,DHLM=25,DLLM=-25,INIT=,RTRY=10,FW_MEANS=+,REV_MEANS=-" )

# Open serial communication with motor
drvAsynIPPortConfigure("M1", "moxa-las-02:4003 TCP", 0, 0, 0)
...
set_savefile_path    ( "$(IOC_DATA)/ioc-las-lhn-smc100-04/autosave" )

set_pass0_restoreFile( "ioc-las-lhn-smc100-04.sav"                  )
...
create_monitor_set( "ioc-las-lhn-smc100-04.req", 30, "" );
