...
epicsEnvSet( "EPICS_NAME", "IOC:LAS:XCS:SMC100:01" )
epicsEnvSet( "LOCATION",   "LAS:FS4:VIT"  )
epicsEnvSet( "IOCSH_PS1",  "ioc-las-xcs-smc100-01> " )
...
dbLoadRecords( "db/save_restoreStatus.db",      "IOC=$(EPICS_NAME),P=LAS:FS4:MMN:FQ" )

# Load EPICS records for motor
dbLoadRecords( "db/smc100.db","P=LAS:FS4:MMN:FQ,M=,PORT=SMC100_1,ADDR=0,DESC=XCS FS4 Vitara Freq Ctrl,EGU=mm,DIR=Neg,VELO=0.16,VBAS=0,ACCL=0.1,BDST=0,BVEL=0.04,BACC=0.2,MRES=0.0000977,PREC=5,DHLM=25,DLLM=-25,INIT=,RTRY=10,FW_MEANS=+,REV_MEANS=-" )

# Open serial communication with motor
drvAsynIPPortConfigure("M1", "moxa-fs4-01:4006 TCP", 0, 0, 0)
...
set_savefile_path    ( "$(IOC_DATA)/ioc-las-xcs-smc100-01/autosave" )

set_pass0_restoreFile( "ioc-las-xcs-smc100-01.sav"                  )
...
create_monitor_set( "ioc-las-xcs-smc100-01.req", 30, "" );
