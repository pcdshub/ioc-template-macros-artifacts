...
epicsEnvSet("IOCNAME", "ioc-lm1k4-qadc134-01" )
epicsEnvSet("ENGINEER", "tjohnson" )
epicsEnvSet("LOCATION", "IP1 MODS" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:LM1K4:QADC:01")
...
dbLoadRecords("db/qadc134.db", "BASE=LM1K4:QADC:01,DEV=QADC0,MODE=1")
dbLoadRecords("db/qadc134_lcls2.db", "BASE=LM1K4:QADC:01,DEV=QADC0")
...
dbpf LM1K4:QADC:01:CONFIG 1
dbpf LM1K4:QADC:01:START 1
