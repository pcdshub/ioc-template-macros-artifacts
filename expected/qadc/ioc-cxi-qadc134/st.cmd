...
epicsEnvSet("IOCNAME", "ioc-cxi-qadc134" )
epicsEnvSet("ENGINEER", "Michael Browne (mcbrowne)" )
epicsEnvSet("LOCATION", "unknown" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:CXI:QADC:02")
...
dbLoadRecords("db/qadc134.db", "BASE=CXI:QADC:02,DEV=QADC0,MODE=0")
dbLoadRecords("db/qadc134_lcls1.db", "BASE=CXI:QADC:02,DEV=QADC0")
...
dbpf CXI:QADC:02:CONFIG 1
dbpf CXI:QADC:02:START 1
