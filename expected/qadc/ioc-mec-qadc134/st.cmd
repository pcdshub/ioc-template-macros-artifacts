...
epicsEnvSet("IOCNAME", "ioc-mec-qadc134" )
epicsEnvSet("ENGINEER", "Michael Browne (mcbrowne)" )
epicsEnvSet("LOCATION", "unknown" )
epicsEnvSet("IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet("IOC_PV", "IOC:MEC:QADC:01")
...
dbLoadRecords("db/qadc134.db", "BASE=MEC:QADC:01,DEV=QADC0,MODE=0")
dbLoadRecords("db/qadc134_lcls1.db", "BASE=MEC:QADC:01,DEV=QADC0")
...
dbpf MEC:QADC:01:CONFIG 1
dbpf MEC:QADC:01:START 1
