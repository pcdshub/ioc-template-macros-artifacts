...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-xcs-gon,PRE=XCS:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=XCS:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-xcs-gon" )
