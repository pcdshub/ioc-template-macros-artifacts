...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-pwr-pr09" )
epicsEnvSet( "ENGINEER",     "Kaushik Malapati (kaushikm)" )
epicsEnvSet( "LOCATION",     "TMO:PR09" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:PWR:PR09" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_8.db", "HOST=power-tmo-pr09,PRE=TMO:PWR:PR09" )

epicsEnvSet( "DEV_INFO", "DEV=TMO:PWR:PR09,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-tmo-pr09" )
...
Snmp2cWalk("power-tmo-pr09", "public", "$(FIRST_MIB_Sentry4_8)", $(MIB_CNT_Sentry4_8), 2.0)
