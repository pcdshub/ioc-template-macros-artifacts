...
# Load pdu instances
dbLoadRecords( "db/LevitonPdu_8.db", "HOST=power-xcs-r42-06,PRE=XCS:R42:PWR:06" )

epicsEnvSet( "DEV_INFO", "DEV=XCS:R42:PWR:06,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-xcs-r42-06" )
