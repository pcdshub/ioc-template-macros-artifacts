...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lhn-pwr-01" )
epicsEnvSet( "ENGINEER",     "Christina Pino (cpino)" )
epicsEnvSet( "LOCATION",     "LHN Timing PDU Bay 1" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:PWR:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_24.db", "HOST=pac-las-lhn-01,PRE=LAS:LHN:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:LHN:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=pac-las-lhn-01" )
