...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-rix-misc-02,PRE=RIX:PWR:MISC:02" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:MISC:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-misc-02" )
