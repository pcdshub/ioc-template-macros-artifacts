...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-xcs-pwr-01" )
epicsEnvSet( "ENGINEER",     "Christina Pino (cpino)" )
epicsEnvSet( "LOCATION",     "XCS Timing PDU" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:XCS:PWR:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-las-fs4-01,PRE=LAS:XCS:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:XCS:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-las-fs4-01" )
