...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lhn-pwr-04" )
epicsEnvSet( "ENGINEER",     "Christina Pino (cpino)" )
epicsEnvSet( "LOCATION",     "LHN Timing PDU Bay 4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:PWR:04" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_24.db", "HOST=pac-las-lhn-04,PRE=LAS:LHN:PWR:04" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:LHN:PWR:04,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=pac-las-lhn-04" )
