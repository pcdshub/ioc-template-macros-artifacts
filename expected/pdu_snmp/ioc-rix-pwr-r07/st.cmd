...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-pwr-r07" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "RIX:R07" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PWR:R07" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_24.db", "HOST=power-rix-r07-01,PRE=RIX:PWR:R07" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:R07,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-r07-01" )
...
Snmp2cWalk("power-rix-r07-01", "public", "$(FIRST_MIB_Sentry4_24)", $(MIB_CNT_Sentry4_24), 2.0)
