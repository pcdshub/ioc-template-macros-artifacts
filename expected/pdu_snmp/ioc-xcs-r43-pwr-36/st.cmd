...
# Load pdu instances
dbLoadRecords( "db/LevitonPdu_8.db", "HOST=XCS-R43-PWR-36,PRE=XCS:R43:PWR:36" )

epicsEnvSet( "DEV_INFO", "DEV=XCS:R43:PWR:36,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=XCS-R43-PWR-36" )
