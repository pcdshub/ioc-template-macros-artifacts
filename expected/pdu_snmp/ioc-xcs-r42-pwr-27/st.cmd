...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-xcs-r42-pwr-27" )
epicsEnvSet( "ENGINEER",     "Rehan Nazir  (rnazir)" )
epicsEnvSet( "LOCATION",     "XCS:IOC:LEV" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:XCS:R42:PWR:27" )
...
# Load pdu instances
dbLoadRecords( "db/LevitonPdu_8.db", "HOST=power-xcs-r42-27,PRE=XCS:R42:PWR:27" )

epicsEnvSet( "DEV_INFO", "DEV=XCS:R42:PWR:27,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-xcs-r42-27" )
