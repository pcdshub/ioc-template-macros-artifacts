...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-pwr-r06" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "RIX:R06" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PWR:06:01" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_24.db", "HOST=power-rix-06-01,PRE=RIX:PWR:06:01" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:06:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-06-01" )
...
Snmp2cWalk("power-rix-06-01", "public", "$(FIRST_MIB_Sentry4_24)", $(MIB_CNT_Sentry4_24), 2.0)
