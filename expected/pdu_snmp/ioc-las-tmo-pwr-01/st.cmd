...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-tmo-pwr-01" )
epicsEnvSet( "ENGINEER",     "Adam Berges (aberges)" )
epicsEnvSet( "LOCATION",     "B950-100H1-R01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:TMO:PWR:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_24.db", "HOST=pac-las-tmo-r01,PRE=LAS:TMO:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:TMO:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=pac-las-tmo-r01" )
