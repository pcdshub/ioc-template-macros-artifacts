...
# Load pdu instances
dbLoadRecords( "db/LevitonPdu_8.db", "HOST=XCS-LAM-PWR-02,PRE=XCS:LAM:PWR:02" )

epicsEnvSet( "DEV_INFO", "DEV=XCS:LAM:PWR:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=XCS-LAM-PWR-02" )
