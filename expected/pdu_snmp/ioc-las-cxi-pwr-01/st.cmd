...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-cxi-pwr-01" )
epicsEnvSet( "ENGINEER",     "Christina Pino (cpino)" )
epicsEnvSet( "LOCATION",     "CXI Timing PDU" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:CXI:PWR:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-las-fs5-01,PRE=LAS:CXI:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:CXI:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-las-fs5-01" )
