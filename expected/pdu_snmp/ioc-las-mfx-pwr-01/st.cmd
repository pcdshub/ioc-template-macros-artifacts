...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-mfx-pwr-01" )
epicsEnvSet( "ENGINEER",     "Christina Pino (cpino)" )
epicsEnvSet( "LOCATION",     "MFX Timing PDU" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:MFX:PWR:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-las-fs45-01,PRE=LAS:MFX:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:MFX:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-las-fs45-01" )
