...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-pwr-r02" )
epicsEnvSet( "ENGINEER",     "jozamudi (Josue Zamudio)" )
epicsEnvSet( "LOCATION",     "TMO_R02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:PWR:R02" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_8.db", "HOST=power-tmo-r02,PRE=TMO:PWR:R02:01" )

epicsEnvSet( "DEV_INFO", "DEV=TMO:PWR:R02:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-tmo-r02" )
...
Snmp2cWalk("power-tmo-r02", "public", "$(FIRST_MIB_Sentry4_8)", $(MIB_CNT_Sentry4_8), 2.0)
