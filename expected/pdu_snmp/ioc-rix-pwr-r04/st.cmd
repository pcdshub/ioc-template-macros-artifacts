#!/reg/g/pcds/epics/ioc/common/pdu_snmp/R2.4.5/bin/rhel7-x86_64/pdu

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-pwr-r04" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "B940-009-R04" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PWR:R04:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/pdu_snmp/R2.4.5" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/rix/pdu_snmp/R1.2.0/build" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_24.db", "HOST=power-rix-r04-01,PRE=RIX:PWR:R04:01" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:R04:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-r04-01" )
...
Snmp2cWalk("power-rix-r04-01", "public", "$(FIRST_MIB_Sentry4_24)", $(MIB_CNT_Sentry4_24), 2.0)
