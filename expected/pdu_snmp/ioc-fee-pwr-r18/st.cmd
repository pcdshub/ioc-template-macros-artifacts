...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-fee-pwr-r18" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "FEE:ALCOVE:R18" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:FEE:PWR:R18" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_24.db", "HOST=power-fee-r18-01,PRE=FEE:PWR:R18:01" )

epicsEnvSet( "DEV_INFO", "DEV=FEE:PWR:R18:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-fee-r18-01" )
...
Snmp2cWalk("power-fee-r18-01", "public", "$(FIRST_MIB_Sentry4_24)", $(MIB_CNT_Sentry4_24), 2.0)
