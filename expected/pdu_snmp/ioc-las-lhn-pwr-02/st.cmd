...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-lhn-pwr-02" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "LHN Timing PDU Bay 2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:LHN:PWR:02" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_24.db", "HOST=pac-las-lhn-02,PRE=LAS:LHN:PWR:02" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:LHN:PWR:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=pac-las-lhn-02" )
