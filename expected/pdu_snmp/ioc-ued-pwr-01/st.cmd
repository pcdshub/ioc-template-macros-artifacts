...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-ued-pwr-01" )
epicsEnvSet( "ENGINEER",     "Christian Tsoi-A-Sue (ctsoi)" )
epicsEnvSet( "LOCATION",     "UED:SUED" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:UED:PWR:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/pdu_snmp/R2.4.6" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/ued/pdu_snmp/v1.0.0/build" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-ued-01,PRE=UED:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=UED:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-ued-01" )
