...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-pwr-wall-s-r05-01" )
epicsEnvSet( "ENGINEER",     "Patrick Oppermann (opperman)" )
epicsEnvSet( "LOCATION",     "B950-233-R02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:PWR:WALL:S:R05:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-rix-wall-s-r05-01,PRE=RIX:PWR:WALL:S:R05:01" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:WALL:S:R05:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-wall-s-r05-01" )
