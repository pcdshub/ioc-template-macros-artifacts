...
# Load pdu instances
dbLoadRecords( "db/LevitonPdu_8.db", "HOST=XCS-R44-PWR-18,PRE=XCS:R44:PWR:18" )

epicsEnvSet( "DEV_INFO", "DEV=XCS:R44:PWR:18,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=XCS-R44-PWR-18" )
