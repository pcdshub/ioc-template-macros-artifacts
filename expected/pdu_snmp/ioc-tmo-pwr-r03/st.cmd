...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-pwr-r03" )
epicsEnvSet( "ENGINEER",     "Johnny Armenta (armenta1)" )
epicsEnvSet( "LOCATION",     "TMO:R03" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:PWR:R03" )
...
# Load pdu instances
dbLoadRecords( "db/Sentry4Pdu_24.db", "HOST=power-tmo-r03-01,PRE=TMO:PWR:R03:01" )

epicsEnvSet( "DEV_INFO", "DEV=TMO:PWR:R03:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-tmo-r03-01" )
...
Snmp2cWalk("power-tmo-r03-01", "public", "$(FIRST_MIB_Sentry4_24)", $(MIB_CNT_Sentry4_24), 2.0)
