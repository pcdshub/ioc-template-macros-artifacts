...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-rix-misc-01,PRE=RIX:PWR:MISC:01" )

epicsEnvSet( "DEV_INFO", "DEV=RIX:PWR:MISC:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-rix-misc-01" )
