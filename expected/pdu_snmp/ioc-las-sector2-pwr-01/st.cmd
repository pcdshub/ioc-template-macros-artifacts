#!/cds/group/pcds/epics/ioc/common/pdu_snmp/R2.4.4/bin/rhel7-x86_64/pdu

# Run common startup commands for linux soft IOC's
< $(IOC_COMMON)/All/pre_linux.cmd

< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-sector2-pwr-01" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "Sector2 Timing PDU" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:S2:PWR:01" )
epicsEnvSet( "IOCTOP",       "/cds/group/pcds/epics/ioc/common/pdu_snmp/R2.4.4" )
...
# Load pdu instances
dbLoadRecords( "db/SentryPdu_8.db", "HOST=power-las-sector2-01,PRE=LAS:S2:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:S2:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-las-sector2-01" )
