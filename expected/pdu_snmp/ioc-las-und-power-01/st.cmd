...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-und-power-01" )
epicsEnvSet( "ENGINEER",     "tjohnson" )
epicsEnvSet( "LOCATION",     "Undulator Hall R920-R02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LAS:UND:PWR:01" )
...
# Load pdu instances
dbLoadRecords( "db/TrippLitePdu_8.db", "HOST=power-las-und-01,PRE=LAS:UND:PWR:01" )

epicsEnvSet( "DEV_INFO", "DEV=LAS:UND:PWR:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=power-las-und-01" )
