...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-plv-pdu-01" )
epicsEnvSet( "ENGINEER",     "Josue Zamudio (jozamudi)" )
epicsEnvSet( "LOCATION",     "B950-233-WALL-S-R02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:QRIX:ICT:01" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-qrix-pdu-01,PRE=QRIX:PDU:ICT:01" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-qrix-pdu-01,PRE=QRIX:PDU:ICT:01" )
dbLoadRecords( "db/ict24VbusB.db", "HOST=plv-qrix-pdu-01,PRE=QRIX:PDU:ICT:01" )
epicsEnvSet( "DEV_INFO", "DEV=QRIX:PDU:ICT:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-qrix-pdu-01" )
...
Snmp2cWalk("plv-qrix-pdu-01", "write", "ICT-MIB::deviceModel", 95, 2.0)
