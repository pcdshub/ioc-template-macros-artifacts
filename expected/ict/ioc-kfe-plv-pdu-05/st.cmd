...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-plv-pdu-05" )
epicsEnvSet( "ENGINEER",     "sfsyunus" )
epicsEnvSet( "LOCATION",     "B950" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:KFE:ICT:05" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/ict/R1.0.7" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/kfe/ict/R1.0.7/build" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-kfe-pdu-05,PRE=PDU:KFE:ICT:05" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-kfe-pdu-05,PRE=PDU:KFE:ICT:05" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-kfe-pdu-05,PRE=PDU:KFE:ICT:05" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:KFE:ICT:05,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-kfe-pdu-05" )
...
Snmp2cWalk("plv-kfe-pdu-05", "write", "ICT-MIB::deviceModel", 95, 2.0)
