...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-plv-pdu-05" )
epicsEnvSet( "ENGINEER",     "nwbrown" )
epicsEnvSet( "LOCATION",     "B950-100H1-R03-ICT-4" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:ICT:05" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-tmo-pdu-05,PRE=PDU:TMO:ICT:05" )
dbLoadRecords( "db/ict48VbusA.db", "HOST=plv-tmo-pdu-05,PRE=PDU:TMO:ICT:05" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-tmo-pdu-05,PRE=PDU:TMO:ICT:05" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:TMO:ICT:05,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-tmo-pdu-05" )
...
Snmp2cWalk("plv-tmo-pdu-05", "write", "ICT-MIB::deviceModel", 95, 2.0)
