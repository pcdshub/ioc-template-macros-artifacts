...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-cvmi-plv-pdu-01" )
epicsEnvSet( "ENGINEER",     "nwbrown" )
epicsEnvSet( "LOCATION",     "B940-100H1-PR03-ICT-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:CVMI:ICT:01" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/ict/R1.0.7" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/tmo/dc_power/ict/R1.0.0/build" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-tmo-cvmi-pdu-01,PRE=PDU:TMO:CVMI:ICT:01" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-tmo-cvmi-pdu-01,PRE=PDU:TMO:CVMI:ICT:01" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-tmo-cvmi-pdu-01,PRE=PDU:TMO:CVMI:ICT:01" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:TMO:CVMI:ICT:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-tmo-cvmi-pdu-01" )
...
Snmp2cWalk("plv-tmo-cvmi-pdu-01", "write", "ICT-MIB::deviceModel", 95, 2.0)
