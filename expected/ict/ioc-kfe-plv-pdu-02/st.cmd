...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-plv-pdu-02" )
epicsEnvSet( "ENGINEER",     "sfsyunus" )
epicsEnvSet( "LOCATION",     "B950" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:KFE:ICT:02" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-kfe-pdu-02,PRE=PDU:KFE:ICT:02" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-kfe-pdu-02,PRE=PDU:KFE:ICT:02" )
dbLoadRecords( "db/ict24VbusB.db", "HOST=plv-kfe-pdu-02,PRE=PDU:KFE:ICT:02" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:KFE:ICT:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-kfe-pdu-02" )
...
Snmp2cWalk("plv-kfe-pdu-02", "write", "ICT-MIB::deviceModel", 95, 2.0)
