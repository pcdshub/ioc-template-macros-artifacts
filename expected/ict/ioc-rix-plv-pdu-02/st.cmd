...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-plv-pdu-02" )
epicsEnvSet( "ENGINEER",     ""Josue Zamudio (jozamudi)" )
epicsEnvSet( "LOCATION",     "B950-233-R02-ICT-02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:ICT:02" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-rix-pdu-02,PRE=RIX:PDU:ICT:02" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-rix-pdu-02,PRE=RIX:PDU:ICT:02" )
dbLoadRecords( "db/ict24VbusB.db", "HOST=plv-rix-pdu-02,PRE=RIX:PDU:ICT:02" )
epicsEnvSet( "DEV_INFO", "DEV=RIX:PDU:ICT:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-rix-pdu-02" )
...
Snmp2cWalk("plv-rix-pdu-02", "write", "ICT-MIB::deviceModel", 95, 2.0)
