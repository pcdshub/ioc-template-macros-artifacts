...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-crix-plv-pdu-01" )
epicsEnvSet( "ENGINEER",     "Josue Zamudio (jozamudi)" )
epicsEnvSet( "LOCATION",     "B950-233-R04-ICT-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CRIX:ICT:01" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-crix-pdu-01,PRE=CRIX:PDU:ICT:01" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-crix-pdu-01,PRE=CRIX:PDU:ICT:01" )
dbLoadRecords( "db/ict24VbusB.db", "HOST=plv-crix-pdu-01,PRE=CRIX:PDU:ICT:01" )
epicsEnvSet( "DEV_INFO", "DEV=CRIX:PDU:ICT:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-crix-pdu-01" )
...
Snmp2cWalk("plv-crix-pdu-01", "write", "ICT-MIB::deviceModel", 95, 2.0)
