...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-lamp-plv-pdu-01" )
epicsEnvSet( "ENGINEER",     "nwbrown" )
epicsEnvSet( "LOCATION",     "B940-100H1-PR01-ICT-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:LAMP:ICT:01" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-tmo-lamp-pdu-01,PRE=PDU:TMO:LAMP:ICT:01" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-tmo-lamp-pdu-01,PRE=PDU:TMO:LAMP:ICT:01" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-tmo-lamp-pdu-01,PRE=PDU:TMO:LAMP:ICT:01" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:TMO:LAMP:ICT:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-tmo-lamp-pdu-01" )
...
Snmp2cWalk("plv-tmo-lamp-pdu-01", "write", "ICT-MIB::deviceModel", 95, 2.0)
