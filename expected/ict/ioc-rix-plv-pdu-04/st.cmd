...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-rix-plv-pdu-04" )
epicsEnvSet( "ENGINEER",     "Josue Zamudio (jozamudi)" )
epicsEnvSet( "LOCATION",     "B950-233-R02-ICT-04" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:RIX:ICT:04" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-rix-pdu-04,PRE=RIX:PDU:ICT:04" )
dbLoadRecords( "db/ict48VbusA.db", "HOST=plv-rix-pdu-04,PRE=RIX:PDU:ICT:04" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-rix-pdu-04,PRE=RIX:PDU:ICT:04" )
epicsEnvSet( "DEV_INFO", "DEV=RIX:PDU:ICT:04,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-rix-pdu-04" )
...
Snmp2cWalk("plv-rix-pdu-04", "write", "ICT-MIB::deviceModel", 95, 2.0)
