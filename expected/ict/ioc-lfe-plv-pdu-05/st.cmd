...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-lfe-plv-pdu-05" )
epicsEnvSet( "ENGINEER",     "sfsyunus" )
epicsEnvSet( "LOCATION",     "B950" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LFE:ICT:05" )
epicsEnvSet( "IOCTOP",       "/reg/g/pcds/epics/ioc/common/ict/R1.0.7" )
epicsEnvSet( "BUILD_TOP",    "/reg/g/pcds/epics/ioc/lfe/ict/R1.0.7/build" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-lfe-pdu-05,PRE=PDU:LFE:ICT:05" )
dbLoadRecords( "db/ict48VbusA.db", "HOST=plv-lfe-pdu-05,PRE=PDU:LFE:ICT:05" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-lfe-pdu-05,PRE=PDU:LFE:ICT:05" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:LFE:ICT:05,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-lfe-pdu-05" )
...
Snmp2cWalk("plv-lfe-pdu-05", "write", "ICT-MIB::deviceModel", 95, 2.0)
