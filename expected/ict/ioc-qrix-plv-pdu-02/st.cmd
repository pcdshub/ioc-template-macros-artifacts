...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-qrix-pdu-02,PRE=QRIX:PDU:ICT:02" )
dbLoadRecords( "db/ict48VbusA.db", "HOST=plv-qrix-pdu-02,PRE=QRIX:PDU:ICT:02" )
dbLoadRecords( "db/ict24VbusB.db", "HOST=plv-qrix-pdu-02,PRE=QRIX:PDU:ICT:02" )
epicsEnvSet( "DEV_INFO", "DEV=QRIX:PDU:ICT:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-qrix-pdu-02" )
...
Snmp2cWalk("plv-qrix-pdu-02", "write", "ICT-MIB::deviceModel", 95, 2.0)
