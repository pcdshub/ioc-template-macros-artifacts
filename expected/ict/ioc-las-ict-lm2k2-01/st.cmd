...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-las-ict-lm2k2-01" )
epicsEnvSet( "ENGINEER",     "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",     "B950-233-R04-E29" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:LM2K2:ICT:01" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-las-lm2k2-pdu-01,PRE=LAS:LM2K2:PDU:ICT:01" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-las-lm2k2-pdu-01,PRE=LAS:LM2K2:PDU:ICT:01" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-las-lm2k2-pdu-01,PRE=LAS:LM2K2:PDU:ICT:01" )
epicsEnvSet( "DEV_INFO", "DEV=LAS:LM2K2:PDU:ICT:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-las-lm2k2-pdu-01" )
...
Snmp2cWalk("plv-las-lm2k2-pdu-01", "write", "ICT-MIB::deviceModel", 95, 2.0)
