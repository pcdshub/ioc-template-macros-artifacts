...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-kfe-plv-pdu-06" )
epicsEnvSet( "ENGINEER",     "sfsyunus" )
epicsEnvSet( "LOCATION",     "B950" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:KFE:ICT:06" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-kfe-pdu-06,PRE=PDU:KFE:ICT:06" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-kfe-pdu-06,PRE=PDU:KFE:ICT:06" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-kfe-pdu-06,PRE=PDU:KFE:ICT:06" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:KFE:ICT:06,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-kfe-pdu-06" )
...
Snmp2cWalk("plv-kfe-pdu-06", "write", "ICT-MIB::deviceModel", 95, 2.0)
