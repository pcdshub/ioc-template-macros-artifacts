...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-mrco-plv-pdu-01" )
epicsEnvSet( "ENGINEER",     "nwbrown" )
epicsEnvSet( "LOCATION",     "B940-100H1-PR09-ICT-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:MRCO:ICT:01" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-tmo-mrco-pdu-01,PRE=PDU:TMO:MRCO:ICT:01" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-tmo-mrco-pdu-01,PRE=PDU:TMO:MRCO:ICT:01" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-tmo-mrco-pdu-01,PRE=PDU:TMO:MRCO:ICT:01" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:TMO:MRCO:ICT:01,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-tmo-mrco-pdu-01" )
...
Snmp2cWalk("plv-tmo-mrco-pdu-01", "write", "ICT-MIB::deviceModel", 95, 2.0)
