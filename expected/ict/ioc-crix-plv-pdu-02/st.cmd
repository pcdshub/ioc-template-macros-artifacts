...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-crix-plv-pdu-02" )
epicsEnvSet( "ENGINEER",     "Josue Zamudio (jozamudi)" )
epicsEnvSet( "LOCATION",     "B950-233-R04-ICT-02" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:CRIX:ICT:02" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-crix-pdu-02,PRE=CRIX:PDU:ICT:02" )
dbLoadRecords( "db/ict48VbusA.db", "HOST=plv-crix-pdu-02,PRE=CRIX:PDU:ICT:02" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-crix-pdu-02,PRE=CRIX:PDU:ICT:02" )
epicsEnvSet( "DEV_INFO", "DEV=CRIX:PDU:ICT:02,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-crix-pdu-02" )
...
Snmp2cWalk("plv-crix-pdu-02", "write", "ICT-MIB::deviceModel", 95, 2.0)
