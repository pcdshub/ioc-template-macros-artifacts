...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-plv-pdu-03" )
epicsEnvSet( "ENGINEER",     "nwbrown" )
epicsEnvSet( "LOCATION",     "B950-100H1-R03-ICT-2" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:ICT:03" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-tmo-pdu-03,PRE=PDU:TMO:ICT:03" )
dbLoadRecords( "db/ict24VbusA.db", "HOST=plv-tmo-pdu-03,PRE=PDU:TMO:ICT:03" )
dbLoadRecords( "db/ict24VbusB.db", "HOST=plv-tmo-pdu-03,PRE=PDU:TMO:ICT:03" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:TMO:ICT:03,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-tmo-pdu-03" )
...
Snmp2cWalk("plv-tmo-pdu-03", "write", "ICT-MIB::deviceModel", 95, 2.0)
