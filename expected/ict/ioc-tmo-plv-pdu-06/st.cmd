...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-tmo-plv-pdu-06" )
epicsEnvSet( "ENGINEER",     "nwbrown" )
epicsEnvSet( "LOCATION",     "B950-100H1-R03-ICT-5" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "IOC:TMO:ICT:06" )
...
# Configure the ICT
dbLoadRecords( "db/ict.db", "HOST=plv-tmo-pdu-06,PRE=PDU:TMO:ICT:06" )
dbLoadRecords( "db/ict48VbusA.db", "HOST=plv-tmo-pdu-06,PRE=PDU:TMO:ICT:06" )
dbLoadRecords( "db/ict48VbusB.db", "HOST=plv-tmo-pdu-06,PRE=PDU:TMO:ICT:06" )
epicsEnvSet( "DEV_INFO", "DEV=PDU:TMO:ICT:06,IOC=$(IOC_PV),IOCNAME=$(IOCNAME)" )
epicsEnvSet( "DEV_INFO", "$(DEV_INFO),COM_TYPE=snmp,COM_PORT=plv-tmo-pdu-06" )
...
Snmp2cWalk("plv-tmo-pdu-06", "write", "ICT-MIB::deviceModel", 95, 2.0)
