...
##############################################################
drvAsynIPPortConfigure( "bus0", "ser-tmo-04:4005", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/bk-1697.db", "BASE=TMO:BKP:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-tmo-bk-01.sav" )
...
create_monitor_set( "ioc-tmo-bk-01.req", 5, "" )
