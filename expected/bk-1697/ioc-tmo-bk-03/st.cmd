...
##############################################################
drvAsynIPPortConfigure( "bus0", "ser-tmo-04:4007", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/bk-1697.db", "BASE=TMO:BKP:03, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-tmo-bk-03.sav" )
...
create_monitor_set( "ioc-tmo-bk-03.req", 5, "" )
