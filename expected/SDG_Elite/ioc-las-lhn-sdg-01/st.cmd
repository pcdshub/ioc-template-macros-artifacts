...
epicsEnvSet( "IOCNAME",	  "ioc-las-lhn-sdg-01" )
epicsEnvSet( "ENGINEER",  "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",  "LHN Bay 1" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:LAS:LHN:SDG:01" )
...
##############################################################
drvAsynIPPortConfigure( "bus0", "moxa-las-01:4009", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/sdg.db", "BASE=LAS:LHN:SDG:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-las-lhn-sdg-01.sav" )
...
create_monitor_set( "ioc-las-lhn-sdg-01.req", 5, "" )
