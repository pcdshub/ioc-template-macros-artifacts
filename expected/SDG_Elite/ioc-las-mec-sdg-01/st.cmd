...
##############################################################
drvAsynIPPortConfigure( "bus0", "moxa-fs6-01:4008", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/sdg.db", "BASE=LAS:MEC:SDG:01, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-las-mec-sdg-01.sav" )
...
create_monitor_set( "ioc-las-mec-sdg-01.req", 5, "" )
