...
epicsEnvSet( "IOCNAME",	  "ioc-las-lhn-sdg-04" )
epicsEnvSet( "ENGINEER",  "Lana Jansen-Whealey (ljansen7)" )
epicsEnvSet( "LOCATION",  "LHN Bay 4" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:LAS:LHN:SDG:04" )
...
##############################################################
drvAsynIPPortConfigure( "bus0", "moxa-las-02:4006", 0, 0, 0 )
asynSetTraceIOMask( "bus0", 0, 0x1 ) # logging for normal operation

## Load record instances
dbLoadRecords( "db/iocSoft.db", "IOC=$(IOC_PV)")
dbLoadRecords( "db/save_restoreStatus.db", "P=$(IOC_PV):")
dbLoadRecords( "db/sdg.db", "BASE=LAS:LHN:SDG:04, DEV=bus0" )
...
set_pass0_restoreFile( "ioc-las-lhn-sdg-04.sav" )
...
create_monitor_set( "ioc-las-lhn-sdg-04.req", 5, "" )
