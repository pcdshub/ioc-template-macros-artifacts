...
epicsEnvSet( "IOCNAME",	  "ioc-crix-spc-01" )
epicsEnvSet( "ENGINEER",  "Basil Aljamal (baljamal)" )
epicsEnvSet( "LOCATION",  "CRIX Beamline" )
epicsEnvSet( "IOCSH_PS1", "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",	  "IOC:CRIX:SPC:01" )
...
dbLoadRecords("db/seabreezeAPI.template", "P=CRIX:SPC:01,PORT=bus0,NELM=1044")
...
set_pass0_restoreFile( "ioc-crix-spc-01.sav" )
...
create_monitor_set( "ioc-crix-spc-01.req", 5, "" )
