...
epicsEnvSet( "IOCSH_PS1", "ioc-mfx-delaygen2>" )
epicsEnvSet( "IOCENAME",  "IOC:MFX:DELAYGEN2" )
epicsEnvSet( "IOCPVROOT", "MFX:IOC:DDG")
epicsEnvSet( "LOCATION",  "MFX:SAMPLE:TABLE")
epicsEnvSet( "IP",        "delaygen-mfx-02"       )
epicsEnvSet( "DG",        "MFX:DDG:02"     )
