...
epicsEnvSet( "IOCSH_PS1", "ioc-lbl-delaygen2>" )
epicsEnvSet( "IOCENAME",  "IOC:LBL:DELAYGEN2" )
epicsEnvSet( "IOCPVROOT", "MFX:IOC:LBL:DDG:02")
epicsEnvSet( "LOCATION",  "MFX:SAMPLE:TABLE")
epicsEnvSet( "IP",        "delaygen-lbl-02"       )
epicsEnvSet( "DG",        "MFX:LBL:DDG:02"     )
