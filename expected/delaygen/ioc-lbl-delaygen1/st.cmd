#!/reg/g/pcds/epics/ioc/common/dg/R2.0.3/bin/rhel7-x86_64/delaygenApp


< envPaths

epicsEnvSet( "ENGINEER" , "Alex Batyuk (batyuk)" )
epicsEnvSet( "IOCSH_PS1", "ioc-lbl-delaygen1>" )
epicsEnvSet( "IOCENAME",  "IOC:LBL:DELAYGEN1" )
epicsEnvSet( "IOCPVROOT", "MFX:IOC:LBL:DDG:01")
epicsEnvSet( "LOCATION",  "MFX:SAMPLE:TABLE")
epicsEnvSet( "IP",        "delaygen-lbl-01"       )
epicsEnvSet( "DG",        "MFX:LBL:DDG:01"     )
epicsEnvSet( "IOC_TOP",   "/reg/g/pcds/epics/ioc/common/dg/R2.0.3"   )
epicsEnvSet( "TOP",       "/reg/g/pcds/epics/ioc/mfx/delaygen/R1.0.0/build"      )
