...
< envPaths
epicsEnvSet( "IOCNAME",      "ioc-qrix-archon1" )
epicsEnvSet( "ENGINEER",     "Daniel Damiani (ddamiani)" )
epicsEnvSet( "LOCATION",     "QRIX STA CCD, ethernet to host daq-rix-ccd-01" )
epicsEnvSet( "IOCSH_PS1",    "$(IOCNAME)> " )
epicsEnvSet( "IOC_PV",       "QRIX:STA:IOC:01" )
...
epicsEnvSet( "EVR_PV",       "QRIX:STA:CCD:01:NoEvr" )
# Setup TPR env vars
epicsEnvSet( "TPR_CARD",     "0" )
epicsEnvSet( "TPR_PV",       "RIX:CCD:TPR:01" )
epicsEnvSet( "TPE_PV",       "QRIX:STA:CCD:01:TPE" )
...
epicsEnvSet( "CAM_PV",       "QRIX:STA:CCD:01" )
...
# TPR driver DB
dbLoadRecords("db/pcieSlave_tprTrig.db",    "DEV=QRIX:STA:CCD:01:TPE,PORT=$(TPR_PORT)")
