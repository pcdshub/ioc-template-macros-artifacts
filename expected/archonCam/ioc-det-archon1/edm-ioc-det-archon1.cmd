...
export TPR_PV=DET:ASC:TPR:01
export TPE_PV=DET:CAM:ARCHON:01:TPE
export TPR_TR=00
export TPR_CH=${TPR_TR}
export TPR_SE=${TPR_CH}
export IOC_PV=DET:IOC:CAM:ARCHON:01
export CAM=DET:CAM:ARCHON:01
export HUTCH=det

export IF=ETH0

export SYNCTS="/reg/g/pcds/epics/ioc/common/archonCam/R1.1.0/children/build/iocBoot/ioc-det-archon1/syncts-ioc-det-archon1.cmd"
